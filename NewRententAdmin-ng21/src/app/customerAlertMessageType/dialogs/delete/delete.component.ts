...
export class DeleteDialogComponent
{
  ...
  confirmDelete()
  {
    this.advanceTableService.delete(this.data.customerAlertMessageTypeID)  
    .subscribe(
    data => 
    {
       this._generalService.sendUpdate('CustomerAlertMessageTypeDelete:CustomerAlertMessageTypeView:Success');//To Send Updates   
    },
    error =>
    {
