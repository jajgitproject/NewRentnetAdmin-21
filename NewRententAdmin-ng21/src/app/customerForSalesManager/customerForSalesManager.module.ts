...
import { CustomerForSalesManagerRoutingModule } from './customerForSalesManager-routing.module';
...
@NgModule({
  declarations: [
    CustomerForSalesManagerComponent,
  ],
  imports: [
    ...
    FormsModule,
    ReactiveFormsModule,
    CustomerForSalesManagerRoutingModule,
    MatTableModule,
    MatPaginatorModule,
    MatFormFieldModule,
    MatInputModule,
  ...
  providers: [CustomerForSalesManagerService,CustomerCorporateIndividualService]
})
export class CustomerForSalesManagerModule {}
