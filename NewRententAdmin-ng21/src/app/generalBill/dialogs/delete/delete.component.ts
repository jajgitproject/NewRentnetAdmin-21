...
export class DeleteDialogComponent
{
  ...
  confirmDelete()
  {
    this.advanceTableService.delete(this.data.invoiceGeneralLineItemsID)  
    .subscribe(
    data => 
    {
       this._generalService.sendUpdate('GeneralBillDelete:GeneralBillView:Success');//To Send Updates   
    },
    error =>
    {
