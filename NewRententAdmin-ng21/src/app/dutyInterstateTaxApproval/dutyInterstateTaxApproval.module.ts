...
import { DutyInterstateTaxApprovalRoutingModule } from './dutyInterstateTaxApproval-routing.module';
...
@NgModule({
  declarations: [
    DutyInterstateTaxApprovalComponent,
    advanceTableForm,
  ...
  imports: [
    ...
    FormsModule,
    ReactiveFormsModule,
    DutyInterstateTaxApprovalRoutingModule,
    MatTableModule,
    MatPaginatorModule,
    MatFormFieldModule,
    MatInputModule,
...
export class DutyInterstateTaxApprovalModule {}
