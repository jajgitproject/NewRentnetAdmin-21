...
import { CustomerCreditChargesRoutingModule } from './customerCreditCharges-routing.module';
import { MyUploadComponent } from '../myupload/myupload.component';
import { MyUploadModule } from '../myupload/myupload.module';
import {MatTooltipModule} from '@angular/material/tooltip';
@NgModule({
  declarations: [
    CustomerCreditChargesComponent,
    advanceTableForm,
  ...
  imports: [
    ...
    FormsModule,
    ReactiveFormsModule,
    CustomerCreditChargesRoutingModule,
    MatTableModule,
    MatPaginatorModule,
    MatFormFieldModule,
    MatInputModule,
  ...
  providers: [CustomerCreditChargesService]
})
export class CustomerCreditChargesModule {}
