...
export class DeleteDialogComponent
{
  ...
  confirmDelete()
  {
    this.advanceTableService.delete(this.data.bankChargeConfigID)  
    .subscribe(
    data => 
    {
       this._generalService.sendUpdate('BankChargeConfigDelete:BankChargeConfigView:Success');//To Send Updates   
    },
    error =>
    {
