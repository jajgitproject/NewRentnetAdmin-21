...
import { CardProcessingChargeRoutingModule } from './cardProcessingCharge-routing.module';
import { MyUploadComponent } from '../myupload/myupload.component';
import { MyUploadModule } from '../myupload/myupload.module';
@NgModule({
  declarations: [
    CardProcessingChargeComponent,
    advanceTableForm,
  ...
  imports: [
    ...
    FormsModule,
    ReactiveFormsModule,
    CardProcessingChargeRoutingModule,
    MatTableModule,
    MatPaginatorModule,
    MatFormFieldModule,
    MatInputModule,
  ...
  providers: [CardProcessingChargeService]
})
export class CardProcessingChargeModule {}
