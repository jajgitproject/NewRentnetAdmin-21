...
@NgModule({
  declarations: [
    SearchDriverByLocationComponent,
    // advanceTableForm,
  ...
  imports: [
    ...
    FormsModule,
    ReactiveFormsModule,
    SearchDriverByLocationRoutingModule,
    MatTableModule,
    MatPaginatorModule,
    MatFormFieldModule,
    MatInputModule,
  ...
  providers: [DriverInventoryAssociationService,SearchDriverByLocationService]
})
export class SearchDriverByLocationModule {}
