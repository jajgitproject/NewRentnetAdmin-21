  ...
  onBackPress(event) 
  {
   ...
   public loadData() 
   {
    switch (this.selectedFilter)
    {
      ...
      this.driverService.getTableData(this.SearchdriverName,this.searchdriverFatherName,this.driverGrade.value,this.searchDriverOfficialIdentityNumber,this.searchhighestQualification,this.searchMobile,this.location.value, this.SearchActivationStatus, this.PageNumber).subscribe
    (
      data =>   
      {
...
/////////////////for Image Upload ends////////////////////////////
  ...
  SortingData(coloumName:any) {
    ...
    this.driverService.getTableDataSort(this.SearchdriverName,this.searchdriverFatherName,this.searchdriverGradeName,this.searchDriverOfficialIdentityNumber,this.searchhighestQualification,this.searchMobile,this.searchLocation, this.SearchActivationStatus, this.PageNumber,coloumName.active,this.sortType).subscribe
    (
      data =>   
      {
        this.dataSource = data;
