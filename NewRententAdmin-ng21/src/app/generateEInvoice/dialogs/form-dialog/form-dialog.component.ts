...
export class FormDialogComponent 
{
  ...
  advanceTable: GenerateEInvoiceModel;
    ...
    public _generalService:GeneralService)
  {
        ...
        else 
        {
          this.dialogTitle = 'Cancel E - Invoice';
          this.advanceTable = data.advanceTable;
          //this.advanceTable = new GenerateEInvoiceModel({});
        }
  ...
  public Post(): void
  {      
    this.generateEInvoiceService.add(this.advanceTableForm.getRawValue()).subscribe(
    response => 
    {
