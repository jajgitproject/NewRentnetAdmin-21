...
import { AdvanceDetailsClosingService } from './advanceDetailsClosing.service';
import { AdvanceDetailsClosing } from './advanceDetailsClosing.model';
import { FormControl } from '@angular/forms';
@Component({
  standalone: false,
  selector: 'app-advanceDetailsClosing',
  templateUrl: './advanceDetailsClosing.component.html',
  styleUrls: ['./advanceDetailsClosing.component.sass'],
  providers: [{ provide: MAT_DATE_LOCALE, useValue: 'en-GB' }]
})
export class AdvanceDetailsClosingComponent implements OnInit {
  @Input() ReservationID;
  displayedColumns = [
    'state',
    'changeDateTime',
  ...
  dataSource: AdvanceDetailsClosing[] | null;
  ...
  onContextMenu(event: MouseEvent, item: AdvanceDetailsClosing) {
