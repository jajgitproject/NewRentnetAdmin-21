...
import { DisputeResolutionRoutingModule } from './disputeResolution-routing.module';
...
@NgModule({
  ...
  imports: [
    ...
    DisputeResolutionRoutingModule,
    MatTableModule,
    MatPaginatorModule,
    MatFormFieldModule,
    MatInputModule,
  ...
  providers: [DisputeResolutionService,DisputeService
  ]
})
