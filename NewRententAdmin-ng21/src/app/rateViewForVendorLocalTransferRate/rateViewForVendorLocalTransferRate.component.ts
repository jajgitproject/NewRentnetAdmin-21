...
import { RateViewForVendorLocalTransferRateModel } from './rateViewForVendorLocalTransferRate.model';
...
@Component({
  standalone: false,
  selector: 'app-rateViewForVendorLocalTransferRate',
  templateUrl: './rateViewForVendorLocalTransferRate.component.html',
  styleUrls: ['./rateViewForVendorLocalTransferRate.component.sass'],
  providers: [{ provide: MAT_DATE_LOCALE, useValue: 'en-GB' }]
})

export class RateViewForVendorLocalTransferRateComponent implements OnInit {
  displayedColumns = [
    'Package',
    'City',    
  ...
  dataSource: RateViewForVendorLocalTransferRateModel[] | null;
  CustomerContract_ID: any;
  PackageName: string;
  advanceTable: RateViewForVendorLocalTransferRateModel | null;
  ...
  constructor(
    ...
    public rateViewForVendorLocalTransferRateService: RateViewForVendorLocalTransferRateService,
  ...
  public Filter()
  {
   ...
   public loadData() 
   {
      this.rateViewForVendorLocalTransferRateService.getTableData(this.vendorContract_ID).subscribe
      (
        data =>   
        {
  ...
  onContextMenu(event: MouseEvent, item: RateViewForVendorLocalTransferRateModel) {
