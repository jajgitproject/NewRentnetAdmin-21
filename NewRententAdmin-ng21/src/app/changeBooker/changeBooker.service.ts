...
@Injectable()
export class ChangeBookerService {
  ...
  add(advanceTable:ChangeBookerModel):Observable<any> 
  {
    advanceTable.userID=this.generalService.getUserID();
    advanceTable.changeEmployeeID=this.generalService.getUserID();
    return this.httpClient.post<any>(this.API_URL + '/' + 'AddChangeBooker' , advanceTable);
  }

  getChangeBookerData(ReservationID:number):Observable<any[]> 
  {
