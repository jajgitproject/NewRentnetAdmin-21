...
import { CustomerCategoryMappingRoutingModule } from './customerCategoryMapping-routing.module';
...
@NgModule({
  declarations: [
    CustomerCategoryMappingComponent,
    advanceTableForm,
  ...
  imports: [
    ...
    FormsModule,
    ReactiveFormsModule,
    CustomerCategoryMappingRoutingModule,
    MatTableModule,
    MatPaginatorModule,
    MatFormFieldModule,
    MatInputModule,
  ...
  providers: [CustomerCategoryMappingService]
})
export class CustomerCategoryMappingModule {}
