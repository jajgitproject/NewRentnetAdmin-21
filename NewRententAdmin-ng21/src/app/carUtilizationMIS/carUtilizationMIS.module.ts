...
import { CarUtilizationMISRoutingModule } from './carUtilizationMIS-routing.module';
import { MatAutocompleteModule } from '@angular/material/autocomplete';
import { MatTooltipModule } from '@angular/material/tooltip';

@NgModule({
  declarations: [
    CarUtilizationMISComponent,
    // advanceTableForm,
  ...
  imports: [
    ...
    FormsModule,
    ReactiveFormsModule,
    CarUtilizationMISRoutingModule,
    MatTableModule,
    MatPaginatorModule,
    MatFormFieldModule,
    MatInputModule,
  ...
  providers: [CarUtilizationMISService]
})
export class CarUtilizationMISModule {}
