...
@Injectable()
export class BillingInstructionDetailsService 
{
  ...
  {
    this.API_URL=generalService.BaseURL+ "billingInstructionDetails";
  }
  /** CRUD METHODS */
  ...
  {
    advanceTable.billingInstructionDetailsID=1;
    return this.httpClient.post<any>(this.API_URL , advanceTable);
  }
  update(advanceTable: BillingInstructionDetails)
  {
    return this.httpClient.put<any>(this.API_URL , advanceTable);
  }
  delete(billingInstructionDetailsID: number):  Observable<any> 
  {
    return this.httpClient.delete(this.API_URL + '/'+ billingInstructionDetailsID);
  }
}
