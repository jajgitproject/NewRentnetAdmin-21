...
@Component({
  standalone: false,
  selector: 'app-inventoryPUC',
  templateUrl: './inventoryPUC.component.html',
  styleUrls: ['./inventoryPUC.component.sass'],
  providers: [{ provide: MAT_DATE_LOCALE, useValue: 'en-GB' }]
})
export class InventoryPUCComponent implements OnInit {
  displayedColumns = [
  ...
  dataSource: InventoryPUC[] | null;
  inventoryPUCID: number;
  advanceTable: InventoryPUC | null;
  ...
  constructor(
    ...
    public inventoryPUCService: InventoryPUCService,
...
console.log(this.inventoryID, this.regNo);
  ...
  editCall(row) {
      //  alert(row.id);
    this.inventoryPUCID = row.inventoryPUCID;
    const dialogRef = this.dialog.open(FormDialogComponent, {
      data: {
        advanceTable: row,
        action: 'edit',
  ...
  onBackPress(event) 
  {
   ...
   public loadData() 
   {
    ...
    switch (this.selectedFilter)
    {
      ...
      this.inventoryPUCService.getTableData(
        this.inventoryID,
        this.SearchStartDate,
        this.SearchEndDate,
  ...
  onContextMenu(event: MouseEvent, item: InventoryPUC) {
...
/////////////////for Image Upload ends////////////////////////////
  ...
  SubscribeUpdateService()
  {
    ...
    (
      ...
      { 
        ...
        {
          if(this.MessageArray[0]=="InventoryPUCCreate")
          {
            if(this.MessageArray[1]=="InventoryPUCView")
            {
              if(this.MessageArray[2]=="Success")
              {
                ...
                'snackbar-success',
                ' Inventory PUC Created Successfully...!!!',
                'bottom',
                'center'
              );
              }
          ...
          else if(this.MessageArray[0]=="InventoryPUCUpdate")
          {
            if(this.MessageArray[1]=="InventoryPUCView")
            {
              if(this.MessageArray[2]=="Success")
              {
               ...
               this.showNotification(
                'snackbar-success',
                ' Inventory PUC Updated Successfully...!!!',
                'bottom',
                'center'
              );
              }
          ...
          else if(this.MessageArray[0]=="InventoryPUCDelete")
          {
            if(this.MessageArray[1]=="InventoryPUCView")
            {
              if(this.MessageArray[2]=="Success")
              {
               ...
               this.showNotification(
                'snackbar-success',
                ' Inventory PUC Deleted Successfully...!!!',
                'bottom',
                'center'
              );
              }
          ...
          else if(this.MessageArray[0]=="InventoryPUCAll")
          {
            if(this.MessageArray[1]=="InventoryPUCView")
            {
  ...
  SortingData(coloumName:any) {
    ...
    //   this.SearchEndDate=moment(this.SearchEndDate).format('MMM DD yyyy');
    // } 
    this.inventoryPUCService.getTableDataSort(
      this.inventoryID,
      this.SearchStartDate,
      this.SearchEndDate,
      this.SearchActivationStatus, 
