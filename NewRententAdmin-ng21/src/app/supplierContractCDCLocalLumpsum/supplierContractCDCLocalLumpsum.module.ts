...
import { SupplierContractCDCLocalLumpsumRoutingModule } from './supplierContractCDCLocalLumpsum-routing.module';
...
@NgModule({
  declarations: [
    SupplierContractCDCLocalLumpsumComponent,
    advanceTableForm,
  ...
  imports: [
    ...
    SupplierContractCDCLocalLumpsumRoutingModule,
    MatTableModule,
    MatPaginatorModule,
    MatFormFieldModule,
    MatInputModule,
  ...
  providers: [SupplierContractCDCLocalLumpsumService]
})
export class SupplierContractCDCLocalLumpsumModule {}
