...
export class FormDialogComponent 
{
  ...
  public _generalService:GeneralService)
  {
        ...
        if (this.action === 'edit') 
        {
          //this.dialogTitle ='Edit  Inventory Fitness For';       
          this.dialogTitle ='Inventory Fitness For';
          this.advanceTable = data.advanceTable;
          this.ImagePath=this.advanceTable.fitnessImage;
        ...
        {
          //this.dialogTitle = 'Create Inventory Fitness For';
          this.dialogTitle = 'Inventory Fitness For';
          this.advanceTable = new InventoryFitness({});
  ...
  public Post(): void
  {
    ...
    {
        this.dialogRef.close();
       this._generalService.sendUpdate('InventoryFitnessCreate:InventoryFitnessView:Success');//To Send Updates  
  ...
  public Put(): void
  {
    ...
    {
        this.dialogRef.close();
       this._generalService.sendUpdate('InventoryFitnessUpdate:InventoryFitnessView:Success');//To Send Updates  
       this.saveDisabled = true;
    },
    error =>
    {
  ...
  public uploadFinished = (event) => 
  {
    ...
    this.advanceTableForm.patchValue({fitnessImage:this.ImagePath})
  }
...
//   if (/[a-zA-Z]/.inventoryFitness(inp)) {
//     return true;
//   } else {
//     event.preventDefault();
//     return false;
