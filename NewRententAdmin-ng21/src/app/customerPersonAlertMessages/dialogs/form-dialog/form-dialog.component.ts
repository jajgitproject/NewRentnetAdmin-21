...
export class FormDialogComponent 
{
  ...
  advanceTable: CustomerPersonAlertMessages;
  fName = '';
  contents: any[];
  mydata = [];
  name = '';
  ...
  public advanceTableService: CustomerPersonAlertMessagesService,
  ...
  public _generalService:GeneralService)
  {
        ...
        if (this.action === 'edit') 
        {
          this.dialogTitle ='Alert Messages for';       
          this.advanceTable = data.advanceTable;
        } else 
        {
          this.dialogTitle = 'Alert Messages for';
          this.advanceTable = new CustomerPersonAlertMessages({});
  ...
  createContactForm(): FormGroup 
  {
    ...
    {
      customerPersonAlertMessagesID: [this.advanceTable.customerPersonAlertMessagesID],
      customerPersonID: [this.advanceTable.customerPersonID],
      bookingAlert: [this.advanceTable.bookingAlert],
      carAlert: [this.advanceTable.carAlert],
      driverAlert: [this.advanceTable.driverAlert],
      dispatchAlert: [this.advanceTable.dispatchAlert],
      billingAlert: [this.advanceTable.billingAlert],
  ...
  public Post(): void
  {
    ...
    {
        this.dialogRef.close();
       this._generalService.sendUpdate('CustomerPersonAlertMessagesCreate:CustomerPersonAlertMessagesView:Success');//To Send Updates
       this.saveDisabled = true;   
    
    },
    error =>
    {
       this._generalService.sendUpdate('CustomerPersonAlertMessagesAll:CustomerPersonAlertMessagesView:Failure');//To Send Updates 
       this.saveDisabled = true;  
    }
  )
  }
  public Put(): void
  {
    ...
    {
        this.dialogRef.close();
       this._generalService.sendUpdate('CustomerPersonAlertMessagesUpdate:CustomerPersonAlertMessagesView:Success');//To Send Updates 
       this.saveDisabled = true;  
...
//   if (/[a-zA-Z]/.customerPersonAlertMessages(inp)) {
//     return true;
//   } else {
//     event.preventDefault();
//     return false;
