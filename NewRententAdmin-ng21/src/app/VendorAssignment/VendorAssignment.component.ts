...
import { VendorAssignment } from './VendorAssignment.model';
...
@Component({
  standalone: false,
  selector: 'app-VendorAssignment',
  templateUrl: './VendorAssignment.component.html',
  styleUrls: ['./VendorAssignment.component.sass'],
...
constructor(
  public dialogRef: MatDialogRef<VendorAssignmentComponent>, 
  ...
  public _generalService:GeneralService)
  {
        ...
        if (this.action === 'edit') 
        {
          //this.dialogTitle ='Edit VendorAssignment';       
          this.dialogTitle ='VendorAssignment';
          this.advanceTable = data.advanceTable;
        } else 
        {
          this.dialogTitle = 'Trip Filter';
          this.advanceTable = new VendorAssignment({});
...
createContactForm(): FormGroup 
{
  ...
  {
    VendorAssignmentID: [this.advanceTable.VendorAssignmentID],
    VendorAssignment: [this.advanceTable.VendorAssignment,[this.noWhitespaceValidator]],
