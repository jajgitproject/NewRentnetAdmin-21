...
export class FormDialogComponent 
{
  ...
  advanceTable: SupplierContractCDCOutStationLumpsumTrip;
  fName = '';
  contents: any[];
  mydata = [];
  name = '';
  ...
  public advanceTableService: SupplierContractCDCOutStationLumpsumTripService,
  ...
  public _generalService:GeneralService)
  {
        ...
        if (this.action === 'edit') 
        {
          this.dialogTitle ='Chauffeur Driven Car Outstation Lumpsum Trip Package';       
        ...
        {
          this.dialogTitle = 'Chauffeur Driven Car Outstation Lumpsum Trip Package';
          this.advanceTable = new SupplierContractCDCOutStationLumpsumTrip({});
...
onPackageSelected(selectedPackage: string) {
  ...
  createContactForm(): FormGroup 
  {
    ...
    {
      supplierContractCDCOutStationLumpsumTripID: [this.advanceTable.supplierContractCDCOutStationLumpsumTripID],
      ...
      packageDays: [this.advanceTable.packageDays],
      packageHrs: [this.advanceTable.packageHrs],
...
numberOnly(event): boolean {
  ...
  public Post(): void
  {
    ...
    response => 
    {
      this.isLoading = false;
        this.dialogRef.close();
       this._generalService.sendUpdate('SupplierContractCDCOutStationLumpsumTripCreate:SupplierContractCDCOutStationLumpsumTripView:Success');//To Send Updates  
    
    },
    error =>
    {
      this.isLoading = false;
       this._generalService.sendUpdate('SupplierContractCDCOutStationLumpsumTripAll:SupplierContractCDCOutStationLumpsumTripView:Failure');//To Send Updates  
    }
  )
  }
  public Put(): void
  {
    ...
    response => 
    {
      this.isLoading = false;
        this.dialogRef.close();
       this._generalService.sendUpdate('SupplierContractCDCOutStationLumpsumTripUpdate:SupplierContractCDCOutStationLumpsumTripView:Success');//To Send Updates  
