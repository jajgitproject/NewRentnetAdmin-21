...
import { PrintDutySlipWithoutMapRoutingModule } from './PrintDutySlipWithoutMap-routing.module';
...
@NgModule({
  declarations: [
    PrintDutySlipWithoutMapComponent
  ],
  imports: [
    CommonModule,
    FormsModule,
    ReactiveFormsModule,
    PrintDutySlipWithoutMapRoutingModule,
    MatTableModule,
    MatPaginatorModule,
    MatFormFieldModule,
    MatInputModule,
...
export class PrintDutySlipWithoutMapModule {}
