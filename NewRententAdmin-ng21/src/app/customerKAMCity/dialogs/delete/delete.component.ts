...
export class DeleteDialogComponent
{
  ...
  confirmDelete()
  {
    this.advanceTableService.delete(this.data.customerKAMCityID)  
    .subscribe(
    data => 
    {
       this._generalService.sendUpdate('CustomerKAMCityDelete:CustomerKAMCityView:Success');//To Send Updates   
    },
    error =>
    {
