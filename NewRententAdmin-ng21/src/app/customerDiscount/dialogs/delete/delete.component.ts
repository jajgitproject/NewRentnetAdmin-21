...
export class DeleteDialogComponent
{
  ...
  confirmDelete()
  {
    this.advanceTableService.delete(this.data.customerDiscountID)  
    .subscribe(
    data => 
    {
       this._generalService.sendUpdate('CustomerDiscountDelete:CustomerDiscountView:Success');//To Send Updates   
    },
    error =>
    {
