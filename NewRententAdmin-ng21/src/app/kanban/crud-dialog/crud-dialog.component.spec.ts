...
import { KanbanDialogComponent } from './crud-dialog.component';
...
describe('KanbanDialogComponent', () => {
  ...
  it('should not add new kanban when name empty or filled with whitespaces)', () => {
    // given
  ...
  it('should add new kanban when name is filled', () => {
    // given
    spyOn(component, 'save');
    const button: DebugElement = fixture.debugElement.query(
      By.css('button.mat-primary')
