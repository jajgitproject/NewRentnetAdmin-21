...
export class DeleteDialogComponent
{
  ...
  confirmDelete()
  {
    this.advanceTableService.delete(this.data.customerContractCityTiersID)  
    .subscribe(
    data => 
    {
       this._generalService.sendUpdate('CustomerContractCityTiersDelete:CustomerContractCityTiersView:Success');//To Send Updates   
    },
    error =>
    {
