...
import { ReservationSourceRoutingModule } from './reservationSource-routing.module';
import { MyUploadComponent } from '../myupload/myupload.component';
import { MyUploadModule } from '../myupload/myupload.module';
@NgModule({
  declarations: [
    ReservationSourceComponent,
    advanceTableForm,
  ...
  imports: [
    ...
    FormsModule,
    ReactiveFormsModule,
    ReservationSourceRoutingModule,
    MatTableModule,
    MatPaginatorModule,
    MatFormFieldModule,
    MatInputModule,
  ...
  providers: [ReservationSourceService]
})
export class ReservationSourceModule {}
