...
export class DeleteDialogComponent
{
  ...
  confirmDelete()
  {
    this.advanceTableService.delete(this.data.customerContactPersonID)  
    .subscribe(
    data => 
    {
       this._generalService.sendUpdate('CustomerContactPersonDelete:CustomerContactPersonView:Success');//To Send Updates   
    },
    error =>
    {
