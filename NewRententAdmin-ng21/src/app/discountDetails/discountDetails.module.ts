...
import { DiscountDetailsRoutingModule } from './discountDetails-routing.module';
...
@NgModule({
  declarations: [
    DiscountDetailsDialogComponent,
  ...
  exports: [DiscountDetailsComponent, DiscountDetailsDialogComponent],
  providers: [DiscountDetailsService]
})
