...
import { RateViewForOutstationLumpsumContractModel } from './rateViewForOutstationLumpsumContract.model';
...
import { RateViewForOutstationLumpsumContractService } from './rateViewForOutstationLumpsumContract.service';

@Component({
  standalone: false,
  selector: 'app-rateViewForTransferContract',
  templateUrl: './rateViewForOutstationLumpsumContract.component.html',
  styleUrls: ['./rateViewForOutstationLumpsumContract.component.sass'],
  providers: [{ provide: MAT_DATE_LOCALE, useValue: 'en-GB' }]
})

export class RateViewForOutstationLumpsumContractComponent implements OnInit {
  displayedColumns = [
    'Package',
  ...
  dataSource: RateViewForOutstationLumpsumContractModel[] | null;
  CustomerContract_ID: any;
  PackageName: string;
  advanceTable: RateViewForOutstationLumpsumContractModel | null;
  ...
  constructor(
    ...
    public rateViewForOutstationLumpsumContractService: RateViewForOutstationLumpsumContractService,
  ...
  public Filter()
  {
   ...
   public loadData() 
   {
      this.rateViewForOutstationLumpsumContractService.getTableData(this.CustomerContract_ID).subscribe
      (
        data =>   
        {
  ...
  onContextMenu(event: MouseEvent, item: RateViewForOutstationLumpsumContractModel) {
