...
@Injectable()
export class SupplierContractSDCSelfDriveLimitedService 
{
  ...
  {
    this.API_URL=generalService.BaseURL+ "supplierContractSDCSelfDriveLimited";
  }
  /** CRUD METHODS */
    ...
    PageNumber: number):  Observable<any> 
  {
    ...
    //console.log(this.API_URL + "/" +supplierContractID + '/'+searchVehicleCategory + '/'+searchPackage + '/'+searchCityTier + '/'+SearchBaseRate + '/' + SearchActivationStatus +'/' + PageNumber + '/supplierContractSDCSelfDriveLimitedID/Ascending')
    return this.httpClient.get(this.API_URL + "/" +supplierContractID + '/'+searchVehicleCategory + '/'+searchPackage + '/'+searchCityTier + '/'+SearchBaseRate +'/'+SearchminimumDays +'/' +SearchActivationStatus +'/' + PageNumber + '/supplierContractSDCSelfDriveLimitedID/Ascending');
  ...
  add(advanceTable: SupplierContractSDCSelfDriveLimited) 
  {
    advanceTable.supplierContractSDCSelfDriveLimitedID=-1;
  ...
  update(advanceTable: SupplierContractSDCSelfDriveLimited)
  {
    advanceTable.userID=this.generalService.getUserID();
    advanceTable.nightChargeStartTimeString=this.generalService.getTimeFrom(advanceTable.nightChargeStartTime);
    advanceTable.nightChargeEndTimeString=this.generalService.getTimeTo(advanceTable.nightChargeEndTime);
  ...
  delete(supplierContractSDCSelfDriveLimitedID: number):  Observable<any> 
  {
    let userID=this.generalService.getUserID();
    return this.httpClient.delete(this.API_URL + '/'+ supplierContractSDCSelfDriveLimitedID + '/'+ userID);
  }
}
