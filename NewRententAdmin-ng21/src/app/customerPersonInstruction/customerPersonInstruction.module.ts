...
import { CustomerPersonInstructionRoutingModule } from './customerPersonInstruction-routing.module';
...
@NgModule({
  declarations: [
    CustomerPersonInstructionComponent,
    advanceTableForm,
  ...
  imports: [
    ...
    FormsModule,
    ReactiveFormsModule,
    CustomerPersonInstructionRoutingModule,
    MatTableModule,
    MatPaginatorModule,
    MatFormFieldModule,
    MatInputModule,
  ...
  providers: [CustomerPersonInstructionService]
})
export class CustomerPersonInstructionModule {}
