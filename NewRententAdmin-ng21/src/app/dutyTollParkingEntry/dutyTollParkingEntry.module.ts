...
import { DutyTollParkingEntryRoutingModule } from './dutyTollParkingEntry-routing.module';
...
@NgModule({
  ...
  imports: [
    ...
    FormsModule,
    ReactiveFormsModule,
    DutyTollParkingEntryRoutingModule,
    MatTableModule,
    MatPaginatorModule,
    MatFormFieldModule,
    MatInputModule,
...
export class DutyTollParkingEntryModule {}
