...
import { SDLimitedRateRoutingModule } from './sdlimitedRate-routing.module';
...
@NgModule({
  ...
  providers: [SDLimitedRateService]
})
export class SDLimitedRateModule {}
