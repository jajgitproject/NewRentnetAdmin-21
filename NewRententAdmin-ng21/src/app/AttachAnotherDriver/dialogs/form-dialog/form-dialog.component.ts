...
export class AttachAnotherDriverFormDialogComponent 
{
  ...
  advanceTable: AttachAnotherDriver;
  ...
  constructor(
  public dialogRef: MatDialogRef<AttachAnotherDriverFormDialogComponent>, 
  ...
  public _generalService:GeneralService)
  {
        ...
        if (this.action === 'edit') 
        {
          this.dialogTitle ='Attach Another Driver';       
          this.advanceTable = data.advanceTable;
        } 
        else 
        {
          this.dialogTitle = 'Attach Another Driver';
          this.advanceTable = new AttachAnotherDriver({});
  ...
  createContactForm(): FormGroup 
  {
    ...
    {
      AttachAnotherDriverID: [this.advanceTable.AttachAnotherDriverID],
      AttachAnotherDriver: [this.advanceTable.AttachAnotherDriver,[this.noWhitespaceValidator]],
