...
@Injectable()
export class ChangeCarTypeService {
  ...
  {
    this.API_URL = generalService.BaseURL + "ChangeCarType";
  ...
  getVehicleBasedOnContractID(ContractID:number):Observable<any[]> 
  {
    return this.httpClient.get<any[]>(this.API_URL + "/GetVehicleBasedOnContractID"+ '/' + ContractID);
  }


  add(advanceTable:ChangeCarTypeModel):Observable<any> 
  {
    advanceTable.userID=this.generalService.getUserID();
    advanceTable.changeEmployeeID=this.generalService.getUserID();
    return this.httpClient.post<any>(this.API_URL + '/' + 'AddChangeCarType' , advanceTable);
  }

  getChangeCarTypeData(ReservationID:number):Observable<any[]> 
  {
    return this.httpClient.get<any[]>(this.API_URL + "/GetAllChangeCarType" + '/' + ReservationID);
  }
