...
import { DriverCarSupplierMISRoutingModule } from '../driverCarSupplierMIS/driverCarSupplierMIS-routing.module';
...
@NgModule({
  ...
  imports: [
    ...
    FormsModule,
    ReactiveFormsModule,
    DriverCarSupplierMISRoutingModule,
    MatTableModule,
    MatPaginatorModule,
    MatFormFieldModule,
    MatInputModule,
  ...
  providers: [DriverCarSupplierMISService]
})
export class DriverCarSupplierMISModule {}
