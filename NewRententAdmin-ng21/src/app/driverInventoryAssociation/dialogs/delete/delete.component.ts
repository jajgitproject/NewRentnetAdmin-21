...
export class DeleteDialogComponent
{
  ...
  confirmDelete()
  {
    this.advanceTableService.delete(this.data.driverInventoryAssociationID)  
    .subscribe(
    data => 
    {
       this._generalService.sendUpdate('DriverInventoryAssociationDelete:DriverInventoryAssociationView:Success');//To Send Updates   
    },
    error =>
    {
