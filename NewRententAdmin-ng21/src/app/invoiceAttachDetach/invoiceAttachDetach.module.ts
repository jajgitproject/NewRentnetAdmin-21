...
import { InvoiceAttachDetachRoutingModule } from './invoiceAttachDetach-routing.module';
...
import { InvoiceDetachModule } from '../invoiceDetach/invoiceDetach.module';
...
@NgModule({
  ...
  imports: [
    ...
    MatTooltipModule,
    ReactiveFormsModule,
    InvoiceAttachDetachRoutingModule,
  ...
  providers: [InvoiceAttachDetachService,InvoiceDetachService]
})
export class InvoiceAttachDetachModule {}
