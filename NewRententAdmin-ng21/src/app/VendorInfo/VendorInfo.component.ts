...
import { VendorInfo } from './VendorInfo.model';
...
@Component({
  ...
  styleUrls: ['./VendorInfo.component.sass'],
...
export class VendorInfoComponent
{
  ...
  SearchVendorInfo: string= 'Assigned';
  SearchVendor: string= '';
  ...
  searchVendorInfo : FormControl = new FormControl();
...
constructor(
  ...
  public _generalService:GeneralService)
  {
        ...
        if (this.action === 'edit') 
        {
          //this.dialogTitle ='Edit VendorInfo';       
          this.dialogTitle ='VendorInfo';
          this.advanceTable = data.advanceTable;
        } else 
        {
          this.dialogTitle = 'Trip Filter';
          this.advanceTable = new VendorInfo({});
...
createContactForm(): FormGroup 
{
  ...
  {
    VendorInfoID: [this.advanceTable.VendorInfoID],
    VendorInfo: [this.advanceTable.VendorInfo,[this.noWhitespaceValidator]],
