...
import { CarPaidTaxMISRoutingModule } from './carPaidTaxMIS-routing.module';
import { MatAutocompleteModule } from '@angular/material/autocomplete';
import { MatTooltipModule } from '@angular/material/tooltip';

@NgModule({
  declarations: [
    CarPaidTaxMISComponent,
    // advanceTableForm,
  ...
  providers: [CarPaidTaxMISService]
})
export class CarPaidTaxMISModule {}
