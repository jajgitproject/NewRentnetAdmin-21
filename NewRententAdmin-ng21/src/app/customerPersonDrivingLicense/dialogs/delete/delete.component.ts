...
export class DeleteDialogComponent
{
  ...
  confirmDelete()
  {
    this.advanceTableService.delete(this.data.customerPersonDrivingLicenseID)  
    .subscribe(
    data => 
    {
       this._generalService.sendUpdate('CustomerPersonDrivingLicenseDelete:CustomerPersonDrivingLicenseView:Success');//To Send Updates   
    },
    error =>
    {
