...
export class DeleteDialogComponent
{
  ...
  confirmDelete()
  {
    this.advanceTableService.delete(this.data.customerContractID)  
    .subscribe(
    data => 
    {
       this._generalService.sendUpdate('CustomerContractDelete:CustomerContractView:Success');//To Send Updates   
    },
    error =>
    {
