...
export class DeleteDialogComponent
{
  ...
  confirmDelete()
  {
    this.advanceTableService.delete(this.data.addPassengersID)  
    .subscribe(
    data => 
    {
       this._generalService.sendUpdate('AddPassengersDelete:AddPassengersView:Success');//To Send Updates   
    },
    error =>
    {
