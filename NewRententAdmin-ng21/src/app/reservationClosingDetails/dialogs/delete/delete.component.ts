...
export class DeleteDialogComponent
{
  ...
  // confirmDelete()
  // {
  //   this.advanceTableService.delete(this.data.reservationClosingDetailsID)  
  //   .subscribe(
  //   data => 
  //   {
  //      this._generalService.sendUpdate('ReservationClosingDetailsDelete:ReservationClosingDetailsView:Success');//To Send Updates   
  //   },
  //   error =>
  //   {
