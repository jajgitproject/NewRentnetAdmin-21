...
import { ContractPaymentMappingRoutingModule } from './contractPaymentMapping-routing.module';
...
@NgModule({
  declarations: [
    ContractPaymentMappingComponent,
    advanceTableForm,
  ...
  imports: [
    ...
    FormsModule,
    ReactiveFormsModule,
    ContractPaymentMappingRoutingModule,
    MatTableModule,
  ...
  providers: [ContractPaymentMappingService]
})
export class ContractPaymentMappingModule {}
