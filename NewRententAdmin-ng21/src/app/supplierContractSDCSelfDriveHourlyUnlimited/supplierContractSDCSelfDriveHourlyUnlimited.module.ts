...
import { SupplierContractSDCSelfDriveHourlyUnlimitedRoutingModule } from './supplierContractSDCSelfDriveHourlyUnlimited-routing.module';
...
@NgModule({
  declarations: [
    SupplierContractSDCSelfDriveHourlyUnlimitedComponent,
    advanceTableForm,
  ...
  imports: [
    ...
    FormsModule,
    ReactiveFormsModule,
    SupplierContractSDCSelfDriveHourlyUnlimitedRoutingModule,
    MatTableModule,
    MatPaginatorModule,
    MatFormFieldModule,
    MatInputModule,
  ...
  providers: [SupplierContractSDCSelfDriveHourlyUnlimitedService]
})
export class SupplierContractSDCSelfDriveHourlyUnlimitedModule {}
