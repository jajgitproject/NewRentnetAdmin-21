...
export class DeleteDialogComponent
{
  ...
  confirmDelete()
  {
    ...
    this.advanceTableService.delete(this.data.customerContractMappingID)  
    .subscribe(
    data => 
    {
       this._generalService.sendUpdate('CustomerContractMappingDelete:CustomerContractMappingView:Success');//To Send Updates   
    },
    error =>
    {
