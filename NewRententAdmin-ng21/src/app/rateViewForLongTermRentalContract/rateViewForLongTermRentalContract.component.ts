...
import { RateViewForLongTermRentalContractModel } from './rateViewForLongTermRentalContract.model';
...
import { RateViewForLongTermRentalContractService } from './rateViewForLongTermRentalContract.service';

@Component({
  standalone: false,
  selector: 'app-rateViewForTransferContract',
  templateUrl: './rateViewForLongTermRentalContract.component.html',
  styleUrls: ['./rateViewForLongTermRentalContract.component.sass'],
  providers: [{ provide: MAT_DATE_LOCALE, useValue: 'en-GB' }]
})

export class RateViewForLongTermRentalContractComponent implements OnInit {
  displayedColumns = [
    'Package',
    'City',    
  ...
  dataSource: RateViewForLongTermRentalContractModel[] | null;
  CustomerContract_ID: any;
  PackageName: string;
  advanceTable: RateViewForLongTermRentalContractModel | null;
  ...
  constructor(
    ...
    public rateViewForLongTermRentalContractService: RateViewForLongTermRentalContractService,
  ...
  public Filter()
  {
   ...
   public loadData() 
   {
      this.rateViewForLongTermRentalContractService.getTableData(this.CustomerContract_ID).subscribe
      (
        data =>   
        {
  ...
  onContextMenu(event: MouseEvent, item: RateViewForLongTermRentalContractModel) {
