...
@Component({
  standalone: false,
  selector: 'app-add-stops-dialog',
  templateUrl: './add-stops-dialog.component.html',
  styleUrls: ['./add-stops-dialog.component.sass'],
  providers: [{ provide: MAT_DATE_LOCALE, useValue: 'en-GB' }]
})

export class AddStopsDialogComponent 
{
  action: string;
  dialogTitle: string;
  ...
  fileUploadEl: any;
  constructor(
  public dialogRef: MatDialogRef<AddStopsDialogComponent>, 
