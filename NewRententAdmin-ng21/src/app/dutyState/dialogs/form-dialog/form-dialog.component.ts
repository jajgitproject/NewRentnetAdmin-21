...
export class FormDialogComponent 
{
  ...
  public _generalService:GeneralService)
  {
        ...
        {
          this.dialogTitle = ' Duty State';
          this.advanceTable = new  DutyState({});
  ...
  createContactForm(): FormGroup 
  {
    ...
    {
      dutyStateID: [this.advanceTable.dutyStateID || ''],
...
InitStates() {
  this.advanceTableService.GetEcoDutyStateForClosing().subscribe(
    data => {
      this.StateList = data;
