...
import { TripDetailsRoutingModule } from './tripDetails-routing.module';
...
import { BillingInstructionService } from '../billingInstruction/billingInstruction.service';
