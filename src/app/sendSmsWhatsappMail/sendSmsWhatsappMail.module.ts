...
import { FormDialogSendSmsWhatsappMailComponent as advanceTableForm}  from './dialogs/form-dialog/form-dialog.component';
...
import { SendSmsWhatsappMailRoutingModule } from './sendSmsWhatsappMail-routing.module';

@NgModule({
  declarations: [
    SendSmsWhatsappMailComponent,
    advanceTableForm,
  ...
  imports: [
    ...
    FormsModule,
    ReactiveFormsModule,
    SendSmsWhatsappMailRoutingModule,
    MatTableModule,
    MatPaginatorModule,
    MatFormFieldModule,
    MatInputModule,
  ...
  providers: [SendSmsWhatsappMailService]
})
export class SendSmsWhatsappMailModule {}
