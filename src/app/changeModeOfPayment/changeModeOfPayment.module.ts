...
import { ChangeModeOfPaymentRoutingModule } from './changeModeOfPayment-routing.module';
...
@NgModule({
  declarations: [
    ChangeModeOfPaymentComponent,
    ChangeModeOfPaymentFormDialogComponent,
    ChangeModeOfPaymentDetailsComponent
  ],
  imports: [
    CommonModule,
    FormsModule,
    MatTooltipModule,
    ReactiveFormsModule,
    ChangeModeOfPaymentRoutingModule,
  ...
  providers: [ChangeModeOfPaymentService]
})
export class ChangeModeOfPaymentModule {}
