...
@Component({
  standalone: false,
  selector: 'app-sdlimitedRate',
  templateUrl: './sdlimitedRate.component.html',
  styleUrls: ['./sdlimitedRate.component.sass'],
  providers: [{ provide: MAT_DATE_LOCALE, useValue: 'en-GB' }]
})
export class SDLimitedRateComponent implements OnInit {
  displayedColumns = [
  ...
  dataSource: SDLimitedRate[] | null;
  sdlimitedRateID: number;
  advanceTable: SDLimitedRate | null;
  searchSDLimitedRateID: number=0;
  ...
  constructor(
    ...
    public sdlimitedRateService: SDLimitedRateService,
...
InitVehicleCategory(){
  ...
  editCall(row) {
    ...
    this.sdlimitedRateID = row.sdLimitedRateID;
    const dialogRef = this.dialog.open(FormDialogComponent, {
      data: {
        advanceTable: row,
        action: 'edit',
  ...
  public Filter()
  {
   ...
   public loadData() 
   {
      this.sdlimitedRateService.getTableData(
        this.searchSDLimitedRateID,
  ...
  onContextMenu(event: MouseEvent, item: SDLimitedRate) {
    event.preventDefault();
...
/////////////////for Image Upload ends////////////////////////////
  ...
  SubscribeUpdateService()
  {
    ...
    (
      ...
      { 
        ...
        {
          if(this.MessageArray[0]=="SDLimitedRateCreate")
          {
            if(this.MessageArray[1]=="SDLimitedRateView")
            {
          ...
          else if(this.MessageArray[0]=="SDLimitedRateUpdate")
          {
            if(this.MessageArray[1]=="SDLimitedRateView")
            {
              if(this.MessageArray[2]=="Success")
          ...
          else if(this.MessageArray[0]=="SDLimitedRateDelete")
          {
            if(this.MessageArray[1]=="SDLimitedRateView")
            {
              if(this.MessageArray[2]=="Success")
          ...
          else if(this.MessageArray[0]=="SDLimitedRateAll")
          {
            if(this.MessageArray[1]=="SDLimitedRateView")
            {
  ...
  SortingData(coloumName:any) {
    ...
    this.sdlimitedRateService.getTableDataSort(
      this.searchSDLimitedRateID,
      this.customerContractID,
