...
import { RateViewForVendorLocalService } from './rateViewForVendorLocal.service';
import { RateViewForVendorLocalModel } from './rateViewForVendorLocal.model';

@Component({
  standalone: false,
  selector: 'app-rateViewForVendorLocal',
  templateUrl: './rateViewForVendorLocal.component.html',
  styleUrls: ['./rateViewForVendorLocal.component.sass'],
  providers: [{ provide: MAT_DATE_LOCALE, useValue: 'en-GB' }]
})

export class RateViewForVendorLocalComponent implements OnInit {
  displayedColumns = [
    'Package',
  ...
  dataSource: RateViewForVendorLocalModel[] | null;
  VendorContract_ID: any;
  PackageName: string;
  advanceTable: RateViewForVendorLocalModel | null;
  ...
  constructor(
    ...
    public rateViewForVendorLocalService: RateViewForVendorLocalService,
  ...
  public Filter()
  {
   ...
   public loadData() 
   {
      this.rateViewForVendorLocalService.getTableData(this.VendorContract_ID).subscribe
      (
        data =>   
        {
  ...
  onContextMenu(event: MouseEvent, item: RateViewForVendorLocalModel) {
