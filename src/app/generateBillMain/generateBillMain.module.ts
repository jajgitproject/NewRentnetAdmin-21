...
import { GenerateBillMainRoutingModule } from './generateBillMain-routing.module';
...
@NgModule({
  declarations: [
    GenerateBillMainComponent,
    advanceTableForm,
    DeleteDialogComponent,
    OpenPopUpDialogComponent
  ],
  imports: [
    CommonModule,
    FormsModule,
    ReactiveFormsModule,
    GenerateBillMainRoutingModule,
    MatTableModule,
    MatPaginatorModule,
    MatFormFieldModule,
    MatInputModule,
...
export class GenerateBillMainModule {}
