...
import { InventoryPUCRoutingModule } from './inventoryPUC-routing.module';
...
@NgModule({
  ...
  providers: [InventoryPUCService]
})
export class InventoryPUCModule {}
