...
export class DeleteDialogComponent
{
  ...
  confirmDelete()
  {
    this.advanceTableService.delete(this.data.supplierContractCDCLocalID)  
    .subscribe(
    data => 
    {
       this._generalService.sendUpdate('SupplierContractCDCLocalDelete:SupplierContractCDCLocalView:Success');//To Send Updates   
    },
    error =>
    {
