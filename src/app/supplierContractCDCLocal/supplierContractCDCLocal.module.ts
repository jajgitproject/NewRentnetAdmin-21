...
// import { SupplierContractCDCLocalRoutingModule } from './supplierContractCDCLocal-routing.module';
...
@NgModule({
  declarations: [
    SupplierContractCDCLocalComponent,
    advanceTableForm,
  ...
  imports: [
    ...
    ReactiveFormsModule,
    SupplierContractCDCLocalRoutingModule,
    MatTableModule,
    MatPaginatorModule,
    MatFormFieldModule,
    MatInputModule,
  ...
  providers: [SupplierContractCDCLocalService]
})
export class SupplierContractCDCLocalModule {}
