...
export class DeleteDialogComponent
{
  ...
  confirmDelete()
  {
    ...
    this.advanceTableService.delete(this.data.customerBillingExecutiveID)  
    .subscribe(
    data => 
    {
       this._generalService.sendUpdate('CustomerBillingExecutiveDelete:CustomerBillingExecutiveView:Success');//To Send Updates   
    },
    error =>
    {
