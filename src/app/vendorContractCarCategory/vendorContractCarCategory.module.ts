...
import { VendorContractCarCategoryRoutingModule } from './vendorContractCarCategory-routing.module';
import { MyUploadComponent } from '../myupload/myupload.component';
import { MyUploadModule } from '../myupload/myupload.module';
import { ConfirmationDialogComponent } from './dialogs/confirmation-dialog/confirmation-dialog.component';
//import { VendorContractCityTiersModule } from '../vendorContractCityTiers/vendorContractCityTiers.module';
...
@NgModule({
  declarations: [
    VendorContractCarCategoryComponent,
    advanceTableForm,
  ...
  imports: [
    ...
    FormsModule,
    ReactiveFormsModule,
    VendorContractCarCategoryRoutingModule,
    MatTableModule,
    MatPaginatorModule,
    MatFormFieldModule,
    MatInputModule,
  ...
  providers: [VendorContractCarCategoryService]
})
export class VendorContractCarCategoryModule {}
