...
import { VendorContractCarCategoryModel } from '../../vendorContractCarCategory.model';
...
export class FormDialogComponent 
{
  ...
  public vendorCategoryList?: CustomerCategoryDropDown[] = [];
  ...
  public advanceTableService: VendorContractCarCategoryService,
  ...
  public _generalService:GeneralService)
  {
    ...
    if (this.action === 'edit') 
    {
      this.dialogTitle ='Car Catagories for Vendor Contract';       
  ...
  public Post(): void
  {
    ...
    {
        this.dialogRef.close();
       this._generalService.sendUpdate('VendorContractCarCategoryCreate:VendorContractCarCategoryView:Success');//To Send Updates 
       this.saveDisabled = true;    
    },
    error =>
    {
       this._generalService.sendUpdate('VendorContractCarCategoryAll:VendorContractCarCategoryView:Failure');//To Send Updates 
       this.saveDisabled = true; 
    }
  )
  }
  public Put(): void
  {
    ...
    {
        this.dialogRef.close();
       this._generalService.sendUpdate('VendorContractCarCategoryUpdate:VendorContractCarCategoryView:Success');//To Send Updates  
       this.saveDisabled = true;       
    },
    error =>
    {
...
//   if (/[a-zA-Z]/.vendorContractCarCategory(inp)) {
//     return true;
//   } else {
//     event.preventDefault();
//     return false;
