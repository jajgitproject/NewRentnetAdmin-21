...
@Component({
  standalone: false,
  selector: 'app-customerCategoryMapping',
  templateUrl: './customerCategoryMapping.component.html',
  styleUrls: ['./customerCategoryMapping.component.sass'],
  providers: [{ provide: MAT_DATE_LOCALE, useValue: 'en-GB' }]
})
export class CustomerCategoryMappingComponent implements OnInit {
  displayedColumns = [
    'customer',
    'customerCategory',
    'status',
  ...
  dataSource: CustomerCategoryMapping[] | null;
  customerCategoryMappingID: number;
  advanceTable: CustomerCategoryMapping | null;
  ...
  constructor(
    ...
    public customerCategoryMappingService: CustomerCategoryMappingService,
  ...
  editCall(row) {
      //  alert(row.id);
    this.customerCategoryMappingID = row.customerCategoryMappingID;
    const dialogRef = this.dialog.open(FormDialogComponent, {
      data: {
        advanceTable: row,
        action: 'edit',
  ...
  deleteItem(row)
  {
    ...
    this.customerCategoryMappingID = row.id;
  ...
  public Filter()
  {
   ...
   public loadData() 
   {
    switch (this.selectedFilter)
    {
      ...
      this.customerCategoryMappingService.getTableData(this.customerID,this.search.value,this.SearchActivationStatus, this.PageNumber).subscribe
    (
      data =>   
      {
  ...
  onContextMenu(event: MouseEvent, item: CustomerCategoryMapping) {
...
/////////////////for Image Upload ends////////////////////////////
  ...
  SubscribeUpdateService()
  {
    ...
    (
      ...
      { 
        ...
        {
          if(this.MessageArray[0]=="CustomerCategoryMappingCreate")
          {
            if(this.MessageArray[1]=="CustomerCategoryMappingView")
            {
              if(this.MessageArray[2]=="Success")
              {
                ...
                'snackbar-success',
                'Customer Category Mapping Created ...!!!',
                'bottom',
                'center'
              );
              }
          ...
          else if(this.MessageArray[0]=="CustomerCategoryMappingUpdate")
          {
            if(this.MessageArray[1]=="CustomerCategoryMappingView")
            {
              if(this.MessageArray[2]=="Success")
              {
               ...
               this.showNotification(
                'snackbar-success',
                'Customer Category Mapping Updated ...!!!',
                'bottom',
                'center'
              );
              }
          ...
          else if(this.MessageArray[0]=="CustomerCategoryMappingDelete")
          {
            if(this.MessageArray[1]=="CustomerCategoryMappingView")
            {
              if(this.MessageArray[2]=="Success")
              {
               ...
               this.showNotification(
                'snackbar-success',
                'Customer Category Mapping Deleted ...!!!',
                'bottom',
                'center'
              );
              }
          ...
          else if(this.MessageArray[0]=="CustomerCategoryMappingAll")
          {
            if(this.MessageArray[1]=="CustomerCategoryMappingView")
            {
  ...
  SortingData(coloumName:any) {
    ...
    this.customerCategoryMappingService.getTableDataSort(this.customerID,this.searchCustomerCategory,this.SearchActivationStatus, this.PageNumber,coloumName.active,this.sortType).subscribe
    (
      data =>   
      {
        this.dataSource = data;
