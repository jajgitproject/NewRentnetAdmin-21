...
export class FormDialogComponent 
{
  ...
  advanceTable: CustomerCategoryMapping;
  fName = '';
  contents: any[];
  mydata = [];
  name = '';
  ...
  public _generalService:GeneralService)
  {
    this.CustomerID= data.customerID,
        ...
        if (this.action === 'edit') 
        {
          this.dialogTitle ='Category Mapping';       
          this.advanceTable = data.advanceTable;
          this.searchCategoryBy.setValue(this.advanceTable.customerCategory)
        } else 
        {
          this.dialogTitle = 'Category Mapping';
          this.advanceTable = new CustomerCategoryMapping({});
  ...
  customerCategoryValidator(customerCategoryList: any[]): ValidatorFn {
    return (control: AbstractControl): ValidationErrors | null => {
      ...
      return match ? null : { customerCategoryInvalid: true };
    };
  }
  ...
  initCustomerCategory(){
    this._generalService.getCustomerCategory().subscribe(
      data=>{
        ...
        this.filteredCategoryOptionss = this.advanceTableForm.controls['customerCategory'].valueChanges.pipe(
          startWith(""),
  ...
  {
    const CategoryName = this.customerCategoryList.find(
      data => data.customerCategory === selectedCategory
    );
    if (selectedCategory) 
    {
      this.getemployeeIDTitles(CategoryName.customerCategoryID);
    }
  }  
  getemployeeIDTitles(customerCategoryID: any)
  {
  ...
  createContactForm(): FormGroup 
  {
    ...
    {
      customerCategoryMappingID: [this.advanceTable.customerCategoryMappingID],
  ...
  public Post(): void
  {
    ...
    {
        this.dialogRef.close();
       this._generalService.sendUpdate('CustomerCategoryMappingCreate:CustomerCategoryMappingView:Success');//To Send Updates 
  ...
  public Put(): void
  {
    ...
    {
        this.dialogRef.close();
       this._generalService.sendUpdate('CustomerCategoryMappingUpdate:CustomerCategoryMappingView:Success');//To Send Updates 
       this.saveDisabled = true; 
