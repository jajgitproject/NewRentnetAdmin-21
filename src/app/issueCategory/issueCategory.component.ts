...
import { FormDialogComponent } from '../issueCategory/dialogs/form-dialog/form-dialog.component';
import { DeleteDialogCityComponent } from '../dashboard/city-master/dialogscity/delete-city/delete-city.component';
import { DeleteDialogComponent } from './dialogs/delete/delete.component';
import { FormControl } from '@angular/forms';
@Component({
  standalone: false,
  selector: 'app-issuecategory',
  templateUrl: './issuecategory.component.html',
  styleUrls: ['./issuecategory.component.sass'],
...
shouldShowDeleteButton(item: any): boolean {
  ...
  onBackPress(event) {
   ...
   public loadData() 
   {
    if(this.selectedFilter==='IssueCategory')
    {
  ...
  onContextMenu(event: MouseEvent, item: IssueCategory) {
  ...
  SubscribeUpdateService()
  {
    ...
    (
      ...
      { 
        ...
        {
          if(this.MessageArray[0]=="IssueCategoryCreate")
          {
            if(this.MessageArray[1]=="IssueCategoryView")
            {
          ...
          else if(this.MessageArray[0]=="IssueCategoryUpdate")
          {
            if(this.MessageArray[1]=="IssueCategoryView")
            {
              if(this.MessageArray[2]=="Success")
          ...
          else if(this.MessageArray[0]=="IssueCategoryDelete")
          {
            if(this.MessageArray[1]=="IssueCategoryView")
            {
              if(this.MessageArray[2]=="Success")
          ...
          else if(this.MessageArray[0]=="IssueCategoryAll")
          {
            if(this.MessageArray[1]=="IssueCategoryView")
            {
