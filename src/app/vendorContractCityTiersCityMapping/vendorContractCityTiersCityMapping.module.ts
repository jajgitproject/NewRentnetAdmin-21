...
import { VendorContractCityTiersCityMappingRoutingModule } from './vendorContractCityTiersCityMapping-routing.module';
...
@NgModule({
  declarations: [
    VendorContractCityTiersCityMappingComponent,
    advanceTableForm,
  ...
  imports: [
    ...
    FormsModule,
    ReactiveFormsModule,
    VendorContractCityTiersCityMappingRoutingModule,
    MatTableModule,
    MatPaginatorModule,
    MatFormFieldModule,
    MatInputModule,
  ...
  providers: [VendorContractCityTiersCityMappingService]
})
export class VendorContractCityTiersCityMappingModule {}
