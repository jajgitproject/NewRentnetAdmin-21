...
import { DateWiseCarwiseBookingReportRoutingModule } from './dateWiseCarwiseBookingReport-routing.module';
import { MatAutocompleteModule } from '@angular/material/autocomplete';
import { MatTooltipModule } from '@angular/material/tooltip';

@NgModule({
  declarations: [
    DateWiseCarwiseBookingReportComponent,
    // advanceTableForm,
  ...
  imports: [
    ...
    FormsModule,
    ReactiveFormsModule,
    DateWiseCarwiseBookingReportRoutingModule,
    MatTableModule,
    MatPaginatorModule,
    MatFormFieldModule,
    MatInputModule,
  ...
  providers: [DateWiseCarwiseBookingReportService]
})
export class DateWiseCarwiseBookingReportModule {}
