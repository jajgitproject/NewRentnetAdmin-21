...
import { InventoryFitnessRoutingModule } from './inventoryFitness-routing.module';
...
@NgModule({
  ...
  providers: [InventoryFitnessService]
})
export class InventoryFitnessModule {}
