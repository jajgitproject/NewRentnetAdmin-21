...
@Component({
  standalone: false,
  selector: 'app-supplierContractSDCSelfDriveHourlyUnlimited',
  templateUrl: './supplierContractSDCSelfDriveHourlyUnlimited.component.html',
  styleUrls: ['./supplierContractSDCSelfDriveHourlyUnlimited.component.sass'],
  providers: [{ provide: MAT_DATE_LOCALE, useValue: 'en-GB' }]
})
export class SupplierContractSDCSelfDriveHourlyUnlimitedComponent implements OnInit {
  displayedColumns = [
    'vehicleCategory',
    'cityTierName',
    'package',
  ...
  dataSource: SupplierContractSDCSelfDriveHourlyUnlimited[] | null;
  supplierContractSDCSelfDriveHourlyUnlimitedID: number;
  advanceTable: SupplierContractSDCSelfDriveHourlyUnlimited | null;
  searchSupplierContractSDCSelfDriveHourlyUnlimitedID: number=0;
...
SearchMinimumHRs: string ='';
  constructor(
    ...
    public supplierContractSDCSelfDriveHourlyUnlimitedService: SupplierContractSDCSelfDriveHourlyUnlimitedService,
...
@ViewChild(MatMenuTrigger)
 ...
 InitPackage(){
  ...
  refresh() {
    this.searchSupplierContractSDCSelfDriveHourlyUnlimitedID=0;
    this.vehicleCategory.setValue('');
    this.cityTier.setValue('');
    this.package.setValue('');
    this.SearchBaseRate='';
    this.SearchMinimumHRs=''
    this.searchTerm='';
  ...
  editCall(row) {
      //  alert(row.id);
    this.supplierContractSDCSelfDriveHourlyUnlimitedID = row.supplierContractSDCSelfDriveHourlyUnlimitedID;
    const dialogRef = this.dialog.open(FormDialogComponent, {
      data: {
        advanceTable: row,
        action: 'edit',
  ...
  deleteItem(row)
  {
    ...
    this.supplierContractSDCSelfDriveHourlyUnlimitedID = row.id;
   ...
   public loadData() 
   {
    switch (this.selectedFilter)
    {
      ...
      case 'baseRate':
        ...
        break;
        case 'minimumHRs':
        this.SearchMinimumHRs = this.searchTerm;
        break;
      default:
        this.searchTerm = '';
        break;
    }
      this.supplierContractSDCSelfDriveHourlyUnlimitedService.getTableData(
        this.searchSupplierContractSDCSelfDriveHourlyUnlimitedID,
  ...
  onContextMenu(event: MouseEvent, item: SupplierContractSDCSelfDriveHourlyUnlimited) {
    event.preventDefault();
...
/////////////////for Image Upload ends////////////////////////////
  ...
  SubscribeUpdateService()
  {
    ...
    (
      ...
      { 
        ...
        {
          if(this.MessageArray[0]=="SupplierContractSDCSelfDriveHourlyUnlimitedCreate")
          {
            if(this.MessageArray[1]=="SupplierContractSDCSelfDriveHourlyUnlimitedView")
            {
              if(this.MessageArray[2]=="Success")
              {
                ...
                'snackbar-success',
                'Supplier Contract SDC Self Drive Hourly Unlimited Created...!!!',
                'bottom',
                'center'
              );
              }
          ...
          else if(this.MessageArray[0]=="SupplierContractSDCSelfDriveHourlyUnlimitedUpdate")
          {
            if(this.MessageArray[1]=="SupplierContractSDCSelfDriveHourlyUnlimitedView")
            {
              if(this.MessageArray[2]=="Success")
              {
               ...
               this.showNotification(
                'snackbar-success',
                'Supplier Contract SDC Self Drive Hourly Unlimited Updated...!!!',
                'bottom',
                'center'
              );
              }
          ...
          else if(this.MessageArray[0]=="SupplierContractSDCSelfDriveHourlyUnlimitedDelete")
          {
            if(this.MessageArray[1]=="SupplierContractSDCSelfDriveHourlyUnlimitedView")
            {
              if(this.MessageArray[2]=="Success")
              {
               ...
               this.showNotification(
                'snackbar-success',
                'Supplier Contract SDC Self Drive Hourly Unlimited Deleted ...!!!',
                'bottom',
                'center'
              );
              }
          ...
          else if(this.MessageArray[0]=="SupplierContractSDCSelfDriveHourlyUnlimitedAll")
          {
            if(this.MessageArray[1]=="SupplierContractSDCSelfDriveHourlyUnlimitedView")
            {
  ...
  SortingData(coloumName:any) {
    ...
    this.supplierContractSDCSelfDriveHourlyUnlimitedService.getTableDataSort(
      this.searchSupplierContractSDCSelfDriveHourlyUnlimitedID,
      this.supplierContract_ID,
