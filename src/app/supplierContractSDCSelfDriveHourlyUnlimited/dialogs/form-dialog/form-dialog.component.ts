...
export class FormDialogComponent 
{
  ...
  advanceTable: SupplierContractSDCSelfDriveHourlyUnlimited;
  fName = '';
  contents: any[];
  mydata = [];
  name = '';
  ...
  public _generalService:GeneralService)
  {
        ...
        if (this.action === 'edit') 
        {
          this.dialogTitle ='Self Driven Car Hourly Unlimited KM Package';       
        ...
        {
          this.dialogTitle = 'Self Driven Car Hourly Unlimited KM Package';
          this.advanceTable = new SupplierContractSDCSelfDriveHourlyUnlimited({});
...
getpackageID(packageID: any) {
  ...
  createContactForm(): FormGroup 
  {
    ...
    {
      supplierContractSDCSelfDriveHourlyUnlimitedID: [this.advanceTable.supplierContractSDCSelfDriveHourlyUnlimitedID],
      ...
      minimumHRs: [this.advanceTable.minimumHRs],
...
numberOnly(event): boolean {
  ...
  public Post(): void
  {
    ...
    response => 
    {
      this.isLoading = false;
        this.dialogRef.close();
       this._generalService.sendUpdate('SupplierContractSDCSelfDriveHourlyUnlimitedCreate:SupplierContractSDCSelfDriveHourlyUnlimitedView:Success');//To Send Updates  
  ...
  public Put(): void
  {
    ...
    response => 
    {
      this.isLoading = false;
        this.dialogRef.close();
       this._generalService.sendUpdate('SupplierContractSDCSelfDriveHourlyUnlimitedUpdate:SupplierContractSDCSelfDriveHourlyUnlimitedView:Success');//To Send Updates  
