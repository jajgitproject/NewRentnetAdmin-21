...
import { SupplierContractCDCOutStationRoundTripRoutingModule } from './supplierContractCDCOutStationRoundTrip-routing.module';
...
@NgModule({
  declarations: [
    SupplierContractCDCOutStationRoundTripComponent,
    advanceTableForm,
  ...
  imports: [
    ...
    ReactiveFormsModule,
    SupplierContractCDCOutStationRoundTripRoutingModule,
    MatTableModule,
    MatPaginatorModule,
    MatFormFieldModule,
    MatInputModule,
  ...
  providers: [SupplierContractCDCOutStationRoundTripService]
})
export class SupplierContractCDCOutStationRoundTripModule {}
