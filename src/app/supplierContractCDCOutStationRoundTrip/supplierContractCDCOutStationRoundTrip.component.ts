...
@Component({
  standalone: false,
  selector: 'app-supplierContractCDCOutStationRoundTrip',
  templateUrl: './supplierContractCDCOutStationRoundTrip.component.html',
  styleUrls: ['./supplierContractCDCOutStationRoundTrip.component.sass'],
  providers: [{ provide: MAT_DATE_LOCALE, useValue: 'en-GB' }]
})
export class SupplierContractCDCOutStationRoundTripComponent implements OnInit {
  [x: string]: any;
  displayedColumns = [
    'vehicleCategory',
    'cityTierName',
  ...
  dataSource: SupplierContractCDCOutStationRoundTrip[] | null;
  supplierContractCDCOutStationRoundTripID: number;
  advanceTable: SupplierContractCDCOutStationRoundTrip | null;
...
filteredPackageOptions: Observable<PackageDropDown[]>;
  ...
  constructor(
    ...
    public supplierContractCDCOutStationRoundTripService: SupplierContractCDCOutStationRoundTripService,
...
@ViewChild(MatMenuTrigger)
 ...
 InitPackage(){
  ...
  editCall(row) {
      //  alert(row.id);
    this.supplierContractCDCOutStationRoundTripID = row.supplierContractCDCOutStationRoundTripID;
    const dialogRef = this.dialog.open(FormDialogComponent, {
      data: {
        advanceTable: row,
        action: 'edit',
  ...
  deleteItem(row)
  {
    ...
    this.supplierContractCDCOutStationRoundTripID = row.id;
   ...
   public loadData() 
   {
    switch (this.selectedFilter)
    {
      ...
      case 'package':
        ...
        break;
      case 'ratePerDay':
        this.searchratePerDay = this.searchTerm;
        break;
      default:
        this.searchTerm = '';
        break;
      ...
      this.supplierContractCDCOutStationRoundTripService.getTableData(
  ...
  onContextMenu(event: MouseEvent, item: SupplierContractCDCOutStationRoundTrip) {
...
/////////////////for Image Upload ends////////////////////////////
  ...
  SubscribeUpdateService()
  {
    ...
    (
      ...
      { 
        ...
        {
          if(this.MessageArray[0]=="SupplierContractCDCOutStationRoundTripCreate")
          {
            if(this.MessageArray[1]=="SupplierContractCDCOutStationRoundTripView")
            {
              if(this.MessageArray[2]=="Success")
              {
                ...
                'snackbar-success',
                'Supplier Contract CDC OutStation Round Trip Created...!!!',
                'bottom',
                'center'
              );
              }
          ...
          else if(this.MessageArray[0]=="SupplierContractCDCOutStationRoundTripUpdate")
          {
            if(this.MessageArray[1]=="SupplierContractCDCOutStationRoundTripView")
            {
              if(this.MessageArray[2]=="Success")
              {
               ...
               this.showNotification(
                'snackbar-success',
                'Supplier Contract CDC OutStation Round Trip Updated...!!!',
                'bottom',
                'center'
              );
              }
          ...
          else if(this.MessageArray[0]=="SupplierContractCDCOutStationRoundTripDelete")
          {
            if(this.MessageArray[1]=="SupplierContractCDCOutStationRoundTripView")
            {
              if(this.MessageArray[2]=="Success")
              {
               ...
               this.showNotification(
                'snackbar-success',
                'Supplier Contract CDC OutStation Round Trip Deleted...!!!',
                'bottom',
                'center'
              );
              }
          ...
          else if(this.MessageArray[0]=="SupplierContractCDCOutStationRoundTripAll")
          {
            if(this.MessageArray[1]=="SupplierContractCDCOutStationRoundTripView")
            {
  ...
  SortingData(coloumName:any) {
    ...
    this.supplierContractCDCOutStationRoundTripService.getTableDataSort(
      this.supplierContract_ID ,
