...
export class BankComponent implements OnInit {
  ...
  dataSource: Bank[] | null;
  bankID: number;
  advanceTable: Bank | null;
  SearchBank: string = '';
...
shouldShowDeleteButton(item: any): boolean {
  ...
  onBackPress(event) {
   ...
   public loadData() 
   {
    ...
    {
      this.SearchBank=this.searchTerm;
    }
      this.bankService.getTableData(this.SearchBank,this.SearchActivationStatus, this.PageNumber).subscribe
      (
        data =>   
        {
...
/////////////////for Image Upload ends////////////////////////////
  ...
  SortingData(coloumName:any) {
    ...
    this.bankService.getTableDataSort(this.SearchBank,this.SearchActivationStatus, this.PageNumber,coloumName.active,this.sortType).subscribe
    (
      data =>   
      {
        this.dataSource = data;
