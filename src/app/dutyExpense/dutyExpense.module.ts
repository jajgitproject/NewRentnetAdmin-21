...
import { DutyExpenseRoutingModule } from './dutyExpense-routing.module';
...
@NgModule({
  ...
  exports:[DutyExpenseComponent],
  providers: [DutyExpenseService]
})
export class DutyExpenseModule {}
