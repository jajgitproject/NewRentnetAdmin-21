...
import { SetAsCustomerKAMRoutingModule } from './setAsCustomerKAM-routing.module';
// import { TwoDigitDecimaNumberDirective } from './twodigitdecimalnumber.directive';


@NgModule({
  declarations: [
    SetAsCustomerKAMComponent
  ],
  imports: [
  ...
  providers: [SetAsCustomerKAMService,CustomerCorporateIndividualService]
})
export class SetAsCustomerKAMModule {}
