...
export class FormDialogComponent 
{
  ...
  advanceTable: SupplierContractSDCSelfDriveUnLimited;
  fName = '';
  contents: any[];
  mydata = [];
  name = '';
  ...
  public _generalService:GeneralService)
  {
        ...
        if (this.action === 'edit') 
        {
          this.dialogTitle ='Self Driven Car Unlimited KM Package';       
        ...
        {
          this.dialogTitle = 'Self Driven Car Unlimited KM Package';
          this.advanceTable = new SupplierContractSDCSelfDriveUnLimited({});
...
getpackageID(packageID: any) {
  ...
  createContactForm(): FormGroup 
  {
    return this.fb.group(
    {
      ...
      graceHRs: [this.advanceTable.graceHRs],
  ...
  public Post(): void
  {
    ...
    response => 
    {
      this.isLoading = false;
        this.dialogRef.close();
       this._generalService.sendUpdate('SupplierContractSDCSelfDriveUnLimitedCreate:SupplierContractSDCSelfDriveUnLimitedView:Success');//To Send Updates  
  ...
  public Put(): void
  {
    ...
    response => 
    {
      this.isLoading = false;
        this.dialogRef.close();
       this._generalService.sendUpdate('SupplierContractSDCSelfDriveUnLimitedUpdate:SupplierContractSDCSelfDriveUnLimitedView:Success');//To Send Updates  
...
//   if (/[a-zA-Z]/.supplierContractSDCSelfDriveUnLimited(inp)) {
//     return true;
//   } else {
//     event.preventDefault();
//     return false;
