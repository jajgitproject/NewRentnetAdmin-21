...
@Component({
  standalone: false,
  selector: 'app-supplierContractSDCSelfDriveUnLimited',
  templateUrl: './supplierContractSDCSelfDriveUnLimited.component.html',
  styleUrls: ['./supplierContractSDCSelfDriveUnLimited.component.sass'],
  providers: [{ provide: MAT_DATE_LOCALE, useValue: 'en-GB' }]
})
export class SupplierContractSDCSelfDriveUnLimitedComponent implements OnInit {
  displayedColumns = [
    'vehicleCategory',
    'cityTierName',
    'package',
  ...
  dataSource: SupplierContractSDCSelfDriveUnLimited[] | null;
  supplierContractSDCSelfDriveUnLimitedID: number;
  advanceTable: SupplierContractSDCSelfDriveUnLimited | null;
...
filteredPackageOptions: Observable<PackageDropDown[]>;
  ...
  constructor(
    ...
    public supplierContractSDCSelfDriveUnLimitedService: SupplierContractSDCSelfDriveUnLimitedService,
 ...
 initPackage(){
  ...
  editCall(row) {
      //  alert(row.id);
    this.supplierContractSDCSelfDriveUnLimitedID = row.supplierContractSDCSelfDriveUnLimitedID;
    const dialogRef = this.dialog.open(FormDialogComponent, {
      data: {
        advanceTable: row,
        action: 'edit',
  ...
  deleteItem(row)
  {
    ...
    this.supplierContractSDCSelfDriveUnLimitedID = row.id;
   ...
   public loadData() 
   {
    switch (this.selectedFilter)
    {
      ...
      case 'baseRate':
        ...
        break;
        case 'minimumDays':
        this.SearchminimumDays = this.searchTerm;
        break;
      default:
        this.searchTerm = '';
        break;
    }
      this.supplierContractSDCSelfDriveUnLimitedService.getTableData(
  ...
  onContextMenu(event: MouseEvent, item: SupplierContractSDCSelfDriveUnLimited) {
    event.preventDefault();
...
/////////////////for Image Upload ends////////////////////////////
  ...
  SubscribeUpdateService()
  {
    ...
    (
      ...
      { 
        ...
        {
          if(this.MessageArray[0]=="SupplierContractSDCSelfDriveUnLimitedCreate")
          {
            if(this.MessageArray[1]=="SupplierContractSDCSelfDriveUnLimitedView")
            {
              if(this.MessageArray[2]=="Success")
              {
                ...
                'snackbar-success',
                'Supplier Contract SDC Self Drive UnLimited Created..!!!',
                'bottom',
                'center'
              );
              }
          ...
          else if(this.MessageArray[0]=="SupplierContractSDCSelfDriveUnLimitedUpdate")
          {
            if(this.MessageArray[1]=="SupplierContractSDCSelfDriveUnLimitedView")
            {
              if(this.MessageArray[2]=="Success")
              {
               ...
               this.showNotification(
                'snackbar-success',
                'Supplier Contract SDC Self Drive UnLimited Updated ...!!!',
                'bottom',
                'center'
              );
              }
          ...
          else if(this.MessageArray[0]=="SupplierContractSDCSelfDriveUnLimitedDelete")
          {
            if(this.MessageArray[1]=="SupplierContractSDCSelfDriveUnLimitedView")
            {
              if(this.MessageArray[2]=="Success")
              {
               ...
               this.showNotification(
                'snackbar-success',
                'Supplier Contract SDC Self Drive UnLimited Deleted ...!!!',
                'bottom',
                'center'
              );
              }
          ...
          else if(this.MessageArray[0]=="SupplierContractSDCSelfDriveUnLimitedAll")
          {
            if(this.MessageArray[1]=="SupplierContractSDCSelfDriveUnLimitedView")
            {
  ...
  SortingData(coloumName:any) {
    ...
    this.supplierContractSDCSelfDriveUnLimitedService.getTableDataSort(
      this.supplierContract_ID ,
