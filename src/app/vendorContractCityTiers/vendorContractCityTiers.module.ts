...
import { VendorContractCityTiersRoutingModule } from './vendorContractCityTiers-routing.module';
...
@NgModule({
  declarations: [
    VendorContractCityTiersComponent,
    advanceTableForm,
  ...
  imports: [
    ...
    FormsModule,
    ReactiveFormsModule,
    VendorContractCityTiersRoutingModule,
    MatTableModule,
    MatPaginatorModule,
    MatFormFieldModule,
    MatInputModule,
  ...
  providers: [VendorContractCityTiersService,VendorContractCarCategoryService]
})
export class VendorContractCityTiersModule {}
