...
import { ReservationGroupModel } from './migrationBookingConfiguration.model';
@Injectable()
export class MigrationBookingConfigurationService {
  ...
  constructor(private httpClient: HttpClient, public generalService: GeneralService) {
    this.API_URL = generalService.BaseURL + "migrationBookingConfiguration";
  }
