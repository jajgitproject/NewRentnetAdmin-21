...
import { MigrationBookingConfigurationRoutingModule } from './migrationBookingConfiguration-routing.module';
...
@NgModule({
  declarations: [
    MigrationBookingConfigurationComponent,
  ...
  imports: [
    ...
    MatTooltipModule,
    ReactiveFormsModule,
    MigrationBookingConfigurationRoutingModule,
  ...
  providers: [MigrationBookingConfigurationService,ReservationService]
})
export class MigrationBookingConfigurationModule {}
