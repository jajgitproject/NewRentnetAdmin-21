...
@Component({
  standalone: false,
  selector: 'app-supplierContractCDCLongTermRental',
  templateUrl: './supplierContractCDCLongTermRental.component.html',
  styleUrls: ['./supplierContractCDCLongTermRental.component.sass'],
  providers: [{ provide: MAT_DATE_LOCALE, useValue: 'en-GB' }]
})
export class SupplierContractCDCLongTermRentalComponent implements OnInit {
  displayedColumns = [
    'vehicleCategory',
    'cityTierName',
    'package',
  ...
  dataSource: SupplierContractCDCLongTermRental[] | null;
  supplierContractCDCLongTermRentalID: number;
  advanceTable: SupplierContractCDCLongTermRental | null;
  searchSupplierContractCDCLongTermRentalID: number=0;
 ...
 filterSelected:boolean = true;
  ...
  totalDays : FormControl = new FormControl();
  ...
  constructor(
    ...
    public supplierContractCDCLongTermRentalService: SupplierContractCDCLongTermRentalService,
  ...
  editCall(row) {
      //  alert(row.id);
    this.supplierContractCDCLongTermRentalID = row.supplierContractCDCLongTermRentalID;
    const dialogRef = this.dialog.open(FormDialogComponent, {
      data: {
        advanceTable: row,
        action: 'edit',
  ...
  deleteItem(row)
  {
    ...
    this.supplierContractCDCLongTermRentalID = row.id;
   ...
   public loadData() 
   {
      ...
      switch (this.selectedFilter)
      {
        ...
        case 'package':
          ...
          break;
        case 'totalDays':
          this.SearchTotalDays = this.searchTerm;
          break;
        default:
          this.searchTerm = '';
          break;
      ...
      this.supplierContractCDCLongTermRentalService.getTableData(
        this.searchSupplierContractCDCLongTermRentalID,
  ...
  onContextMenu(event: MouseEvent, item: SupplierContractCDCLongTermRental) {
    event.preventDefault();
...
/////////////////for Image Upload ends////////////////////////////
  ...
  SubscribeUpdateService()
  {
    ...
    (
      ...
      { 
        ...
        {
          if(this.MessageArray[0]=="SupplierContractCDCLongTermRentalCreate")
          {
            if(this.MessageArray[1]=="SupplierContractCDCLongTermRentalView")
            {
              if(this.MessageArray[2]=="Success")
              {
                ...
                'snackbar-success',
                'Supplier Contract CDC Long Term Rental Created Successfully...!!!',
                'bottom',
                'center'
              );
              }
          ...
          else if(this.MessageArray[0]=="SupplierContractCDCLongTermRentalUpdate")
          {
            if(this.MessageArray[1]=="SupplierContractCDCLongTermRentalView")
            {
              if(this.MessageArray[2]=="Success")
              {
               ...
               this.showNotification(
                'snackbar-success',
                'Supplier Contract CDC Long Term Rental Updated Successfully...!!!',
                'bottom',
                'center'
              );
              }
          ...
          else if(this.MessageArray[0]=="SupplierContractCDCLongTermRentalDelete")
          {
            if(this.MessageArray[1]=="SupplierContractCDCLongTermRentalView")
            {
              if(this.MessageArray[2]=="Success")
              {
               ...
               this.showNotification(
                'snackbar-success',
                'Supplier Contract CDC Long Term Rental Deleted Successfully...!!!',
                'bottom',
                'center'
              );
              }
          ...
          else if(this.MessageArray[0]=="SupplierContractCDCLongTermRentalAll")
          {
            if(this.MessageArray[1]=="SupplierContractCDCLongTermRentalView")
            {
  ...
  SortingData(coloumName:any) {
    ...
    this.supplierContractCDCLongTermRentalService.getTableDataSort(
      this.searchSupplierContractCDCLongTermRentalID,
      this.supplierContract_ID,
