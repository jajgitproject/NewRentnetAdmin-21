...
import { GenerateEInvoiceRoutingModule } from './generateEInvoice-routing.module';
...
@NgModule({
  declarations: [
    ...
    FormDialogComponent,
    ConfirmGenerateEInvoiceComponent
  ],
  imports: [
    //BrowserModule,
    CommonModule,
  ...
  providers: [GenerateEInvoiceService, DynamicEInvoiceService, DynamicEInvoiceDetailsService]
})
