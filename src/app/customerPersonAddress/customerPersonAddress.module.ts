...
import { CustomerPersonAddressComponent } from './customerPersonAddress.component';
...
import { CustomerPersonAddressRoutingModule } from './customerPersonAddress-routing.module';
...
@NgModule({
  ...
  imports: [
    ...
    FormsModule,
    ReactiveFormsModule,
    CustomerPersonAddressRoutingModule,
    MatTableModule,
    MatPaginatorModule,
    MatFormFieldModule,
    MatInputModule,
  ...
  providers: [CustomerPersonAddressService]
})
export class CustomerPersonAddressModule {}
