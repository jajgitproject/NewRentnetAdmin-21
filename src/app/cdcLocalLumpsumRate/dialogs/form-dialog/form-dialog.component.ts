...
export class FormDialogComponent 
{
  ...
  advanceTable: CDCLocalLumpsumRate;
  ...
  public _generalService:GeneralService)
  {
        ...
        {
          this.dialogTitle = 'Chauffeur Driven Car Local Lumpsum Package';
          this.advanceTable = new CDCLocalLumpsumRate({});
  ...
  InitPackage(){
    this._generalService.GetPackageForCDC(2).subscribe(
      data=>{
  ...
  createContactForm(): FormGroup 
  {
    ...
    {
      cdcLocalLumpsumRateID: [this.advanceTable.cdcLocalLumpsumRateID],
...
numberOnly(event): boolean {
   ...
   this.advanceTableForm.patchValue({packageID:this.packageID});
    ...
    .subscribe(
      response => {
        ...
        {
          this.dialogRef.close();
          this._generalService.sendUpdate('CDCLocalLumpsumRateCreate:CDCLocalLumpsumRateView:Success');//To Send Updates  
          this.saveDisabled = true;
        } 
      },
      error =>
      {
        this._generalService.sendUpdate('CDCLocalLumpsumRateAll:CDCLocalLumpsumRateView:Failure');//To Send Updates 
        this.saveDisabled = true; 
      }
    )
  }
  public Put(): void
  {
    ...
    .subscribe(
      response => {
        ...
        {
          this.dialogRef.close();
          this._generalService.sendUpdate('CDCLocalLumpsumRateUpdate:CDCLocalLumpsumRateView:Success');//To Send Updates  
          this.saveDisabled = true;
        } 
      },
      error =>
  ...
  public Duplicate(): void
  {
    ...
    response => 
    {
      ...
      {
        this.dialogRef.close();
        this._generalService.sendUpdate('CDCLocalLumpsumRateUpdate:CDCLocalLumpsumRateView:Success');
        this.saveDisabled = true; 
      }
    },
    error =>
    {
     this._generalService.sendUpdate('CDCLocalLumpsumRateAll:CDCLocalLumpsumRateView:Failure');
     this.saveDisabled = true;
    }
  )
  }
