...
import { DutyAllotmentStatusSearchRoutingModule } from './dutyAllotmentStatusSearch-routing.module';
import { MatAutocompleteModule } from '@angular/material/autocomplete';
import { MatTooltipModule } from '@angular/material/tooltip';

@NgModule({
  declarations: [
    DutyAllotmentStatusSearchComponent,
    // advanceTableForm,
  ...
  imports: [
    ...
    FormsModule,
    ReactiveFormsModule,
    DutyAllotmentStatusSearchRoutingModule,
    MatTableModule,
    MatPaginatorModule,
    MatFormFieldModule,
    MatInputModule,
  ...
  providers: [DutyAllotmentStatusSearchService]
})
export class DutyAllotmentStatusSearchModule {}
