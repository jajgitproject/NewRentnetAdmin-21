...
@Injectable()
export class BookerBookingPageService 
{
  ...
  {
    this.API_URL=generalService.BaseURL+ "BookerBookingPage";
  }
  /** CRUD METHODS */
  ...
  add(advanceTable: BookerBookingPage) 
  {
    
    return this.httpClient.post<any>(this.API_URL , advanceTable);
  }
  update(advanceTable: BookerBookingPage)
  {
