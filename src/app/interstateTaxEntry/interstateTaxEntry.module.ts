...
import { InterstateTaxEntryRoutingModule } from './interstateTaxEntry-routing.module';
import { MatAutocompleteModule } from '@angular/material/autocomplete';


@NgModule({
  declarations: [
    InterstateTaxEntryComponent,
    advanceTableForm,
  ...
  imports: [
    ...
    FormsModule,
    ReactiveFormsModule,
    InterstateTaxEntryRoutingModule,
    MatTableModule,
    MatPaginatorModule,
    MatFormFieldModule,
    MatInputModule,
  ...
  providers: [InterstateTaxEntryService]
})
export class InterstateTaxEntryModule {}
