...
import { ReservationGroupDetailsRoutingModule } from './reservationGroupDetails-routing.module';
...
@NgModule({
  declarations: [
    ...
    NewDuplicateDialogComponent,
    DuplicateWithRangeDialogComponent
  ],
  imports: [
    CommonModule,
    FormsModule,
    ReactiveFormsModule,
    ReservationGroupDetailsRoutingModule,
    MatTableModule,
    MatPaginatorModule,
    MatFormFieldModule,
    MatInputModule,
