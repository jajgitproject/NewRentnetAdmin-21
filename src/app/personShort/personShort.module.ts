...
import { FormDialogPersonShortComponent as advanceTableForm } from './dialogs/form-dialog/form-dialog.component';
...
import { PersonShortRoutingModule } from './personShort-routing.module';
...
@NgModule({
  ...
  providers: [PersonShortService]
})
export class PersonShortModule {}
