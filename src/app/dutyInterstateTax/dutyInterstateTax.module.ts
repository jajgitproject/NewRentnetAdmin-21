...
import { DITFormDialogComponent as advanceTableForm } from './dialogs/form-dialog/form-dialog.component';
...
import { DutyInterstateTaxRoutingModule } from './dutyInterstateTax-routing.module';
...
@NgModule({
  ...
  imports: [
    ...
    FormsModule,
    ReactiveFormsModule,
    DutyInterstateTaxRoutingModule,
    MatTableModule,
    MatPaginatorModule,
    MatFormFieldModule,
    MatInputModule,
...
export class DutyInterstateTaxModule {}
