...
import { SDUnLimitedRateRoutingModule } from './sdUnLimitedRate-routing.module';
...
@NgModule({
  ...
  providers: [SDUnLimitedRateService]
})
export class SDUnLimitedRateModule {}
