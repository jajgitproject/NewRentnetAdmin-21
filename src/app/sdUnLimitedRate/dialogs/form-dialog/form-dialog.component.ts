...
export class FormDialogComponent 
{
  ...
  public _generalService:GeneralService)
  {
    this.CustomerContractID= data.customerContractID,
        ...
        if (this.action === 'edit') 
        {
          this.dialogTitle ='Self Driven Car Unlimited Package'	;       
          this.advanceTable = data.advanceTable;

          this.searchVehicleCategory.setValue(this.advanceTable.customerContractCarCategory);
          this.searchCityTier.setValue(this.advanceTable.customerContractCityTier);
          this.searchPackage.setValue(this.advanceTable.package);

        } else 
        {
          this.dialogTitle = 'Self Driven Car Unlimited Package';
          this.advanceTable = new SDUnLimitedRate({});
  ...
  InitVehicleCategory(){
    this._generalService.GetCarCategory(this.data.customerContractID).subscribe(
      data=>
      {
        ...
        this.filteredVehicleCategoryOptions = this.advanceTableForm.controls['customerContractCarCategory'].valueChanges.pipe(
          startWith(""),
  ...
  createContactForm(): FormGroup 
  {
    ...
    {
      sdUnLimitedRateID: [this.advanceTable.sdUnLimitedRateID],
...
numberOnly(event): boolean {
  ...
  public Post(): void
  {
    ...
    {
        this.dialogRef.close();
       this._generalService.sendUpdate('SDUnLimitedRateCreate:SDUnLimitedRateView:Success');//To Send Updates  
  ...
  public Put(): void
  {
    ...
    {
        this.dialogRef.close();
       this._generalService.sendUpdate('SDUnLimitedRateUpdate:SDUnLimitedRateView:Success');//To Send Updates  
