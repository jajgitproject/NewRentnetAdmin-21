...
import { AdditionalServiceRateRoutingModule } from './additionalServiceRate-routing.module';
...
@NgModule({
  declarations: [
    AdditionalServiceRateComponent,
    advanceTableForm,
  ...
  imports: [
    ...
    FormsModule,
    ReactiveFormsModule,
    AdditionalServiceRateRoutingModule,
    MatTableModule,
    MatPaginatorModule,
    MatFormFieldModule,
    MatInputModule,
  ...
  providers: [AdditionalServiceRateService]
})
export class AdditionalServiceRateModule {}
