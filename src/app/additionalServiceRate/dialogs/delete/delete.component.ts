...
export class DeleteDialogComponent
{
  ...
  confirmDelete()
  {
    this.advanceTableService.delete(this.data.additionalServiceRateID)  
    .subscribe(
    data => 
    {
       this._generalService.sendUpdate('AdditionalServiceRateDelete:AdditionalServiceRateView:Success');//To Send Updates   
    },
    error =>
    {
