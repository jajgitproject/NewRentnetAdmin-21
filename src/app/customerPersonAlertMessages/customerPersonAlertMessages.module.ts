...
import { CustomerPersonAlertMessagesRoutingModule } from './customerPersonAlertMessages-routing.module';
...
@NgModule({
  declarations: [
    CustomerPersonAlertMessagesComponent,
    advanceTableForm,
  ...
  imports: [
    ...
    FormsModule,
    ReactiveFormsModule,
    CustomerPersonAlertMessagesRoutingModule,
    MatTableModule,
    MatPaginatorModule,
    MatFormFieldModule,
    MatInputModule,
  ...
  providers: [CustomerPersonAlertMessagesService]
})
export class CustomerPersonAlertMessagesModule {}
