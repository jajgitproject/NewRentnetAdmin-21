...
export class DeleteDialogComponent
{
  ...
  confirmDelete()
  {
    this.advanceTableService.delete(this.data.customerInvoiceTemplateID)  
    .subscribe(
    data => 
    {
       this._generalService.sendUpdate('InvoiceTemplateDelete:InvoiceTemplateView:Success');//To Send Updates   
    },
    error =>
    {
