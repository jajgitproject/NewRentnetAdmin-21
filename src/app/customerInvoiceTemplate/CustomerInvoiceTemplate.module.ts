...
import { CustomerInvoiceTemplateRoutingModule } from './CustomerInvoiceTemplate-routing.module';
...
@NgModule({
  declarations: [
    CustomerInvoiceTemplateComponent,
    advanceTableForm,
  ...
  imports: [
    ...
    FormsModule,
    ReactiveFormsModule,
    CustomerInvoiceTemplateRoutingModule,
    MatTableModule,
    MatPaginatorModule,
    MatFormFieldModule,
    MatInputModule,
  ...
  providers: [CustomerInvoiceTemplateService,CustomerService]
})
export class CustomerInvoiceTemplateModule {}
