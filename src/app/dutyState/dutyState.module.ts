...
import { DutyStateRoutingModule } from './dutyState-routing.module';
...
@NgModule({
  ...
  exports:[DutyStateComponent],
  providers: [ DutyStateService]
})
export class  DutyStateModule {}
