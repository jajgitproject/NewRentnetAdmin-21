...
import { BillingCycleNameRoutingModule } from './billingCycleName-routing.module';
...
@NgModule({
  ...
  providers: [BillingCycleNameService]
})
export class BillingCycleNameModule {}
