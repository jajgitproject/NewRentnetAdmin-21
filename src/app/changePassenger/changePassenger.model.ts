...
export class ChangePassengerModel {
  ...
  reason:string;
  userID: number;
  constructor(changePassengerModel) {
    {
      this.reservationChangeLogID = changePassengerModel.reservationChangeLogID || -1;
      this.reservationID = changePassengerModel.reservationID || '';
      this.changeEmployeeID = changePassengerModel.changeEmployeeID || '';
      this.changeType = changePassengerModel.changeType || '';      
      this.previousRecordID = changePassengerModel.previousRecordID || '';
      this.previousRecordName = changePassengerModel.previousRecordName || ''; 
      this.newRecordID = changePassengerModel.newRecordID || '';
      this.newRecordName = changePassengerModel.newRecordName || '';
      this.reason = changePassengerModel.reason || '';
    }
  }
}
