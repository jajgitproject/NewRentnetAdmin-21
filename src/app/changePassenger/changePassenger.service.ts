...
@Injectable()
export class ChangePassengerService {
  ...
  add(advanceTable:ChangePassengerModel):Observable<any> 
  {
    advanceTable.userID=this.generalService.getUserID();
    advanceTable.changeEmployeeID=this.generalService.getUserID();
    return this.httpClient.post<any>(this.API_URL + '/' + 'AddChangePassenger' , advanceTable);
  }

  getChangePassengerData(ReservationID:number):Observable<any[]> 
  {
