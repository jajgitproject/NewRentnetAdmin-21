...
import { AllotCarAndDriverRoutingModule } from './allotCarAndDriver-routing.module';
...
@NgModule({
  ...
  imports: [
    ...
    FormsModule,
    ReactiveFormsModule,
    AllotCarAndDriverRoutingModule,
    MatTableModule,
    MatPaginatorModule,
    MatFormFieldModule,
    MatInputModule,
  ...
  providers: [AllotCarAndDriverService,]
})
export class AllotCarAndDriverModule {}
