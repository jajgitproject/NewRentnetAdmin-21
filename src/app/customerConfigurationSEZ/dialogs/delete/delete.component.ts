...
export class DeleteDialogComponent
{
  ...
  confirmDelete()
  {
    this.advanceTableService.delete(this.data.customerConfigurationSEZID)  
    .subscribe(
    data => 
    {
       this._generalService.sendUpdate('CustomerConfigurationSEZDelete:CustomerConfigurationSEZView:Success');//To Send Updates   
    },
    error =>
    {
