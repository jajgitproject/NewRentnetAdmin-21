...
import { CustomerConfigurationSEZRoutingModule } from './customerConfigurationSEZ-routing.module';
...
@NgModule({
  declarations: [
    CustomerConfigurationSEZComponent,
    advanceTableForm,
  ...
  imports: [
    ...
    FormsModule,
    ReactiveFormsModule,
    CustomerConfigurationSEZRoutingModule,
    MatTableModule,
    MatPaginatorModule,
    MatFormFieldModule,
    MatInputModule,
  ...
  providers: [CustomerConfigurationSEZService]
})
export class CustomerConfigurationSEZModule {}
