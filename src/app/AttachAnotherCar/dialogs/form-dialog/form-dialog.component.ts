...
export class AttachAnotherCarFormDialogComponent 
{
  ...
  constructor(
  public dialogRef: MatDialogRef<AttachAnotherCarFormDialogComponent>, 
  ...
  public _generalService:GeneralService)
  {
        ...
        if (this.action === 'edit') 
        {
          this.dialogTitle ='Attach Another Car';       
          this.advanceTable = data.advanceTable;
        } 
        else 
        {
          this.dialogTitle = 'Attach Another Car';
          this.advanceTable = new AttachAnotherCar({});
  ...
  createContactForm(): FormGroup 
  {
    ...
    {
      AttachAnotherCarID: [this.advanceTable.AttachAnotherCarID],
      AttachAnotherCar: [this.advanceTable.AttachAnotherCar,[this.noWhitespaceValidator]],
