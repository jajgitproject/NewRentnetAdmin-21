...
@Component({
  standalone: false,
  selector: 'app-customerSalesManager',
  templateUrl: './customerSalesManager.component.html',
  styleUrls: ['./customerSalesManager.component.sass'],
...
export class CustomerSalesManagerComponent implements OnInit {
  displayedColumns = [
    ...
    'endDate',
    'attachmentStatus',
  'isDefaultSalesManager',
    'activationStatus',
    'actions'
  ];
  dataSource: CustomerSalesManager[] | null;
  customerSalesManagerID: number;
  advanceTable: CustomerSalesManager | null;
  ...
  constructor(
    ...
    public customerSalesManagerService: CustomerSalesManagerService,
...
@ViewChild(MatMenuTrigger)
  ...
  refresh() {
    this.SearchCustomerSalesManager = '';
  ...
  public loadData() 
   {
    ...
    switch (this.selectedFilter)
    {
      ...
      this.customerSalesManagerService.getTableData(this.customer_ID,this.SearchCustomerSalesManager,this.SearchEmployeeName,this.SearchStartDate,this.SearchEndDate,this.SearchActivationStatus, this.PageNumber).subscribe
    (
      data =>   
      {
  ...
  onContextMenu(event: MouseEvent, item: CustomerSalesManager) {
...
/////////////////for Image Upload ends////////////////////////////
  ...
  SubscribeUpdateService()
  {
    ...
    (
      ...
      { 
        ...
        {
          if(this.MessageArray[0]=="CustomerSalesManagerCreate")
          {
            if(this.MessageArray[1]=="CustomerSalesManagerView")
            {
              if(this.MessageArray[2]=="Success")
              {
                ...
                'snackbar-success',
                ' Customer Sales Manager Created ...!!!',
                'bottom',
                'center'
              );
              }
          ...
          else if(this.MessageArray[0]=="CustomerSalesManagerUpdate")
          {
            if(this.MessageArray[1]=="CustomerSalesManagerView")
            {
              if(this.MessageArray[2]=="Success")
              {
               ...
               this.showNotification(
                'snackbar-success',
                ' Customer Sales Manager Updated ...!!!',
                'bottom',
                'center'
              );
              }
          ...
          else if(this.MessageArray[0]=="CustomerSalesManagerDelete")
          {
            if(this.MessageArray[1]=="CustomerSalesManagerView")
            {
              if(this.MessageArray[2]=="Success")
              {
               ...
               this.showNotification(
                'snackbar-success',
                ' Customer Sales Manager Deleted ...!!!',
                'bottom',
                'center'
              );
              }
          ...
          else if(this.MessageArray[0]=="CustomerSalesManagerAll")
          {
            if(this.MessageArray[1]=="CustomerSalesManagerView")
            {
  ...
  SortingData(coloumName:any) {
    ...
    this.customerSalesManagerService.getTableDataSort(this.customer_ID,this.SearchCustomerSalesManager,this.SearchEmployeeName,this.SearchStartDate,this.SearchEndDate,this.SearchActivationStatus, this.PageNumber, coloumName.active,this.sortType).subscribe
    (
      data =>   
      {
        this.dataSource = data;
