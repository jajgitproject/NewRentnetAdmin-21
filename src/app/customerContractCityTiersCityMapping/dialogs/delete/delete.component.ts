...
export class DeleteDialogComponent
{
  ...
  confirmDelete()
  {
    this.advanceTableService.delete(this.data.customerContractCityTiersCityMappingID)  
    .subscribe(
    data => 
    {
       this._generalService.sendUpdate('CustomerContractCityTiersCityMappingDelete:CustomerContractCityTiersCityMappingView:Success');//To Send Updates   
    },
    error =>
    {
