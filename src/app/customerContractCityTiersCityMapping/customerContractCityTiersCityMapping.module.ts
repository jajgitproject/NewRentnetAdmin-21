...
import { CustomerContractCityTiersCityMappingRoutingModule } from './customerContractCityTiersCityMapping-routing.module';
...
@NgModule({
  declarations: [
    CustomerContractCityTiersCityMappingComponent,
    advanceTableForm,
  ...
  imports: [
    ...
    FormsModule,
    ReactiveFormsModule,
    CustomerContractCityTiersCityMappingRoutingModule,
    MatTableModule,
    MatPaginatorModule,
    MatFormFieldModule,
    MatInputModule,
  ...
  providers: [CustomerContractCityTiersCityMappingService]
})
export class CustomerContractCityTiersCityMappingModule {}
