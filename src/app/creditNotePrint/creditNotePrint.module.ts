...
import { CreditNotePrintRoutingModule } from './creditNotePrint-routing.module';
...
@NgModule({
  ...
  providers: [CreditNotePrintService]
})
export class CreditNotePrintModule {}
