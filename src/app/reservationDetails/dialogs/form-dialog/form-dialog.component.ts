...
export class FormDialogRDComponent 
{
  action: string;
  dialogTitle: string;
  advanceTableForm: FormGroup;
  advanceTable: ReservationDetails;
  ...
  fromForm: any;
  constructor(
  public dialogRef: MatDialogRef<FormDialogRDComponent>, 
  ...
  public _generalService:GeneralService)
  {
        ...
        // else 
        // {
        //   this.dialogTitle = 'ReservationDetails';
...
// }
  ...
  //   {
  //       this.dialogRef.close();
  //      this._generalService.sendUpdate('ReservationDetailsUpdate:ReservationDetailsView:Success');//To Send Updates  
...
//   if (/[a-zA-Z]/.reservationDetails(inp)) {
//     return true;
//   } else {
//     event.preventDefault();
//     return false;
