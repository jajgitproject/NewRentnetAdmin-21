...
import { ReservationDetailsRoutingModule } from './reservationDetails-routing.module';
...
@NgModule({
  ...
  exports: [ReservationDetailsComponent, advanceTableForm],
  providers: [ReservationDetailsService,AdvanceService,CustomerShortService,CustomerPersonService,ViewKAMService]
})
