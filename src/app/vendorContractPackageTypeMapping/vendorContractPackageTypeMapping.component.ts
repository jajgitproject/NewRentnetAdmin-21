...
@Component({
  standalone: false,
  selector: 'app-vendorContractPackageTypeMapping',
  templateUrl: './vendorContractPackageTypeMapping.component.html',
  styleUrls: ['./vendorContractPackageTypeMapping.component.sass'],
  providers: [{ provide: MAT_DATE_LOCALE, useValue: 'en-GB' }]
})
export class VendorContractPackageTypeMappingComponent implements OnInit {
  displayedColumns = [
    'PackageType',
    'activationStatus',
    'actions'
  ];
  dataSource: VendorContractPackageTypeMapping[] | null;
  vendorContractPackageTypeMappingID: number;
  advanceTable: VendorContractPackageTypeMapping | null;
  ...
  constructor(
    ...
    public contractPackagetypeMappingService: VendorContractPackageTypeMappingService,
...
//   {
//    this._generalService.getPackageTypeByVendorID(this.vendorContract_ID).subscribe
//    (
//      data =>   
//      {
...
//  }
  ...
  editCall(row) {
    //  alert(row.id);
  this.vendorContractPackageTypeMappingID = row.id;
  const dialogRef = this.dialog.open(FormDialogComponent, {
    data: {
      advanceTable: row,
      action: 'edit',
...
shouldShowDeleteButton(item: any): boolean {
  ...
  onBackPress(event) 
  {
   ...
   public loadData() 
   {
    switch (this.selectedFilter)
    {
      ...
      this.contractPackagetypeMappingService.getTableData(this.vendorContract_ID,this.package.value,this.SearchActivationStatus, this.PageNumber).subscribe
      (
        data =>   
        {
  ...
  onContextMenu(event: MouseEvent, item: VendorContractPackageTypeMapping) {
  ...
  {
    this.loadData();
    //this.SearchVendorContractPackageTypeMapping='';
...
/////////////////for Image Upload ends////////////////////////////
  ...
  SubscribeUpdateService()
  {
    ...
    (
      ...
      { 
        ...
        {
          if(this.MessageArray[0]=="VendorContractPackageTypeMappingCreate")
          {
            if(this.MessageArray[1]=="VendorContractPackageTypeMappingView")
            {
              if(this.MessageArray[2]=="Success")
              {
                ...
                'snackbar-success',
                'Vendor Contract Package Type Mapping Created...!!!',
                'bottom',
                'center'
              );
              }
          ...
          else if(this.MessageArray[0]=="VendorContractPackageTypeMappingUpdate")
          {
            if(this.MessageArray[1]=="VendorContractPackageTypeMappingView")
            {
              if(this.MessageArray[2]=="Success")
              {
               ...
               this.showNotification(
                'snackbar-success',
                'Vendor Contract Package Type Mapping Updated...!!!',
                'bottom',
                'center'
              );
              }
          ...
          else if(this.MessageArray[0]=="VendorContractPackageTypeMappingDelete")
          {
            if(this.MessageArray[1]=="VendorContractPackageTypeMappingView")
            {
              if(this.MessageArray[2]=="Success")
              {
               ...
               this.showNotification(
                'snackbar-success',
                'Vendor Contract Package Type Mapping Deleted...!!!',
                'bottom',
                'center'
              );
              }
          ...
          else if(this.MessageArray[0]=="VendorContractPackageTypeMappingAll")
          {
            if(this.MessageArray[1]=="VendorContractPackageTypeMappingView")
            {
  ...
  SortingData(coloumName:any) {
    ...
    this.contractPackagetypeMappingService.getTableDataSort(this.vendorContract_ID,this.searchPackageType,this.SearchActivationStatus, this.PageNumber,coloumName.active,this.sortType).subscribe
    (
      data =>   
      {
        this.dataSource = data;
