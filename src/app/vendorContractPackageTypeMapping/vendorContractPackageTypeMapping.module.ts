...
import { VendorContractPackageTypeMappingRoutingModule } from './vendorContractPackageTypeMapping-routing.module';
...
@NgModule({
  declarations: [
    VendorContractPackageTypeMappingComponent,
    advanceTableForm,
  ...
  imports: [
    ...
    FormsModule,
    ReactiveFormsModule,
    VendorContractPackageTypeMappingRoutingModule,
    MatTableModule,
    MatPaginatorModule,
    MatFormFieldModule,
    MatInputModule,
  ...
  providers: [VendorContractPackageTypeMappingService]
})
export class VendorContractPackageTypeMappingModule {}
