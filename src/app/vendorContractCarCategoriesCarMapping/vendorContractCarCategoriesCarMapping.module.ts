...
import { VendorContractCarCategoriesCarMappingRoutingModule } from './vendorContractCarCategoriesCarMapping-routing.module';
...
@NgModule({
  declarations: [
    VendorContractCarCategoriesCarMappingComponent,
    advanceTableForm,
  ...
  imports: [
    ...
    FormsModule,
    ReactiveFormsModule,
    VendorContractCarCategoriesCarMappingRoutingModule,
    MatTableModule,
    MatPaginatorModule,
    MatFormFieldModule,
    MatInputModule,
  ...
  providers: [VendorContractCarCategoriesCarMappingService]
})
export class VendorContractCarCategoriesCarMappingModule {}
