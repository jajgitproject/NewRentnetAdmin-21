...
import { CustomerContractCarCategoryRoutingModule } from './customerContractCarCategory-routing.module';
import { MyUploadComponent } from '../myupload/myupload.component';
import { MyUploadModule } from '../myupload/myupload.module';
import { ConfirmationDialogComponent } from './dialogs/confirmation-dialog/confirmation-dialog.component';
import { CustomerContractCityTiersModule } from '../customerContractCityTiers/customerContractCityTiers.module';
...
@NgModule({
  declarations: [
    CustomerContractCarCategoryComponent,
    advanceTableForm,
  ...
  imports: [
    ...
    FormsModule,
    ReactiveFormsModule,
    CustomerContractCarCategoryRoutingModule,
    MatTableModule,
    MatPaginatorModule,
    MatFormFieldModule,
    MatInputModule,
  ...
  providers: [CustomerContractCarCategoryService]
})
export class CustomerContractCarCategoryModule {}
