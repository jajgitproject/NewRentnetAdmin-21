...
export class FormDialogComponent 
{
  ...
  public _generalService:GeneralService)
  {
    ...
    if (this.action === 'edit') 
    {
      this.dialogTitle ='Car Catagories for Customer Contract';       
  ...
  public Post(): void
  {
    ...
    {
        this.dialogRef.close();
       this._generalService.sendUpdate('CustomerContractCarCategoryCreate:CustomerContractCarCategoryView:Success');//To Send Updates 
  ...
  public Put(): void
  {
    ...
    {
        this.dialogRef.close();
       this._generalService.sendUpdate('CustomerContractCarCategoryUpdate:CustomerContractCarCategoryView:Success');//To Send Updates  
       this.saveDisabled = true;       
    },
    error =>
    {
...
//   if (/[a-zA-Z]/.customerContractCarCategory(inp)) {
//     return true;
//   } else {
//     event.preventDefault();
//     return false;
