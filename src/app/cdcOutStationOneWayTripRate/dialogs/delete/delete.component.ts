...
export class DeleteDialogComponent
{
  ...
  confirmDelete()
  {
    this.advanceTableService.delete(this.data.cdcOutStationOneWayTripRateID)  
    .subscribe(
    data => 
    {
       this._generalService.sendUpdate('CDCOutStationOneWayTripRateDelete:CDCOutStationOneWayTripRateView:Success');//To Send Updates   
    },
    error =>
    {
