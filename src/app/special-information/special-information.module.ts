...
import { SpecialinformationRoutingModule } from './special-information-routing.module';
...
@NgModule({
  ...
  imports: [
    ...
    MatExpansionModule,
    SpecialinformationRoutingModule
  ],
    exports:[SpecialinformationComponent],
    providers: [SpecialinformationService]
})
