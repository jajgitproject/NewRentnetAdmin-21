...
export class FormDialogComponent 
{
  ...
  public _generalService:GeneralService)
  {
    ...
    if (this.action === 'edit') 
    {
      this.dialogTitle ='Package Types for Customer Contract';       
  ...
  createContactForm(): FormGroup 
  {
    return this.fb.group(
    {
      ...
      customerContractPackageType: [this.advanceTable.customerContractPackageType],
  ...
  public Post(): void
  {
    ...
    {
        this.dialogRef.close();
       this._generalService.sendUpdate('CustomerContractPackageTypeCreate:CustomerContractPackageTypeView:Success');//To Send Updates 
  ...
  public Put(): void
  {
    ...
    {
        this.dialogRef.close();
       this._generalService.sendUpdate('CustomerContractPackageTypeUpdate:CustomerContractPackageTypeView:Success');//To Send Updates  
       this.saveDisabled = true;       
    },
    error =>
    {
...
//   if (/[a-zA-Z]/.CustomerContractPackageType(inp)) {
//     return true;
//   } else {
//     event.preventDefault();
//     return false;
