...
import { CustomerContractPackageTypeRoutingModule } from './customerContractPackageType-routing.module';
...
@NgModule({
  declarations: [
    CustomerContractPackageTypeComponent,
    advanceTableForm,
  ...
  imports: [
    ...
    FormsModule,
    ReactiveFormsModule,
    CustomerContractPackageTypeRoutingModule,
    MatTableModule,
    MatPaginatorModule,
    MatFormFieldModule,
    MatInputModule,
  ...
  providers: [CustomerContractPackageTypeService]
})
export class CustomerContractPackageTypeModule {}
