...
import { ReservationAlertRoutingModule } from './reservationAlert-routing.module';
...
@NgModule({
  ...
  providers: [ReservationAlertService]
})
export class ReservationAlertModule {}
