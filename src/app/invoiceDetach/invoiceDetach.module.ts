...
import { InvoiceDetachRoutingModule } from './invoiceDetach-routing.module';
...
@NgModule({
  ...
  exports:[InvoiceDetachComponent],
  providers: [InvoiceDetachService]
})
export class InvoiceDetachModule {}
