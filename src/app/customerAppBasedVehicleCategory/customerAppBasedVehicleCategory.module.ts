...
import { CustomerAppBasedVehicleCategoryRoutingModule } from './customerAppBasedVehicleCategory-routing.module';
...
@NgModule({
  declarations: [
    CustomerAppBasedVehicleCategoryComponent,
    advanceTableForm,
  ...
  imports: [
    ...
    FormsModule,
    ReactiveFormsModule,
    CustomerAppBasedVehicleCategoryRoutingModule,
    MatTableModule,
    MatPaginatorModule,
    MatFormFieldModule,
    MatInputModule,
  ...
  providers: [CustomerAppBasedVehicleCategoryService]
})
export class CustomerAppBasedVehicleCategoryModule {}
