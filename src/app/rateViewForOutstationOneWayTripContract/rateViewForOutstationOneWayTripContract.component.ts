...
import { RateViewForOutstationOneWayTripContractModel } from './rateViewForOutstationOneWayTripContract.model';
...
@Component({
  ...
  templateUrl: './rateViewForOutstationOneWayTripContract.component.html',
  styleUrls: ['./rateViewForOutstationOneWayTripContract.component.sass'],
  providers: [{ provide: MAT_DATE_LOCALE, useValue: 'en-GB' }]
})

export class RateViewForOutstationOneWayTripContractComponent implements OnInit {
  displayedColumns = [
    'Package',
  ...
  dataSource: RateViewForOutstationOneWayTripContractModel[] | null;
  CustomerContract_ID: any;
  PackageName: string;
  advanceTable: RateViewForOutstationOneWayTripContractModel | null;
  ...
  constructor(
    ...
    public rateViewForOutstationOneWayTripContractService: RateViewForOutstationOneWayTripContractService,
  ...
  public Filter()
  {
   ...
   public loadData() 
   {
      this.rateViewForOutstationOneWayTripContractService.getTableData(this.CustomerContract_ID).subscribe
      (
        data =>   
        {
  ...
  onContextMenu(event: MouseEvent, item: RateViewForOutstationOneWayTripContractModel) {
