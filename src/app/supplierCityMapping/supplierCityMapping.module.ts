...
import { SupplierCityMappingRoutingModule } from './supplierCityMapping-routing.module';
...
@NgModule({
  ...
  imports: [
    ...
    SupplierCityMappingRoutingModule,
    MatTableModule,
    MatPaginatorModule,
    MatFormFieldModule,
    MatInputModule,
  ...
  providers: [SupplierCityMappingService]
})
export class SupplierCityMappingModule {}
