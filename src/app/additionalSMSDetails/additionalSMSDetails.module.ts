...
import { AdditionalSMSDetailsRoutingModule } from './additionalSMSDetails-routing.module';
...
@NgModule({
  ...
  imports: [
    ...
    FormsModule,
    ReactiveFormsModule,
    AdditionalSMSDetailsRoutingModule,
    MatTableModule,
    MatPaginatorModule,
    MatFormFieldModule,
    MatInputModule,
  ...
  exports:[AdditionalSMSDetailsComponent],
  providers: [AdditionalSMSDetailsService,AdditionalSMSEmailWhatsappService]
})
export class AdditionalSMSDetailsModule {}
