...
import { GeoPointTypeRoutingModule } from './geoPointType-routing.module';
...
@NgModule({
  ...
  providers: [GeoPointTypeService]
})
export class GeoPointTypeModule {}
