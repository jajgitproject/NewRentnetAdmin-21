...
import { CancelAttotmentRoutingModule } from './cancelAttotment-routing.module';
import { MyUploadComponent } from '../myupload/myupload.component';
import { MyUploadModule } from '../myupload/myupload.module';

@NgModule({
  declarations: [
    CancelAttotmentComponent,
    advanceTableForm,
  ...
  providers: [CancelAttotmentService]
})
export class CancelAttotmentModule {}
