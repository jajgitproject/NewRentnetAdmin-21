...
import { DutyGSTPercentageRoutingModule } from './dutyGSTPercentage-routing.module';
...
@NgModule({
  ...
  imports: [
    ...
    FormsModule,
    ReactiveFormsModule,
    DutyGSTPercentageRoutingModule,
    MatTableModule,
    MatPaginatorModule,
    MatFormFieldModule,
    MatInputModule,
  ...
  exports:[DutyGSTPercentageComponent],
  providers: [DutyGSTPercentageService]
})
export class DutyGSTPercentageModule {}
