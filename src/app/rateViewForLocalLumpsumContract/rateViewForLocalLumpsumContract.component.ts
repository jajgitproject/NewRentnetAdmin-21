...
import { RateViewForLocalLumpsumContractModel } from './rateViewForLocalLumpsumContract.model';
...
import { RateViewForLocalLumpsumContractService } from './rateViewForLocalLumpsumContract.service';
import { DatePipe } from '@angular/common';

@Component({
  standalone: false,
  selector: 'app-rateViewForLumpsumContract',
  templateUrl: './rateViewForLocalLumpsumContract.component.html',
  styleUrls: ['./rateViewForLocalLumpsumContract.component.sass'],
  providers: [{ provide: MAT_DATE_LOCALE, useValue: 'en-GB' }]
})

export class RateViewForLocalLumpsumContractComponent implements OnInit {
  displayedColumns = [
    'Package',
  ...
  dataSource: RateViewForLocalLumpsumContractModel[] | null;
  CustomerContract_ID: any;
  PackageName: string;
  advanceTable: RateViewForLocalLumpsumContractModel | null;
  ...
  constructor(
    ...
    public rateViewForLocalLumpsumContractService: RateViewForLocalLumpsumContractService,
  ...
  public Filter()
  {
   ...
   public loadData() 
   {
      this.rateViewForLocalLumpsumContractService.getTableData(this.CustomerContract_ID).subscribe
      (
        data =>   
        {
  ...
  onContextMenu(event: MouseEvent, item: RateViewForLocalLumpsumContractModel) {
