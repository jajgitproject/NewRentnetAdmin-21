...
import { CustomerFuelSurchargeComponent } from './customerFuelSurcharge.component';
...
import { CustomerFuelSurchargeRoutingModule } from './customerFuelSurcharge-routing.module';
...
@NgModule({
  declarations: [
    CustomerFuelSurchargeComponent,
    advanceTableForm,
  ...
  imports: [
    ...
    FormsModule,
    ReactiveFormsModule,
    CustomerFuelSurchargeRoutingModule,
    MatTableModule,
    MatPaginatorModule,
    MatFormFieldModule,
    MatInputModule,
  ...
  providers: [CustomerFuelSurchargeService]
})
export class CustomerFuelSurchargeModule {}
