...
export class DeleteDialogComponent
{
  ...
  confirmDelete()
  {
    ...
    this.advanceTableService.delete(this.data.customerServiceExecutiveID)  
    .subscribe(
    data => 
    {
       this._generalService.sendUpdate('CustomerServiceExecutiveDelete:CustomerServiceExecutiveView:Success');//To Send Updates   
    },
    error =>
    {
