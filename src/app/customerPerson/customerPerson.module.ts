...
import { CustomerPersonComponent } from './customerPerson.component';
import { FormDialogComponentCustomerPerson as advanceTableForm } from './dialogs/form-dialog/form-dialog.component';
...
@NgModule({
  ...
  providers: [CustomerPersonService,CustomerDepartmentService,CustomerDesignationService]
})
export class CustomerPersonModule {}
