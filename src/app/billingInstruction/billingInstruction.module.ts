...
import { BillingInstructionRoutingModule } from './billingInstruction-routing.module';
...
@NgModule({
  ...
  imports: [
    ...
    FormsModule,
    ReactiveFormsModule,
    BillingInstructionRoutingModule,
    MatTableModule,
    MatPaginatorModule,
    MatFormFieldModule,
    MatInputModule,
  ...
  providers: [BillingInstructionService]
})
export class BillingInstructionModule {}
