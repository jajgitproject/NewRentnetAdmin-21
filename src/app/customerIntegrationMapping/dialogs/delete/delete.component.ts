...
export class DeleteDialogComponent
{
  ...
  confirmDelete()
  {
    this.advanceTableService.delete(this.data.customerIntegrationMappingID)  
    .subscribe(
    data => 
    {
       this._generalService.sendUpdate('CustomerIntegrationMappingDelete:CustomerIntegrationMappingView:Success');//To Send Updates   
    },
    error =>
    {
