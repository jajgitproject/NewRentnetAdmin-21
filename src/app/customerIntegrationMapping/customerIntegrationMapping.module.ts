...
import { CustomerIntegrationMappingRoutingModule } from './customerIntegrationMapping-routing.module';
...
@NgModule({
  declarations: [
    CustomerIntegrationMappingComponent,
    advanceTableForm,
  ...
  imports: [
    ...
    FormsModule,
    ReactiveFormsModule,
    CustomerIntegrationMappingRoutingModule,
    MatTableModule,
    MatPaginatorModule,
    MatFormFieldModule,
    MatInputModule,
  ...
  providers: [CustomerIntegrationMappingService]
})
export class CustomerIntegrationMappingModule {}
