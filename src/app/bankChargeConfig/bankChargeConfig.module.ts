...
import { BankChargeConfigRoutingModule } from './bankChargeConfig-routing.module';
...
@NgModule({
  ...
  providers: [BankChargeConfigService]
})
export class BankChargeConfigModule {}
