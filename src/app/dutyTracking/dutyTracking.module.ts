...
import { DutyTrackingRoutingModule } from './dutyTracking-routing.module';
import { MyUploadComponent } from '../myupload/myupload.component';
import { MyUploadModule } from '../myupload/myupload.module';
import { MatAutocompleteModule } from '@angular/material/autocomplete';
@NgModule({
  declarations: [
    DutyTrackingComponent,
    advanceTableForm,
  ...
  exports: [DutyTrackingComponent, advanceTableForm],
  providers: [DutyTrackingService]
})
export class DutyTrackingModule {}
