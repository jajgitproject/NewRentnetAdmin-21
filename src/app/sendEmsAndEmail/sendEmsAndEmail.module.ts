...
import { FormDialogSendEmsComponent as advanceTableForm}  from './dialogs/form-dialog/form-dialog.component';
...
import { SendEmsAndEmailRoutingModule } from './sendEmsAndEmail-routing.module';
...
@NgModule({
  ...
  providers: [SendEmsAndEmailService]
})
export class SendEmsAndEmailModule {}
