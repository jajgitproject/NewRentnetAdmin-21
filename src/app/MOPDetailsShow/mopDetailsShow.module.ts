...
import { MOPDetailsRoutingModule } from './mopDetailsShow-routing.module';
...
@NgModule({
  ...
  exports: [MOPDetailsComponent, FormDialogComponent],
  providers: [MOPDetailsService]
})
export class MOPDetailsModule {}
