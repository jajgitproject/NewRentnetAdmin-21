...
import { CustomerPaymentTermsCodeRoutingModule } from './customerPaymentTermsCode-routing.module';
...
@NgModule({
  declarations: [
    CustomerPaymentTermsCodeComponent,
    advanceTableForm,
  ...
  imports: [
    ...
    FormsModule,
    ReactiveFormsModule,
    CustomerPaymentTermsCodeRoutingModule,
    MatTableModule,
    MatPaginatorModule,
    MatFormFieldModule,
    MatInputModule,
  ...
  providers: [CustomerPaymentTermsCodeService]
})
export class CustomerPaymentTermsCodeModule {}
