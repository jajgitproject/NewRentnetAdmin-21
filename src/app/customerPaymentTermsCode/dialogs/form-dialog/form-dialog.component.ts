...
export class FormDialogComponent 
{
  ...
  advanceTable: CustomerPaymentTermsCode;
  fName = '';
  contents: any[];
  mydata = [];
  name = '';
  ...
  public _generalService:GeneralService)
  {
    this.CustomerID= data.customerID,
        ...
        if (this.action === 'edit') 
        {
          this.dialogTitle ='Customer Payment Terms Code';       
          this.advanceTable = data.advanceTable;
          //this.searchCategoryBy.setValue(this.advanceTable.customerCategory)
        } else 
        {
          this.dialogTitle = 'Customer Payment Terms Code';
          this.advanceTable = new CustomerPaymentTermsCode({});
  ...
  createContactForm(): FormGroup 
  {
    ...
    {
      customerPaymentTermsCodeID: [this.advanceTable.customerPaymentTermsCodeID],
      customerID: [this.advanceTable.customerID],
      paymentTermCode: [this.advanceTable.paymentTermCode],
  ...
  public Post(): void
  {
    ...
    {
        this.dialogRef.close();
       this._generalService.sendUpdate('CustomerPaymentTermsCodeCreate:CustomerPaymentTermsCodeView:Success');//To Send Updates 
  ...
  public Put(): void
  {
    ...
    {
        this.dialogRef.close();
       this._generalService.sendUpdate('CustomerPaymentTermsCodeUpdate:CustomerPaymentTermsCodeView:Success');//To Send Updates 
       this.saveDisabled = true; 
...
//   if (/[a-zA-Z]/.customerPaymentTermsCode(inp)) {
//     return true;
//   } else {
//     event.preventDefault();
//     return false;
