...
@Component({
  standalone: false,
  selector: 'app-changeSaleForCustomers',
  templateUrl: './changeSaleForCustomers.component.html',
  styleUrls: ['./changeSaleForCustomers.component.sass'],
  providers: [{ provide: MAT_DATE_LOCALE, useValue: 'en-GB' }]
})
export class ChangeSaleForCustomersComponent implements OnInit {
  displayedColumns = [
    'oldSalesManagerName',
    'newSalesManagerName',
    'startDate',
  ...
  //   'newKAMActivationStatus',
    'actions'
  ];
  dataSource: ChangeSaleForCustomers[] | null;
  changeSaleForCustomersID: number;
  advanceTable: ChangeSaleForCustomers | null;
  SearchChangeSaleForCustomers: string = ''; 
  ...
  SearchEntityType:string='';
   SearchnewSalesManagerActivationStatus : boolean=true;
    SearchnewSalesManagerActivationFromDate:  string = ''; 
  SearchnewSalesManagerActivationToDate: string = ''; 
  PageNumber: number = 0;
  sortType: string;
  sortingData: number;
  ActiveStatus: any;
  ...
  SearchCustomerSalesManager: string;
  ...
  constructor(
    ...
    public changeSaleForCustomersService: ChangeSaleForCustomersService,
  ...
  refresh() {
    ...
    this.SearchChangeSaleForCustomers = '';
    this.SearchEmployeeName='';
    this.SearchStartDate='';
    this.SearchnewSalesManagerActivationStatus = true;
    this.searchTerm = '';
  ...
  editCall(row) {
      //  alert(row.id);
    this.changeSaleForCustomersID = row.id;
    const dialogRef = this.dialog.open(FormDialogComponentHolder, {
      data: {
        advanceTable: row,
        action: 'edit',
  ...
  openInNewTab(menuItem: any, rowItem: any) {
    ...
    if(menuItem.label.toLowerCase() === 'customer kam city') {
      const url = this.router.serializeUrl(this.router.createUrlTree(['/customerKAMCity'], { queryParams: {
        changeSaleForCustomersID: rowItem.changeSaleForCustomersID,
  ...
  shouldShowDeleteButton(item: any): boolean {
    return item.newKAMActivationStatus !== false; // Only show delete button if newKAMActivationStatus is not false (not deleted)
  }
  public Filter()
  {
    this.PageNumber = 0;
  ...
  public loadData() 
   {
    ...
    switch (this.selectedFilter)
    {
      ...
      this.changeSaleForCustomersService.getTableData(this.SearchCustomerSalesManager,this.SearchEmployeeName,this.SearchFromDate,this.SearchActivationStatus, this.PageNumber).subscribe
    (
      data =>   
      {
  ...
  onContextMenu(event: MouseEvent, item: ChangeSaleForCustomers) {
...
/////////////////for Image Upload ends////////////////////////////
    ...
    (
      ...
      { 
        ...
        if(this.MessageArray.length==3)
        {
          ...
          else if(this.MessageArray[0]=="ChangeSaleForCustomersUpdate")
          {
            if(this.MessageArray[1]=="ChangeSaleForCustomersView")
            {
              if(this.MessageArray[2]=="Success")
          ...
          else if(this.MessageArray[0]=="ChangeSaleForCustomersDelete")
          {
            if(this.MessageArray[1]=="ChangeSaleForCustomersView")
            {
              if(this.MessageArray[2]=="Success")
          ...
          else if(this.MessageArray[0]=="ChangeSaleForCustomersAll")
          {
            if(this.MessageArray[1]=="ChangeSaleForCustomersView")
            {
  ...
  SortingData(coloumName:any) {
    ...
    this.changeSaleForCustomersService.getTableDataSort(this.SearchCustomerSalesManager,this.SearchEmployeeName,this.SearchFromDate,this.SearchActivationStatus,this.PageNumber, coloumName.active,this.sortType).subscribe
    (
      data =>   
      {
        this.dataSource = data;
