...
import { CustomerCorporateIndividualComponent } from './customerCorporateIndividual.component';
...
import { CustomerCorporateIndividualRoutingModule } from './customer-routing.module';


@NgModule({
  declarations: [
    CustomerCorporateIndividualComponent,
    advanceTableForm,
  ...
  imports: [
    ...
    FormsModule,
    ReactiveFormsModule,
    CustomerCorporateIndividualRoutingModule,
    MatTableModule,
    MatPaginatorModule,
    MatFormFieldModule,
    MatInputModule,
