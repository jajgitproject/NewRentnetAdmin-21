...
import { CustomerDecimalValuesOnInvoiceRoutingModule } from './customerDecimalValuesOnInvoice-routing.module';
import { MatNativeDateModule } from '@angular/material/core';
// import { TwoDigitDecimaNumberDirective } from './twodigitdecimalnumber.directive';

@NgModule({
  declarations: [
    CustomerDecimalValuesOnInvoiceComponent,
    advanceTableForm,
  ...
  imports: [
    ...
    FormsModule,
    ReactiveFormsModule,
    CustomerDecimalValuesOnInvoiceRoutingModule,
    MatTableModule,
    MatPaginatorModule,
    MatFormFieldModule,
    MatInputModule,
  ...
  providers: [CustomerDecimalValuesOnInvoiceService]
})
export class CustomerDecimalValuesOnInvoiceModule {}
