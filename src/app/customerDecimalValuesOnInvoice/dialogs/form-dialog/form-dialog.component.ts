...
export class FormDialogComponent 
{
  ...
  advanceTable: CustomerDecimalValuesOnInvoice;
  fName = '';
  contents: any[];
  mydata = [];
  name = '';
  ...
  public _generalService:GeneralService)
  {
        ...
        {
          this.dialogTitle = 'Round UP ';
          this.advanceTable = new CustomerDecimalValuesOnInvoice({});
  ...
  createContactForm(): FormGroup 
  {
    ...
    {
      customerDecimalValuesOnInvoiceID: [this.advanceTable.customerDecimalValuesOnInvoiceID],
  ...
  public Post(): void
  {
    ...
    {
        this.dialogRef.close();
       this._generalService.sendUpdate('CustomerDecimalValuesOnInvoiceCreate:CustomerDecimalValuesOnInvoiceView:Success');//To Send Updates 
  ...
  public Put(): void
  {
    ...
    {
        this.dialogRef.close();
       this._generalService.sendUpdate('CustomerDecimalValuesOnInvoiceUpdate:CustomerDecimalValuesOnInvoiceView:Success');//To Send Updates 
       this.saveDisabled = true; 
...
//   if (/[a-zA-Z]/.customerDecimalValuesOnInvoice(inp)) {
//     return true;
//   } else {
//     event.preventDefault();
//     return false;
