...
@Component({
  standalone: false,
  selector: 'app-customerCollectionExecutive',
  templateUrl: './customerCollectionExecutive.component.html',
  styleUrls: ['./customerCollectionExecutive.component.sass'],
  providers: [{ provide: MAT_DATE_LOCALE, useValue: 'en-GB' }]
})
export class CustomerCollectionExecutiveComponent implements OnInit {
  displayedColumns = [
    'employeeName',
    'fromDate',
    'toDate',
  ...
  dataSource: CustomerCollectionExecutive[] | null;
  customerCollectionExecutiveID: number;
  advanceTable: CustomerCollectionExecutive | null;
  SearchCustomerCollectionExecutive: string = ''; 
  ...
  constructor(
    ...
    public customerCollectionExecutiveService: CustomerCollectionExecutiveService,
  ...
  refresh() 
  {  
    this.SearchCustomerCollectionExecutive = '';
  ...
  editCall(row) {
      //  alert(row.id);
    this.customerCollectionExecutiveID = row.id;
    const dialogRef = this.dialog.open(FormDialogComponentHolder, {
      data: {
        advanceTable: row,
        action: 'edit',
  ...
  public loadData() 
   {
    ...
    switch (this.selectedFilter)
    {
      ...
      this.customerCollectionExecutiveService.getTableData(this.customer_ID,this.SearchCustomerCollectionExecutive,this.EmployeeName.value,this.SearchStartDate,this.SearchEndDate,this.SearchActivationStatus, this.PageNumber).subscribe
    (
      data =>   
      {
  ...
  onContextMenu(event: MouseEvent, item: CustomerCollectionExecutive) {
...
/////////////////for Image Upload ends////////////////////////////
  ...
  SubscribeUpdateService()
  {
    ...
    (
      ...
      { 
        ...
        {
          if(this.MessageArray[0]=="CustomerCollectionExecutiveCreate")
          {
            if(this.MessageArray[1]=="CustomerCollectionExecutiveView")
            {
              if(this.MessageArray[2]=="Success")
              {
                ...
                'snackbar-success',
                'Customer Collection Executive Created...!!!',
                'bottom',
                'center'
              );
              }
          ...
          else if(this.MessageArray[0]=="CustomerCollectionExecutiveUpdate")
          {
            if(this.MessageArray[1]=="CustomerCollectionExecutiveView")
            {
              if(this.MessageArray[2]=="Success")
              {
               ...
               this.showNotification(
                'snackbar-success',
                'Customer Collection Executive Updated...!!!',
                'bottom',
                'center'
              );
              }
          ...
          else if(this.MessageArray[0]=="CustomerCollectionExecutiveDelete")
          {
            if(this.MessageArray[1]=="CustomerCollectionExecutiveView")
            {
              if(this.MessageArray[2]=="Success")
              {
               ...
               this.showNotification(
                'snackbar-success',
                'Customer Collection Executive Deleted ...!!!',
                'bottom',
                'center'
              );
              }
          ...
          else if(this.MessageArray[0]=="CustomerCollectionExecutiveAll")
          {
            if(this.MessageArray[1]=="CustomerCollectionExecutiveView")
            {
  ...
  SortingData(coloumName:any) {
    ...
    this.customerCollectionExecutiveService.getTableDataSort(this.customer_ID,this.SearchCustomerCollectionExecutive,this.EmployeeName.value,this.SearchStartDate,this.SearchEndDate,this.SearchActivationStatus, this.PageNumber, coloumName.active,this.sortType).subscribe
    (
      data =>   
      {
        this.dataSource = data;
