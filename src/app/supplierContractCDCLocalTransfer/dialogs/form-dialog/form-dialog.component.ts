...
export class FormDialogComponent 
{
  ...
  advanceTable: SupplierContractCDCLocalTransfer;
  fName = '';
  contents: any[];
  mydata = [];
  name = '';
  ...
  public _generalService:GeneralService)
  {
        ...
        {
          this.dialogTitle = 'Chauffeur Driven Car Local Transfer Package';
          this.advanceTable = new SupplierContractCDCLocalTransfer({});
...
numberOnly(event): boolean {
  ...
  public Post(): void
  {
    ...
    response => 
    {
      this.isLoading = false;
        this.dialogRef.close();
       this._generalService.sendUpdate('SupplierContractCDCLocalTransferCreate:SupplierContractCDCLocalTransferView:Success');//To Send Updates  
  ...
  public Put(): void
  {
    ...
    response => 
    {
      this.isLoading = false;
        this.dialogRef.close();
       this._generalService.sendUpdate('SupplierContractCDCLocalTransferUpdate:SupplierContractCDCLocalTransferView:Success');//To Send Updates  
