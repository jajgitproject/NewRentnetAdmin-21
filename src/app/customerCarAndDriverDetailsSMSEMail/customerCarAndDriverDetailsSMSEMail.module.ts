...
import { CustomerCarAndDriverDetailsSMSEMailRoutingModule } from './customerCarAndDriverDetailsSMSEMail-routing.module';
...
@NgModule({
  declarations: [
    CustomerCarAndDriverDetailsSMSEMailComponent,
    advanceTableForm,
  ...
  imports: [
    ...
    FormsModule,
    ReactiveFormsModule,
    CustomerCarAndDriverDetailsSMSEMailRoutingModule,
    MatTableModule,
    MatPaginatorModule,
    MatFormFieldModule,
    MatInputModule,
  ...
  providers: [CustomerCarAndDriverDetailsSMSEMailService]
})
export class CustomerCarAndDriverDetailsSMSEMailModule {}
