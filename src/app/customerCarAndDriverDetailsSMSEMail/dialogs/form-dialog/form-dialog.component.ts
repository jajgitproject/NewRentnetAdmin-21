...
export class FormDialogComponent 
{
  ...
  advanceTable: CustomerCarAndDriverDetailsSMSEMail;
  fName = '';
  contents: any[];
  mydata = [];
  name = '';
 saveDisabled:boolean = true;
  ...
  public _generalService:GeneralService)
  {
    this.CustomerID= data.customerID,
        ...
        if (this.action === 'edit') 
        {
          this.dialogTitle ='Additional Car and Driver Details SMS Email';       
          this.advanceTable = data.advanceTable;
        } else 
        {
          this.dialogTitle = 'Additional Car and Driver Details SMS Email';
          this.advanceTable = new CustomerCarAndDriverDetailsSMSEMail({});
  ...
  createContactForm(): FormGroup 
  {
    ...
    {
      customerCarAndDriverDetailsSMSEMailID: [this.advanceTable.customerCarAndDriverDetailsSMSEMailID],
  ...
  public Post(): void
  {
    ...
    response => 
    {
       ...
       this._generalService.sendUpdate('CustomerCarAndDriverDetailsSMSEMailCreate:CustomerCarAndDriverDetailsSMSEMailView:Success');//To Send Updates  
  ...
  public Put(): void
  {
    ...
    {
        this.dialogRef.close();
       this._generalService.sendUpdate('CustomerCarAndDriverDetailsSMSEMailUpdate:CustomerCarAndDriverDetailsSMSEMailView:Success');//To Send Updates  
       this.saveDisabled = true;
    },
    error =>
    {
...
//   if (/[a-zA-Z]/.customerCarAndDriverDetailsSMSEMail(inp)) {
//     return true;
//   } else {
//     event.preventDefault();
//     return false;
