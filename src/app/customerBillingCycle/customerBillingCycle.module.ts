...
import { CustomerBillingCycleRoutingModule } from './customerBillingCycle-routing.module';
// import { TwoDigitDecimaNumberDirective } from './twodigitdecimalnumber.directive';


@NgModule({
  declarations: [
    CustomerBillingCycleComponent,
    advanceTableForm,
  ...
  imports: [
    ...
    FormsModule,
    ReactiveFormsModule,
    CustomerBillingCycleRoutingModule,
    MatTableModule,
    MatPaginatorModule,
    MatFormFieldModule,
    MatInputModule,
  ...
  providers: [CustomerBillingCycleService]
})
export class CustomerBillingCycleModule {}
