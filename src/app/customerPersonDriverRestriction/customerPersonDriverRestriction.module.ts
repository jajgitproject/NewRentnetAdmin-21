...
import { CustomerPersonDriverRestrictionRoutingModule } from './customerPersonDriverRestriction-routing.module';
...
@NgModule({
  declarations: [
    CustomerPersonDriverRestrictionComponent,
    advanceTableForm,
  ...
  imports: [
    ...
    FormsModule,
    ReactiveFormsModule,
    CustomerPersonDriverRestrictionRoutingModule,
    MatTableModule,
    MatPaginatorModule,
    MatFormFieldModule,
    MatInputModule,
  ...
  providers: [CustomerPersonDriverRestrictionService]
})
export class CustomerPersonDriverRestrictionModule {}
