...
import { CustomerBlockingRoutingModule } from './customerBlocking-routing.module';
...
@NgModule({
  ...
  providers: [CustomerBlockingService]
})
export class CustomerBlockingModule {}
