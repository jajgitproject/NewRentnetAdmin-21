...
import { CustomerGroupSBTDomainRoutingModule } from './customerGroupSBTDomain-routing.module';
...
@NgModule({
  declarations: [
    CustomerGroupSBTDomainComponent,
    advanceTableForm,
  ...
  imports: [
    ...
    FormsModule,
    ReactiveFormsModule,
    CustomerGroupSBTDomainRoutingModule,
    MatTableModule,
    MatPaginatorModule,
    MatFormFieldModule,
    MatInputModule,
  ...
  providers: [CustomerGroupSBTDomainService]
})
export class CustomerGroupSBTDomainModule {}
