...
import { CreditNoteDutyAdjustmentRoutingModule } from './creditNoteDutyAdjustment-routing.module';
...
@NgModule({
  declarations: [
    CreditNoteDutyAdjustmentComponent,
    advanceTableForm,
  ...
  imports: [
    ...
    MatTooltipModule,
    ReactiveFormsModule,
    CreditNoteDutyAdjustmentRoutingModule,
  ...
  providers: [CreditNoteDutyAdjustmentService],
})
export class CreditNoteDutyAdjustmentModule {}
