...
import { VendorOutStationOneWayTripRate } from './vendorOutStationOneWayTripRate.model';
...
@Component({
  standalone: false,
  selector: 'app-vendorOutStationOneWayTripRate',
  templateUrl: './vendorOutStationOneWayTripRate.component.html',
  styleUrls: ['./vendorOutStationOneWayTripRate.component.sass'],
  providers: [{ provide: MAT_DATE_LOCALE, useValue: 'en-GB' }]
})
export class VendorOutStationOneWayTripRateComponent implements OnInit {
  displayedColumns = [
  ...
  dataSource: VendorOutStationOneWayTripRate[] | null;
  vendorOutStationOneWayTripRateID: number;
  VendorOutStationOneWayTripRateID: number=0;
  advanceTable: VendorOutStationOneWayTripRate | null;
  ...
  constructor(
    ...
    public vendorOutStationOneWayTripRateService: VendorOutStationOneWayTripRateService,
...
InitVehicleCategory(){
  ...
  refresh() {
    ...
    this.VendorOutStationOneWayTripRateID=0;
  ...
  editCall(row) {
      //  alert(row.id);
    this.vendorOutStationOneWayTripRateID = row.vendorOutStationOneWayTripRateID;
    const dialogRef = this.dialog.open(FormDialogComponent, {
      data: {
        advanceTable: row,
        action: 'edit',
  ...
  deleteItem(row)
  {
    ...
    this.vendorOutStationOneWayTripRateID = row.id;
  ...
  onBackPress(event) 
  {
   ...
   public loadData() 
   {
    switch (this.selectedFilter)
    {
      ...
      this.vendorOutStationOneWayTripRateService.getTableData(
        this.VendorOutStationOneWayTripRateID,
  ...
  onContextMenu(event: MouseEvent, item: VendorOutStationOneWayTripRate) {
    event.preventDefault();
...
/////////////////for Image Upload ends////////////////////////////
  ...
  SubscribeUpdateService()
  {
    ...
    (
      ...
      { 
        ...
        {
          if(this.MessageArray[0]=="VendorOutStationOneWayTripRateCreate")
          {
            if(this.MessageArray[1]=="VendorOutStationOneWayTripRateView")
            {
              if(this.MessageArray[2]=="Success")
              {
                ...
                'snackbar-success',
                'Vendor Contract OutStation One Way Trip Rate  Created ...!!!',
                'bottom',
                'center'
              );
              }
          ...
          else if(this.MessageArray[0]=="VendorOutStationOneWayTripRateUpdate")
          {
            if(this.MessageArray[1]=="VendorOutStationOneWayTripRateView")
            {
              if(this.MessageArray[2]=="Success")
              {
               ...
               this.showNotification(
                'snackbar-success',
                'Vendor Contract OutStation One Way Trip Rate Updated...!!!',
                'bottom',
                'center'
              );
              }
          ...
          else if(this.MessageArray[0]=="VendorOutStationOneWayTripRateDelete")
          {
            if(this.MessageArray[1]=="VendorOutStationOneWayTripRateView")
            {
              if(this.MessageArray[2]=="Success")
              {
               ...
               this.showNotification(
                'snackbar-success',
                'Vendor Contract OutStation One Way Trip Rate  Deleted ...!!!',
                'bottom',
                'center'
              );
              }
          ...
          else if(this.MessageArray[0]=="VendorOutStationOneWayTripRateAll")
          {
            if(this.MessageArray[1]=="VendorOutStationOneWayTripRateView")
            {
  ...
  SortingData(coloumName:any) {
    ...
    this.vendorOutStationOneWayTripRateService.getTableDataSort(
      this.VendorOutStationOneWayTripRateID,
      this.vendorContract_ID,
  ...
  RateView()
  {
    ...
    const url = this.router.serializeUrl(this.router.createUrlTree(
      ['/rateViewForOutstationOneWayTripVendorContract'],
      {
        queryParams: {
