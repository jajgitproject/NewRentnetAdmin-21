...
import { CurrentDutyRoutingModule } from './currentDuty-routing.module';
...
@NgModule({
  ...
  exports:[CurrentDutyComponent],
  providers: [CurrentDutyService]
})
export class CurrentDutyModule {}
