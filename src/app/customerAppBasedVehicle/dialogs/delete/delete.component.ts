...
export class DeleteDialogComponent
{
  ...
  confirmDelete()
  {
    this.advanceTableService.delete(this.data.customerAppVehicleMappingID)  
    .subscribe(
    data => 
    {
       this._generalService.sendUpdate('CustomerAppBasedVehicleDelete:CustomerAppBasedVehicleView:Success');//To Send Updates   
    },
    error =>
    {
