...
import { UpsellDeclineReasonRoutingModule } from './upsellDeclineReason-routing.module';

@NgModule({
  declarations: [
    UpsellDeclineReasonComponent,
    advanceTableForm,
  ...
  imports: [
    ...
    FormsModule,
    ReactiveFormsModule,
    UpsellDeclineReasonRoutingModule,
    MatTableModule,
    MatPaginatorModule,
    MatFormFieldModule,
    MatInputModule,
  ...
  providers: [UpsellDeclineReasonService]
})
export class UpsellDeclineReasonModule {}
