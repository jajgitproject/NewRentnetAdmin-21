...
import { DriverCarWithoutDutyMISRoutingModule } from '../driverCarWithoutDutyMIS/driverCarWithoutDutyMIS-routing.module';
...
@NgModule({
  declarations: [
    DriverCarWithoutDutyMISComponent,
  ],
  imports: [
    ...
    FormsModule,
    ReactiveFormsModule,
    DriverCarWithoutDutyMISRoutingModule,
    MatTableModule,
    MatPaginatorModule,
    MatFormFieldModule,
    MatInputModule,
  ...
  providers: [DriverCarWithoutDutyMISService]
})
export class DriverCarWithoutDutyMISModule {}
