...
import { CustomerConfigurationSupplierDropDown } from '../../customerConfigurationSupplierDropDown.model';
...
export class FormDialogComponent 
{
  ...
  advanceTable: CustomerConfigurationSupplier;
  CustomerID:number;
  ...
  public _generalService:GeneralService)
  {
        ...
        if (this.action === 'edit') 
        {
          this.dialogTitle ='Supplier Configuration For';       
          this.advanceTable = data.advanceTable;
        } else 
        {
          this.dialogTitle = 'Supplier Configuration For';
          this.advanceTable = new CustomerConfigurationSupplier({});
  ...
  createContactForm(): FormGroup 
  {
    ...
    {
      customerConfigurationSupplierID: [this.advanceTable.customerConfigurationSupplierID],
      customerID: [this.advanceTable.customerID],
      commissionToBeDeductedFromVendor: [this.advanceTable.commissionToBeDeductedFromVendor],
      deductCreditCardFeesFromVendor: [this.advanceTable.deductCreditCardFeesFromVendor],
      supplierPaymentType: [this.advanceTable.supplierPaymentType],
...
//   if (/[a-zA-Z]/.customerConfigurationSupplier(inp)) {
//     return true;
//   } else {
//     event.preventDefault();
//     return false;
