...
export class AskForDeleteDialogComponent
{
  ...
  confirmDelete()
  {
    ...
    this.advanceTableService.delete(this.data.CustomerConfigurationSupplierID)  
    .subscribe(
    data => 
    {
      this.dialogRef.close();
       this._generalService.sendUpdate('CustomerConfigurationSupplierDelete:CustomerConfigurationSupplierView:Success');//To Send Updates   
    },
    error =>
    {
