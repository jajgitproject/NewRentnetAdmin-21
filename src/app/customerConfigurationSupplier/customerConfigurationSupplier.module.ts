...
import { CustomerConfigurationSupplierRoutingModule } from './customerConfigurationSupplier-routing.module';
...
@NgModule({
  declarations: [
    CustomerConfigurationSupplierComponent,
    advanceTableForm,
  ...
  imports: [
    ...
    FormsModule,
    ReactiveFormsModule,
    CustomerConfigurationSupplierRoutingModule,
    MatTableModule,
    MatPaginatorModule,
    MatFormFieldModule,
    MatInputModule,
  ...
  providers: [CustomerConfigurationSupplierService]
})
export class CustomerConfigurationSupplierModule {}
