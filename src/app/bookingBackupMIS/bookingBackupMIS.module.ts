...
import { BookingBackupMISRoutingModule } from './bookingBackupMIS-routing.module';


@NgModule({
  declarations: [
    BookingBackupMISComponent,
  ...
  providers: [BookingBackupMISService]
})
export class BookingBackupMISModule {}
