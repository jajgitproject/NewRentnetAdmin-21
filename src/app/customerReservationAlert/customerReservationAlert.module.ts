...
import { CustomerReservationAlertRoutingModule } from './customerReservationAlert-routing.module';
...
@NgModule({
  declarations: [
    CustomerReservationAlertComponent,
    advanceTableForm,
  ...
  imports: [
    ...
    FormsModule,
    ReactiveFormsModule,
    CustomerReservationAlertRoutingModule,
    MatTableModule,
    MatPaginatorModule,
    MatFormFieldModule,
    MatInputModule,
  ...
  providers: [CustomerReservationAlertService]
})
export class CustomerReservationAlertModule {}
