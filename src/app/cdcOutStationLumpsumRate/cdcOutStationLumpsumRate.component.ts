...
@Component({
  standalone: false,
  selector: 'app-cdcOutStationLumpsumRate',
  templateUrl: './cdcOutStationLumpsumRate.component.html',
  styleUrls: ['./cdcOutStationLumpsumRate.component.sass'],
  providers: [{ provide: MAT_DATE_LOCALE, useValue: 'en-GB' }]
})
export class CDCOutStationLumpsumRateComponent implements OnInit {
  displayedColumns = [
  ...
  dataSource: CDCOutStationLumpsumRate[] | null;
  cdcOutStationLumpsumRateID: number;
  CDCOutStationLumpsumRateID: number=0;
  advanceTable: CDCOutStationLumpsumRate | null;
  ...
  constructor(
    ...
    public cdcOutStationLumpsumRateService: CDCOutStationLumpsumRateService,
...
InitVehicleCategory(){
  ...
  refresh() {
    ...
    this.CDCOutStationLumpsumRateID=0;
  ...
  editCall(row) {
      //  alert(row.id);
    this.cdcOutStationLumpsumRateID = row.cdcLocalRateID;
    const dialogRef = this.dialog.open(FormDialogComponent, {
      data: {
        advanceTable: row,
        action: 'edit',
  ...
  deleteItem(row)
  {
    ...
    this.cdcOutStationLumpsumRateID = row.id;
  ...
  onBackPress(event) 
  {
   ...
   public loadData() 
   {
    switch (this.selectedFilter)
    {
      ...
      this.cdcOutStationLumpsumRateService.getTableData(
        this.CDCOutStationLumpsumRateID,
  ...
  onContextMenu(event: MouseEvent, item: CDCOutStationLumpsumRate) {
    event.preventDefault();
...
/////////////////for Image Upload ends////////////////////////////
  ...
  SubscribeUpdateService()
  {
    ...
    (
      ...
      { 
        ...
        {
          if(this.MessageArray[0]=="CDCOutStationLumpsumRateCreate")
          {
            if(this.MessageArray[1]=="CDCOutStationLumpsumRateView")
            {
              if(this.MessageArray[2]=="Success")
              {
                ...
                'snackbar-success',
                'CDC Outstation Lumpsum Rate Created ...!!!',
                'bottom',
                'center'
              );
              }
          ...
          else if(this.MessageArray[0]=="CDCOutStationLumpsumRateUpdate")
          {
            if(this.MessageArray[1]=="CDCOutStationLumpsumRateView")
            {
              if(this.MessageArray[2]=="Success")
              {
               ...
               this.showNotification(
                'snackbar-success',
                'CDC Outstation Lumpsum Rate Updated ...!!!',
                'bottom',
                'center'
              );
              }
          ...
          else if(this.MessageArray[0]=="CDCOutStationLumpsumRateDelete")
          {
            if(this.MessageArray[1]=="CDCOutStationLumpsumRateView")
            {
              if(this.MessageArray[2]=="Success")
              {
               ...
               this.showNotification(
                'snackbar-success',
                'CDC Outstation Lumpsum Rate Deleted ...!!!',
                'bottom',
                'center'
              );
              }
          ...
          else if(this.MessageArray[0]=="CDCOutStationLumpsumRateAll")
          {
            if(this.MessageArray[1]=="CDCOutStationLumpsumRateView")
            {
  ...
  SortingData(coloumName:any) {
    ...
    this.cdcOutStationLumpsumRateService.getTableDataSort(
      this.CDCOutStationLumpsumRateID,
      this.customerContract_ID,
  ...
  RateView()
  {
    ...
    const url = this.router.serializeUrl(this.router.createUrlTree(
      ['/rateViewForOutstationLumpsumContract'],
      {
        queryParams: {
