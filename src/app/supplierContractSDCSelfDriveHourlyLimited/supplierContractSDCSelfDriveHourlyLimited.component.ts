...
@Component({
  standalone: false,
  selector: 'app-supplierContractSDCSelfDriveHourlyLimited',
  templateUrl: './supplierContractSDCSelfDriveHourlyLimited.component.html',
  styleUrls: ['./supplierContractSDCSelfDriveHourlyLimited.component.sass'],
  providers: [{ provide: MAT_DATE_LOCALE, useValue: 'en-GB' }]
})
export class SupplierContractSDCSelfDriveHourlyLimitedComponent implements OnInit {
  displayedColumns = [
    'vehicleCategory',
    'cityTierName',
    'package',
  ...
  dataSource: SupplierContractSDCSelfDriveHourlyLimited[] | null;
  supplierContractSDCSelfDriveHourlyLimitedID: number;
  advanceTable: SupplierContractSDCSelfDriveHourlyLimited | null;
  searchSupplierContractSDCSelfDriveHourlyLimitedID: number=0;
  ...
  constructor(
    ...
    public supplierContractSDCSelfDriveHourlyLimitedService: SupplierContractSDCSelfDriveHourlyLimitedService,
...
@ViewChild(MatMenuTrigger)
  ...
  refresh() {
    ...
    this.searchSupplierContractSDCSelfDriveHourlyLimitedID=0;
  ...
  editCall(row) {
      //  alert(row.id);
    this.supplierContractSDCSelfDriveHourlyLimitedID = row.supplierContractSDCSelfDriveHourlyLimitedID;
    const dialogRef = this.dialog.open(FormDialogComponent, {
      data: {
        advanceTable: row,
        action: 'edit',
  ...
  deleteItem(row)
  {
    ...
    this.supplierContractSDCSelfDriveHourlyLimitedID = row.id;
   ...
   public loadData() 
   {
      ...
      switch (this.selectedFilter)
      {
        ...
        case 'baseRate':
          ...
          break;
          case 'hrs':
          this.SearchHrs = this.searchTerm;
          break;
        default:
          this.searchTerm = '';
          break;
      ...
      this.supplierContractSDCSelfDriveHourlyLimitedService.getTableData(
        this.searchSupplierContractSDCSelfDriveHourlyLimitedID,
  ...
  onContextMenu(event: MouseEvent, item: SupplierContractSDCSelfDriveHourlyLimited) {
    event.preventDefault();
...
/////////////////for Image Upload ends////////////////////////////
  ...
  SubscribeUpdateService()
  {
    ...
    (
      ...
      { 
        ...
        {
          if(this.MessageArray[0]=="SupplierContractSDCSelfDriveHourlyLimitedCreate")
          {
            if(this.MessageArray[1]=="SupplierContractSDCSelfDriveHourlyLimitedView")
            {
              if(this.MessageArray[2]=="Success")
              {
                ...
                'snackbar-success',
                'Supplier Contract SDC Self Drive Hourly Limited Created...!!!',
                'bottom',
                'center'
              );
              }
          ...
          else if(this.MessageArray[0]=="SupplierContractSDCSelfDriveHourlyLimitedUpdate")
          {
            if(this.MessageArray[1]=="SupplierContractSDCSelfDriveHourlyLimitedView")
            {
              if(this.MessageArray[2]=="Success")
              {
               ...
               this.showNotification(
                'snackbar-success',
                'Supplier Contract SDC Self Drive Hourly Limited Updated...!!!',
                'bottom',
                'center'
              );
              }
          ...
          else if(this.MessageArray[0]=="SupplierContractSDCSelfDriveHourlyLimitedDelete")
          {
            if(this.MessageArray[1]=="SupplierContractSDCSelfDriveHourlyLimitedView")
            {
              if(this.MessageArray[2]=="Success")
              {
               ...
               this.showNotification(
                'snackbar-success',
                'Supplier Contract SDC Self Drive Hourly Limited Deleted...!!!',
                'bottom',
                'center'
              );
              }
          ...
          else if(this.MessageArray[0]=="SupplierContractSDCSelfDriveHourlyLimitedAll")
          {
            if(this.MessageArray[1]=="SupplierContractSDCSelfDriveHourlyLimitedView")
            {
  ...
  SortingData(coloumName:any) {
    ...
    this.supplierContractSDCSelfDriveHourlyLimitedService.getTableDataSort(
      this.searchSupplierContractSDCSelfDriveHourlyLimitedID,
      this.supplierContract_ID,
