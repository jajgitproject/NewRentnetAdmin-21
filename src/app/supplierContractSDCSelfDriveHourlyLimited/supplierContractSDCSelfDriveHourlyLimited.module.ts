...
import { SupplierContractSDCSelfDriveHourlyLimitedRoutingModule } from './supplierContractSDCSelfDriveHourlyLimited-routing.module';
...
@NgModule({
  declarations: [
    SupplierContractSDCSelfDriveHourlyLimitedComponent,
    advanceTableForm,
  ...
  imports: [
    ...
    FormsModule,
    ReactiveFormsModule,
    SupplierContractSDCSelfDriveHourlyLimitedRoutingModule,
    MatTableModule,
    MatPaginatorModule,
    MatFormFieldModule,
    MatInputModule,
  ...
  providers: [SupplierContractSDCSelfDriveHourlyLimitedService]
})
export class SupplierContractSDCSelfDriveHourlyLimitedModule {}
