...
export class FormDialogComponent 
{
  ...
  advanceTable: CDCLocalTransferRate;
  fName = '';
  contents: any[];
  mydata = [];
  name = '';
  ...
  public _generalService:GeneralService)
  {
    this.CustomerContractID= data.customerContractID,
        ...
        {
          this.dialogTitle ='Chauffeur Driven Car Local Transfer Package';       
        ...
        {
          this.dialogTitle = 'Chauffeur Driven Car Local Transfer Package';
          this.advanceTable = new CDCLocalTransferRate({});
  ...
  createContactForm(): FormGroup 
  {
    ...
    {
      cdcLocalTransferRateID: [this.advanceTable.cdcLocalTransferRateID],
...
numberOnly(event): boolean {
  ...
  public Post(): void
  {
    ...
    .subscribe(
      response => {
        ...
        {
          this.dialogRef.close();
          this._generalService.sendUpdate('CDCLocalTransferRateCreate:CDCLocalTransferRateView:Success');//To Send Updates  
          this.saveDisabled = true;
        } 
      },
      error =>
  ...
  public Put(): void
  {
    ...
    .subscribe(
      response => {
        ...
        {
          this.dialogRef.close();
          this._generalService.sendUpdate('CDCLocalTransferRateUpdate:CDCLocalTransferRateView:Success');//To Send Updates  
          this.saveDisabled = true;
        } 
      },
      error =>
  ...
  public Duplicate(): void
  {
    ...
    response => 
    {
      ...
      {
        this.dialogRef.close();
        this._generalService.sendUpdate('CDCLocalTransferRateUpdate:CDCLocalTransferRateView:Success');
        this.saveDisabled = true; 
      }
    },
    error =>
    {
     this._generalService.sendUpdate('CDCLocalTransferRateAll:CDCLocalTransferRateView:Failure');
     this.saveDisabled = true;
    }
  )
  }
