...
import { InventoryStatusHistoryRoutingModule } from './inventoryStatusHistory-routing.module';
...
@NgModule({
  declarations: [
    InventoryStatusHistoryComponent,
    advanceTableForm,
  ...
  imports: [
    ...
    FormsModule,
    ReactiveFormsModule,
    InventoryStatusHistoryRoutingModule,
    MatTableModule,
    MatPaginatorModule,
    MatFormFieldModule,
    MatInputModule,
