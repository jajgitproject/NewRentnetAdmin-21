...
import { DriverComplianceDashboardRoutingModule } from './driverComplianceDashboard-routing.module';
import { MatExpansionModule } from '@angular/material/expansion';

@NgModule({
  declarations: [
    DriverComplianceDashboardComponent,
  ...
  imports: [
    ...
    MatTooltipModule,
    ReactiveFormsModule,
    DriverComplianceDashboardRoutingModule,
  ...
  providers: [DriverComplianceDashboardService],
})
export class DriverComplianceDashboardModule {}
