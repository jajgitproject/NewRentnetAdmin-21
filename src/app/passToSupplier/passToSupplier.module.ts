...
import { PassToSupplierRoutingModule } from './passToSupplier-routing.module';
import { MyUploadComponent } from '../myupload/myupload.component';
import { MyUploadModule } from '../myupload/myupload.module';
import { MatAutocompleteModule } from '@angular/material/autocomplete';
@NgModule({
  declarations: [
    PassToSupplierComponent,
    advanceTableForm,
  ...
  providers: [PassToSupplierService]
})
export class PassToSupplierModule {}
