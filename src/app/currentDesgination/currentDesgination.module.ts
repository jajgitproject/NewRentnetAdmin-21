...
import { CurrentDesginationRoutingModule } from './currentDesgination-routing.module';
...
@NgModule({
  ...
  imports: [
    ...
    FormsModule,
    ReactiveFormsModule,
    CurrentDesginationRoutingModule,
    MatTableModule,
    MatPaginatorModule,
    MatFormFieldModule,
    MatInputModule,
  ...
  exports:[CurrentDesginationComponent],
  providers: [CurrentDesginationService]
})
export class CurrentDesginationModule {}
