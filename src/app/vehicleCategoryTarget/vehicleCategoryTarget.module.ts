...
import { VehicleCategoryTargetRoutingModule } from './vehicleCategoryTarget-routing.module';
import { MyUploadComponent } from '../myupload/myupload.component';
import { MyUploadModule } from '../myupload/myupload.module';
@NgModule({
  declarations: [
    VehicleCategoryTargetComponent,
    advanceTableForm,
  ...
  imports: [
    ...
    FormsModule,
    ReactiveFormsModule,
    VehicleCategoryTargetRoutingModule,
    MatTableModule,
    MatPaginatorModule,
    MatFormFieldModule,
    MatInputModule,
  ...
  providers: [VehicleCategoryTargetService]
})
export class VehicleCategoryTargetModule {}
