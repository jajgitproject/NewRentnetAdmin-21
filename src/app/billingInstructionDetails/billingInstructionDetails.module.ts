...
import { BillingInstructionDetailsRoutingModule } from './billingInstructionDetails-routing.module';
...
@NgModule({
  declarations: [
    BillingInstructionDetailsComponent,
    //advanceTableForm,
  ...
  imports: [
    ...
    FormsModule,
    ReactiveFormsModule,
    BillingInstructionDetailsRoutingModule,
    MatTableModule,
    MatPaginatorModule,
    MatFormFieldModule,
    MatInputModule,
  ...
  providers: [BillingInstructionDetailsService]
})
export class BillingInstructionDetailsModule {}
