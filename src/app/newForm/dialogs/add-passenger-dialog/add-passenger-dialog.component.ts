...
@Component({
  ...
  styleUrls: ['./add-passenger-dialog.component.sass'],
...
export class AddPassengerDialogComponent 
{
  ...
  options: User[] = [{ name: 'Rohit-8978675609-rohit@gmail.com-Male-VIP' }, { name: 'Amit-7898989899-amit@gmail.com-Male-VIP' }, { name: 'Amrita-6787888989-amrita@gmail.com-Female-VIP' }];
