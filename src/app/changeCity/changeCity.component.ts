...
@Component({
  standalone: false,
  selector: 'app-changeCity',
  templateUrl: './changeCity.component.html',
  styleUrls: ['./changeCity.component.sass'],
  providers: [{ provide: MAT_DATE_LOCALE, useValue: 'en-GB' }]
})
export class ChangeCityComponent implements OnInit {
  // @Input() advanceTableMOP
  // @Input() reservationID;
  advanceTable: ChangeCityModel | null;
  advanceTableForm: FormGroup;

  constructor(
    public httpClient: HttpClient,
    public dialog: MatDialog,
    public mopDetailsService: ChangeCityService,
    ...
    (
      ...
      { 
        ...
        if(this.MessageArray.length==3)
        {
          ...
          else if(this.MessageArray[0]=="ChangeCityAll")
          {
            if(this.MessageArray[1]=="ChangeCityView")
            {
