...
@Component({
  standalone: false,
  selector: 'app-supplierContractPackageTypePercentage',
  templateUrl: './supplierContractPackageTypePercentage.component.html',
  styleUrls: ['./supplierContractPackageTypePercentage.component.sass'],
  providers: [{ provide: MAT_DATE_LOCALE, useValue: 'en-GB' }]
})
export class SupplierContractPackageTypePercentageComponent implements OnInit {
  displayedColumns = [
    'packageType',
    'fromDate',
    'toDate',
  ...
  dataSource: SupplierContractPackageTypePercentage[] | null;
  filteredPackageTypeOptions: Observable<PackageTypeDropDown[]>;
  supplierContractPackageTypePercentageID: number;
  advanceTable: SupplierContractPackageTypePercentage | null;
  SearchSupplierContractPackageTypePercentage: string = ''; 
  ...
  constructor(
    ...
    public supplierContractPackageTypePercentageService: SupplierContractPackageTypePercentageService,
...
@ViewChild(MatMenuTrigger)
 ...
 private _filterPackage(value: string): any {
  ...
  editCall(row) {
      //  alert(row.id);
    this.supplierContractPackageTypePercentageID = row.id;
    const dialogRef = this.dialog.open(FormDialogComponentHolder, {
      data: {
        advanceTable: row,
        action: 'edit',
  ...
  {
    this.loadData();
    //this.SearchSupplierContractPackageTypePercentage='';
  }
  ...
  public loadData() {
    ...
    // Assign the searchTerm to the corresponding variable based on the selected filter
    ...
    this.supplierContractPackageTypePercentageService.getTableData(
  ...
  onContextMenu(event: MouseEvent, item: SupplierContractPackageTypePercentage) {
...
/////////////////for Image Upload ends////////////////////////////
    ...
    (
      ...
      { 
        ...
        if(this.MessageArray.length==3)
        {
            ...
            if(this.MessageArray[1]=="SupplierContractPackageTypePercentageView")
            {
              if(this.MessageArray[2]=="Success")
              {
               // debugger;
                ...
                'snackbar-success',
                'Supplier Contract PackageType Percentage Created...!!!',
                'bottom',
                'center'
              );
              }
          ...
          else if(this.MessageArray[0]=="SupplierContractPackageTypePercentageUpdate")
          {
            if(this.MessageArray[1]=="SupplierContractPackageTypePercentageView")
            {
              if(this.MessageArray[2]=="Success")
              {
               ...
               this.showNotification(
                'snackbar-success',
                'Supplier Contract PackageType Percentage Updated...!!!',
                'bottom',
                'center'
              );
              }
          ...
          else if(this.MessageArray[0]=="SupplierContractPackageTypePercentageDelete")
          {
            if(this.MessageArray[1]=="SupplierContractPackageTypePercentageView")
            {
              if(this.MessageArray[2]=="Success")
              {
               ...
               this.showNotification(
                'snackbar-success',
                'Supplier Contract PackageType Percentage Deleted...!!!',
                'bottom',
                'center'
              );
              }
          ...
          else if(this.MessageArray[0]=="SupplierContractPackageTypePercentageAll")
          {
            if(this.MessageArray[1]=="SupplierContractPackageTypePercentageView")
            {
  ...
  SortingData(coloumName:any) {
    ...
    this.supplierContractPackageTypePercentageService.getTableDataSort(this.supplierContract_ID,this.SearchSupplierContractPackageTypePercentage,this.SearchPercentage,this.SearchFromDate,
