...
import { OrganizationalEntityRoutingModule } from './organizationalEntity-routing.module';
...
@NgModule({
  ...
  imports: [
    ...
    OrganizationalEntityRoutingModule,
    MatTableModule,
    MatPaginatorModule,
    MatFormFieldModule,
    MatInputModule,
  ...
  providers: [OrganizationalEntityService,LutService]
})
export class OrganizationalEntityModule {}
