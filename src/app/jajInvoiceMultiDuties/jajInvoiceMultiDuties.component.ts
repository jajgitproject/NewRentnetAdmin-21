...
import { JajInvoiceMultiDuties } from './jajInvoiceMultiDuties.model';
import { JajInvoiceMultiDutiesService } from './jajInvoiceMultiDuties.service';


@Component({
  standalone: false,
  selector: 'app-jajInvoiceMultiDuties',
  templateUrl: './jajInvoiceMultiDuties.component.html',
  styleUrls: ['./jajInvoiceMultiDuties.component.scss'],
  providers: [{ provide: MAT_DATE_LOCALE, useValue: 'en-GB' }]
})
export class JajInvoiceMultiDutiesComponent implements OnInit {
  dataSource: any;
  dataSourceForInvoiceDuties: any[] = [];;
  advanceTable: JajInvoiceMultiDuties | null;
  sortingData: number;
  sortType: string;
  ...
  constructor(
    ...
    public jajInvoiceMultiDutiesService: JajInvoiceMultiDutiesService,
  ...
  public loadData() 
  {
     this.jajInvoiceMultiDutiesService.printDutySlipInfo(this.invoiceID).subscribe
   (
     data =>   
     {
  ...
  {
     this.jajInvoiceMultiDutiesService.getinvoiceMultiDuties(this.invoiceID).subscribe
   (
     data =>   
     {
