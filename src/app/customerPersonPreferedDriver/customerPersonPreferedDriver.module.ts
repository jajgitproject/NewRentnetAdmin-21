...
import { CustomerPersonPreferedDriverRoutingModule } from './customerPersonPreferedDriver-routing.module';
...
@NgModule({
  declarations: [
    CustomerPersonPreferedDriverComponent,
    advanceTableForm,
  ...
  imports: [
    ...
    FormsModule,
    ReactiveFormsModule,
    CustomerPersonPreferedDriverRoutingModule,
    MatTableModule,
    MatPaginatorModule,
    MatFormFieldModule,
    MatInputModule,
  ...
  providers: [CustomerPersonPreferedDriverService]
})
export class CustomerPersonPreferedDriverModule {}
