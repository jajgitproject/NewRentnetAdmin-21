...
import { KamCardRoutingModule } from './kamCard-routing.module';
...
@NgModule({
  ...
  exports: [KamCardComponent, FormDialogKCComponent],
  providers: [KamCardService]
})
export class KamCardModule {}
