...
import { BillToOtherDetailsRoutingModule } from './billToOtherDetails-routing.module';
...
@NgModule({
  declarations: [
    BillToOtherDetailsComponent,
  ],
  imports: [
    CommonModule,
    FormsModule,
    ReactiveFormsModule,
    BillToOtherDetailsRoutingModule,
    MatTableModule,
    MatPaginatorModule,
    MatFormFieldModule,
    MatInputModule,
  ...
  exports:[BillToOtherDetailsComponent],
  providers: [BillToOtherDetailsService,AdditionalSMSEmailWhatsappService]
})
export class BillToOtherDetailsModule {}
