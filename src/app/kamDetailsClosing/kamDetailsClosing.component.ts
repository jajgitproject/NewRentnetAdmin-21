...
import { KAMDetailsClosing } from './kamDetailsClosing.model';
import { KAMDetailsClosingService } from './kamDetailsClosing.service';


@Component({
  standalone: false,
  selector: 'app-kamDetailsClosing',
  templateUrl: './kamDetailsClosing.component.html',
  styleUrls: ['./kamDetailsClosing.component.sass'],
  providers: [{ provide: MAT_DATE_LOCALE, useValue: 'en-GB' }]
})
export class KAMDetailsClosingComponent implements OnInit {
  @Input() ReservationID;
 
  dataSource: KAMDetailsClosing[] | null;
...
(
 ...
 (error: HttpErrorResponse) => { this.advanceTableKC = null;}
  ...
  onContextMenu(event: MouseEvent, item: KAMDetailsClosing) {
