...
export class CarAndDriverActionsFormDialogComponent 
{
  ...
  advanceTable: CarAndDriverActions;
  ...
  constructor(
  public dialogRef: MatDialogRef<CarAndDriverActionsFormDialogComponent>, 
  ...
  public _generalService:GeneralService)
  {
        ...
        if (this.action === 'edit') 
        {
          this.dialogTitle ='Actions';       
          this.advanceTable = data.advanceTable;
        } 
        else 
        {
          this.dialogTitle = 'Actions';
          this.advanceTable = new CarAndDriverActions({});
  ...
  createContactForm(): FormGroup 
  {
    ...
    {
      CarAndDriverActionsID: [this.advanceTable.CarAndDriverActionsID],
      CarAndDriverActions: [this.advanceTable.CarAndDriverActions,[this.noWhitespaceValidator]],
