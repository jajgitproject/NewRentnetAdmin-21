...
import {FormDialogComponent as BankFormDialogComponent} from '../bank/dialogs/form-dialog/form-dialog.component'
@Component({
  standalone: false,
  selector: 'app-employeeDemo',
  templateUrl: './employeeDemo.component.html',
  styleUrls: ['./employeeDemo.component.sass'],
...
export class EmployeeDemoComponent implements OnInit {
  ...
  dataSource: EmployeeDemo[] | null;
  employeeID: number;
  advanceTable: EmployeeDemo | null;
  SearchName: string = '';
  ...
  constructor(
    ...
    public employeeDemoService: EmployeeDemoService,
  ...
  public loadData(source:string = 'init') 
  {
    if (source === 'popUp')
    {
      this.employeeDemoService.getTableData(
        this.SearchName,
        this.SearchSupplierName,
        '',
        '',
  ...
  onContextMenu(event: MouseEvent, item: EmployeeDemo) {
  ...
  SortingData(coloumName: any) {
    ...
    this.employeeDemoService.getTableDataSort(
      this.SearchNameForFilter,
      this.SearchSupplierNameForFilter,
      this.SearchEmailForFilter,
      this.SearchPhoneForFilter,
