...
export class DeleteDialogComponent
{
  ...
  confirmDelete()
  {
    ...
    this.advanceTableService.delete(this.data.customerPersonDocumentID)  
    .subscribe(
    data => 
    {
       this._generalService.sendUpdate('CustomerPersonDocumentDelete:CustomerPersonDocumentView:Success');//To Send Updates   
    },
    error =>
    {
