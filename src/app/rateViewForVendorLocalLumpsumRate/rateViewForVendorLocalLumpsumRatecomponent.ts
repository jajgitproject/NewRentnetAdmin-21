...
import { RateViewForVendorLocalLumpsumRateModel } from './rateViewForVendorLocalLumpsumRate.model';
import { RateViewForVendorLocalLumpsumRateService } from './rateViewForVendorLocalLumpsumRate.service';


@Component({
  standalone: false,
  selector: 'app-rateViewForVendorLocalLumpsumRate',
  templateUrl: './rateViewForVendorLocalLumpsumRate.component.html',
  styleUrls: ['./rateViewForVendorLocalLumpsumRate.component.sass'],
  providers: [{ provide: MAT_DATE_LOCALE, useValue: 'en-GB' }]
})

export class RateViewForVendorLocalLumpsumRateComponent implements OnInit {
  displayedColumns = [
    'Package',
    'City',    
  ...
  dataSource: RateViewForVendorLocalLumpsumRateModel[] | null;
  CustomerContract_ID: any;
  PackageName: string;
  advanceTable: RateViewForVendorLocalLumpsumRateModel | null;
  ...
  constructor(
    ...
    public rateViewForVendorLocalLumpsumService: RateViewForVendorLocalLumpsumRateService,
  ...
  public Filter()
  {
   ...
   public loadData() 
   {
      this.rateViewForVendorLocalLumpsumService.getTableData(this.vendorContract_ID).subscribe
      (
        data =>   
        {
  ...
  onContextMenu(event: MouseEvent, item: RateViewForVendorLocalLumpsumRateModel) {
