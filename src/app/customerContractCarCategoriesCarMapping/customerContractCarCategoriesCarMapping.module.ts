...
import { CustomerContractCarCategoriesCarMappingRoutingModule } from './customerContractCarCategoriesCarMapping-routing.module';
...
@NgModule({
  declarations: [
    CustomerContractCarCategoriesCarMappingComponent,
    advanceTableForm,
  ...
  imports: [
    ...
    FormsModule,
    ReactiveFormsModule,
    CustomerContractCarCategoriesCarMappingRoutingModule,
    MatTableModule,
    MatPaginatorModule,
    MatFormFieldModule,
    MatInputModule,
  ...
  providers: [CustomerContractCarCategoriesCarMappingService]
})
export class CustomerContractCarCategoriesCarMappingModule {}
