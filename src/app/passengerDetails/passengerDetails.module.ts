...
import { PassengerDetailsRoutingModule } from './passengerDetails-routing.module';
...
@NgModule({
  ...
  exports: [PassengerDetailsComponent, FormDialogRPComponent],
  providers: [PassengerDetailsService,AdvanceService]
})
