...
export class DeleteDialogComponent
{
  ...
  confirmDelete()
  {
    this.advanceTableService.delete(this.data.customerPersonInventoryRestrictionID)  
    .subscribe(
    data => 
    {
       this._generalService.sendUpdate('CustomerPersonInventoryRestrictionDelete:CustomerPersonInventoryRestrictionView:Success');//To Send Updates   
    },
    error =>
    {
