...
import { CustomerPersonInventoryRestrictionRoutingModule } from './customerPersonInventoryRestriction-routing.module';
...
@NgModule({
  declarations: [
    CustomerPersonInventoryRestrictionComponent,
    advanceTableForm,
  ...
  imports: [
    ...
    FormsModule,
    ReactiveFormsModule,
    CustomerPersonInventoryRestrictionRoutingModule,
    MatTableModule,
    MatPaginatorModule,
    MatFormFieldModule,
    MatInputModule,
  ...
  providers: [CustomerPersonInventoryRestrictionService]
})
export class CustomerPersonInventoryRestrictionModule {}
