...
import { CurrentDutyDetailsComponent } from './currentDutyDetails.component';
import { CurrentDutyDetailsRoutingModule } from './currentDutyDetails-routing.module';
...
@NgModule({
  ...
  imports: [
    ...
    FormsModule,
    ReactiveFormsModule,
    CurrentDutyDetailsRoutingModule,
    MatTableModule,
    MatPaginatorModule,
    MatFormFieldModule,
    MatInputModule,
  ...
  exports:[],
  providers: [CurrentDutyDetailsService,AdvanceService,ClossingOneService]
})
export class CurrentDutyDetailsModule {}
