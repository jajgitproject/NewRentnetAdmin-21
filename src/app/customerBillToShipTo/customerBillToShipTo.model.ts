...
export class CustomerBillToShipTo {
  ...
  constructor(data?: any) {
    ...
    this.headInBill = data.headInBill || data.HeadInBill || '';
    this.shipToCompany = data.shipToCompany || data.ShipToCompany || '';
    ...
    this.countryName = data.countryName || data.CountryName || '';
