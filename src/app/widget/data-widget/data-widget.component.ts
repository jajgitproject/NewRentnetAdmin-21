...
import { ProgressChartWidgetComponent } from '@shared/components/progress-chart-widget/progress-chart-widget.component';
...
export class DataWidgetComponent {
  ...
  // Progress chart data
  progressData = [
    { label: 'Website Development', value: 85, color: '#3f51b5', target: 100 },
    { label: 'Mobile App', value: 60, color: '#4caf50', target: 100 },
    { label: 'UI/UX Design', value: 75, color: '#ff9800', target: 100 },
    { label: 'Database Migration', value: 40, color: '#f44336', target: 100 },
  ];
