...
import { LocationGroupLocationMappingRoutingModule } from './locationGroupLocationMapping-routing.module';
import { LocationGroupLocationMappingService } from './locationGroupLocationMapping.service';
import { DeleteDialogComponent } from './dialogs/delete/delete.component';

@NgModule({
  declarations: [
    LocationGroupLocationMappingComponent,
    advanceTableForm,
  ...
  imports: [
    ...
    FormsModule,
    ReactiveFormsModule,
    LocationGroupLocationMappingRoutingModule,
    MatTableModule,
    MatPaginatorModule,
    MatFormFieldModule,
    MatInputModule,
  ...
  providers: [LocationGroupLocationMappingService]
})
export class LocationGroupLocationMappingModule {}
