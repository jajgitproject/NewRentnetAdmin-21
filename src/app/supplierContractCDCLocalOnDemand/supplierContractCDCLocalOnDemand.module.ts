...
import { SupplierContractCDCLocalOnDemandRoutingModule } from './supplierContractCDCLocalOnDemand-routing.module';
...
@NgModule({
  declarations: [
    SupplierContractCDCLocalOnDemandComponent,
    advanceTableForm,
  ...
  imports: [
    ...
    FormsModule,
    ReactiveFormsModule,
    SupplierContractCDCLocalOnDemandRoutingModule,
    MatTableModule,
    MatPaginatorModule,
    MatFormFieldModule,
    MatInputModule,
  ...
  providers: [SupplierContractCDCLocalOnDemandService]
})
export class SupplierContractCDCLocalOnDemandModule {}
