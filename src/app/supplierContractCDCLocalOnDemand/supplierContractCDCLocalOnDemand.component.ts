...
@Component({
  standalone: false,
  selector: 'app-supplierContractCDCLocalOnDemand',
  templateUrl: './supplierContractCDCLocalOnDemand.component.html',
  styleUrls: ['./supplierContractCDCLocalOnDemand.component.sass'],
  providers: [{ provide: MAT_DATE_LOCALE, useValue: 'en-GB' }]
})
export class SupplierContractCDCLocalOnDemandComponent implements OnInit {
  displayedColumns = [
    'vehicleCategory',
    'cityTierName',
    'baseRate',
  ...
  dataSource: SupplierContractCDCLocalOnDemand[] | null;
  supplierContractCDCLocalOnDemandID: number;
  advanceTable: SupplierContractCDCLocalOnDemand | null;
  searchSupplierContractCDCLocalOnDemandID: number=0;
  ...
  constructor(
    ...
    public supplierContractCDCLocalOnDemandService: SupplierContractCDCLocalOnDemandService,
  ...
  refresh() {
    ...
    this.searchSupplierContractCDCLocalOnDemandID=0;
  ...
  editCall(row) {
      //  alert(row.id);
    this.supplierContractCDCLocalOnDemandID = row.supplierContractCDCLocalOnDemandID;
    const dialogRef = this.dialog.open(FormDialogComponent, {
      data: {
        advanceTable: row,
        action: 'edit',
  ...
  deleteItem(row)
  {
    ...
    this.supplierContractCDCLocalOnDemandID = row.id;
  ...
  debugger;
      ...
      this.supplierContractCDCLocalOnDemandService.getTableData(
        this.searchSupplierContractCDCLocalOnDemandID,
  ...
  onContextMenu(event: MouseEvent, item: SupplierContractCDCLocalOnDemand) {
    event.preventDefault();
...
/////////////////for Image Upload ends////////////////////////////
  ...
  SubscribeUpdateService()
  {
    ...
    (
      ...
      { 
        ...
        {
          if(this.MessageArray[0]=="SupplierContractCDCLocalOnDemandCreate")
          {
            if(this.MessageArray[1]=="SupplierContractCDCLocalOnDemandView")
            {
              if(this.MessageArray[2]=="Success")
              {
                ...
                'snackbar-success',
                'Supplier Contract CDC Local On Demand Created...!!!',
                'bottom',
                'center'
              );
              }
          ...
          else if(this.MessageArray[0]=="SupplierContractCDCLocalOnDemandUpdate")
          {
            if(this.MessageArray[1]=="SupplierContractCDCLocalOnDemandView")
            {
              if(this.MessageArray[2]=="Success")
              {
               ...
               this.showNotification(
                'snackbar-success',
                'Supplier Contract CDC Local On Demand Updated...!!!',
                'bottom',
                'center'
              );
              }
          ...
          else if(this.MessageArray[0]=="SupplierContractCDCLocalOnDemandDelete")
          {
            if(this.MessageArray[1]=="SupplierContractCDCLocalOnDemandView")
            {
              if(this.MessageArray[2]=="Success")
              {
               ...
               this.showNotification(
                'snackbar-success',
                'Supplier Contract CDC Local On Demand Deleted...!!!',
                'bottom',
                'center'
              );
              }
          ...
          else if(this.MessageArray[0]=="SupplierContractCDCLocalOnDemandAll")
          {
            if(this.MessageArray[1]=="SupplierContractCDCLocalOnDemandView")
            {
  ...
  SortingData(coloumName:any) {
    ...
    this.supplierContractCDCLocalOnDemandService.getTableDataSort(
      this.searchSupplierContractCDCLocalOnDemandID,
      this.supplierContract_ID,
