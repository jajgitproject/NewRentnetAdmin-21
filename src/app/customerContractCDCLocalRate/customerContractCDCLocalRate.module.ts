...
import { CustomerContractCDCLocalRateRoutingModule } from './customerContractCDCLocalRate-routing.module';
...
import { RateViewForLocalContractService } from '../rateViewForLocalContract/rateViewForLocalContract.service';


@NgModule({
  declarations: [
    CustomerContractCDCLocalRateComponent,
    advanceTableForm,
  ...
  imports: [
    ...
    FormsModule,
    ReactiveFormsModule,
    CustomerContractCDCLocalRateRoutingModule,
    MatTableModule,
    MatPaginatorModule,
    MatFormFieldModule,
    MatInputModule,
  ...
  providers: [CustomerContractCDCLocalRateService,CDCLocalFixedDetailsService,RateViewForLocalContractService]
})
export class CustomerContractCDCLocalRateModule {}
