...
import { SupplierContractCDCOutStationOnewayTripRoutingModule } from './supplierContractCDCOutStationOnewayTrip-routing.module';
...
@NgModule({
  declarations: [
    SupplierContractCDCOutStationOnewayTripComponent,
    advanceTableForm,
  ...
  imports: [
    ...
    FormsModule,
    ReactiveFormsModule,
    SupplierContractCDCOutStationOnewayTripRoutingModule,
    MatTableModule,
    MatPaginatorModule,
    MatFormFieldModule,
    MatInputModule,
  ...
  providers: [SupplierContractCDCOutStationOnewayTripService]
})
export class SupplierContractCDCOutStationOnewayTripModule {}
