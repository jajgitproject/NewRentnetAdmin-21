...
export class FormDialogComponent 
{
  ...
  advanceTable: SupplierContractCDCOutStationOnewayTrip;
  fName = '';
  contents: any[];
  mydata = [];
  name = '';
  ...
  public _generalService:GeneralService)
  {
        ...
        if (this.action === 'edit') 
        {
          this.dialogTitle ='Chauffeur Driven Car Outstation Oneway Trip Package';       
        ...
        {
          this.dialogTitle = 'Chauffeur Driven Car Outstation Oneway Trip Package';
          this.advanceTable = new SupplierContractCDCOutStationOnewayTrip({});
 ...
 InitCityTier(){
  ...
  createContactForm(): FormGroup 
  {
    ...
    {
      supplierContractCDCOutStationOnewayTripID: [this.advanceTable.supplierContractCDCOutStationOnewayTripID],
      ...
      geoLocationFromID: [this.advanceTable.geoLocationFromID],
      geoLocationToID: [this.advanceTable.geoLocationToID],
...
numberOnly(event): boolean {
  ...
  public Post(): void
  {
    ...
    { 
      this.isLoading = false;
        this.dialogRef.close();
       this._generalService.sendUpdate('SupplierContractCDCOutStationOnewayTripCreate:SupplierContractCDCOutStationOnewayTripView:Success');//To Send Updates  
  ...
  public Put(): void
  {
    ...
    response => 
    {
      this.isLoading = false;
        this.dialogRef.close();
       this._generalService.sendUpdate('SupplierContractCDCOutStationOnewayTripUpdate:SupplierContractCDCOutStationOnewayTripView:Success');//To Send Updates  
