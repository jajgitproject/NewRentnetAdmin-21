...
@Component({
  standalone: false,
  selector: 'app-supplierContractCDCOutStationOnewayTrip',
  templateUrl: './supplierContractCDCOutStationOnewayTrip.component.html',
  styleUrls: ['./supplierContractCDCOutStationOnewayTrip.component.sass'],
  providers: [{ provide: MAT_DATE_LOCALE, useValue: 'en-GB' }]
})
export class SupplierContractCDCOutStationOnewayTripComponent implements OnInit {
  displayedColumns = [
    'vehicleCategory',
    'cityTierName',
    'package',
  ...
  dataSource: SupplierContractCDCOutStationOnewayTrip[] | null;
  supplierContractCDCOutStationOnewayTripID: number;
  advanceTable: SupplierContractCDCOutStationOnewayTrip | null;
  searchSupplierContractCDCOutStationOnewayTripID: number=0;
 ...
 filteredPackageOptions: Observable<PackageDropDown[]>;
  ...
  constructor(
    ...
    public supplierContractCDCOutStationOnewayTripService: SupplierContractCDCOutStationOnewayTripService,
...
@ViewChild(MatMenuTrigger)
 ...
 InitPackage(){
  ...
  refresh() {
    ...
    this.searchSupplierContractCDCOutStationOnewayTripID=0;
  ...
  editCall(row) {
      //  alert(row.id);
    this.supplierContractCDCOutStationOnewayTripID = row.supplierContractCDCOutStationOnewayTripID;
    const dialogRef = this.dialog.open(FormDialogComponent, {
      data: {
        advanceTable: row,
        action: 'edit',
  ...
  deleteItem(row)
  {
    ...
    this.supplierContractCDCOutStationOnewayTripID = row.id;
  ...
  public Filter()
  {
   ...
   public loadData() 
   {
    switch (this.selectedFilter)
    {
      ...
      this.supplierContractCDCOutStationOnewayTripService.getTableData(
        this.searchSupplierContractCDCOutStationOnewayTripID,
  ...
  onContextMenu(event: MouseEvent, item: SupplierContractCDCOutStationOnewayTrip) {
    event.preventDefault();
...
/////////////////for Image Upload ends////////////////////////////
  ...
  SubscribeUpdateService()
  {
    ...
    (
      ...
      { 
        ...
        {
          if(this.MessageArray[0]=="SupplierContractCDCOutStationOnewayTripCreate")
          {
            if(this.MessageArray[1]=="SupplierContractCDCOutStationOnewayTripView")
            {
              if(this.MessageArray[2]=="Success")
              {
                ...
                'snackbar-success',
                'Supplier Contract CDC OutStation Oneway Trip Created ...!!!',
                'bottom',
                'center'
              );
              }
          ...
          else if(this.MessageArray[0]=="SupplierContractCDCOutStationOnewayTripUpdate")
          {
            if(this.MessageArray[1]=="SupplierContractCDCOutStationOnewayTripView")
            {
              if(this.MessageArray[2]=="Success")
              {
               ...
               this.showNotification(
                'snackbar-success',
                'Supplier Contract CDC OutStation Oneway Trip Updated ...!!!',
                'bottom',
                'center'
              );
              }
          ...
          else if(this.MessageArray[0]=="SupplierContractCDCOutStationOnewayTripDelete")
          {
            if(this.MessageArray[1]=="SupplierContractCDCOutStationOnewayTripView")
            {
              if(this.MessageArray[2]=="Success")
              {
               ...
               this.showNotification(
                'snackbar-success',
                'Supplier Contract CDC OutStation Oneway Trip Deleted ...!!!',
                'bottom',
                'center'
              );
              }
          ...
          else if(this.MessageArray[0]=="SupplierContractCDCOutStationOnewayTripAll")
          {
            if(this.MessageArray[1]=="SupplierContractCDCOutStationOnewayTripView")
            {
  ...
  SortingData(coloumName:any) {
    ...
    this.supplierContractCDCOutStationOnewayTripService.getTableDataSort(
      this.searchSupplierContractCDCOutStationOnewayTripID,
      this.supplierContract_ID,
