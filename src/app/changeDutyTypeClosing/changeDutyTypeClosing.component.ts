...
@Component({
  standalone: false,
  selector: 'app-changeDutyTypeClosing',
  templateUrl: './changeDutyTypeClosing.component.html',
  styleUrls: ['./changeDutyTypeClosing.component.sass'],
  providers: [{ provide: MAT_DATE_LOCALE, useValue: 'en-GB' }]
})
export class ChangeDutyTypeClosingComponent implements OnInit {
  @Input() advanceTableMOP
  @Input() reservationID;
  advanceTable: ChangeDutyTypeClosingModel | null;
  ...
  constructor(
    ...
    public mopDetailsService: ChangeDutyTypeClosingService,
