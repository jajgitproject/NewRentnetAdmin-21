...
import { ContractPackageTypeMappingRoutingModule } from './contractPackageTypeMapping-routing.module';
...
@NgModule({
  declarations: [
    ContractPackageTypeMappingComponent,
    advanceTableForm,
  ...
  imports: [
    ...
    FormsModule,
    ReactiveFormsModule,
    ContractPackageTypeMappingRoutingModule,
    MatTableModule,
  ...
  providers: [ContractPackageTypeMappingService]
})
export class ContractPackageTypeMappingModule {}
