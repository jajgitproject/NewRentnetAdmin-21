...
import { CustomerContractPackageTypePackageMappingRoutingModule } from './customerContractPackageTypePackageMapping-routing.module';
...
@NgModule({
  declarations: [
    CustomerContractPackageTypePackageMappingComponent,
    advanceTableForm,
  ...
  imports: [
    ...
    FormsModule,
    ReactiveFormsModule,
    CustomerContractPackageTypePackageMappingRoutingModule,
    MatTableModule,
    MatPaginatorModule,
    MatFormFieldModule,
    MatInputModule,
  ...
  providers: [CustomerContractPackageTypePackageMappingService]
})
export class CustomerContractPackageTypePackageMappingModule {}
