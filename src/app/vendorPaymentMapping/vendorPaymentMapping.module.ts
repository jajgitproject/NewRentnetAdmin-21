...
import { VendorPaymentMappingRoutingModule } from './vendorPaymentMapping-routing.module';
...
@NgModule({
  ...
  imports: [
    ...
    FormsModule,
    ReactiveFormsModule,
    VendorPaymentMappingRoutingModule,
    MatTableModule,
  ...
  providers: [VendorPaymentMappingService]
})
export class VendorPaymentMappingModule {}
