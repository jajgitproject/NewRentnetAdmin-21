...
export class DeleteDialogComponent
{
  ...
  confirmDelete()
  {
    this.advanceTableService.delete(this.data.disputeResolutionID)  
    .subscribe(
    data => 
    {
       this._generalService.sendUpdate('DisputeResolutionDelete:DisputeResolutionView:Success');//To Send Updates   
    },
    error =>
    {
