...
export class DeleteDialogComponent
{
  ...
  confirmDelete()
  {
    ...
    this.advanceTableService.delete(this.data.customerReservationExecutiveID)  
    .subscribe(
    data => 
    {
       this._generalService.sendUpdate('CustomerReservationExecutiveDelete:CustomerReservationExecutiveView:Success');//To Send Updates   
    },
    error =>
    {
