...
export class DeleteDialogComponent
{
  ...
  confirmDelete()
  {
    ...
    this.advanceTableService.delete(this.data.supplierContractCustomerPackageTypePercentageID)  
    .subscribe(
    data => 
    {
       this._generalService.sendUpdate('SupplierContractCustomerPackageTypePercentageDelete:SupplierContractCustomerPackageTypePercentageView:Success');//To Send Updates   
    },
    error =>
    {
