...
import { FetchDataRBERoutingModule } from './fetchDataRBE-routing.module';
...
@NgModule({
  ...
  providers: [FetchDataRBEService]
})
export class FetchDataRBEModule {}
