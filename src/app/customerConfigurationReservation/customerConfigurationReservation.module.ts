...
import { CustomerConfigurationReservationRoutingModule } from './customerConfigurationReservation-routing.module';
...
@NgModule({
  declarations: [
    CustomerConfigurationReservationComponent,
    advanceTableForm,
  ...
  imports: [
    ...
    MatTooltipModule,
    ReactiveFormsModule,
    CustomerConfigurationReservationRoutingModule,
    MatTableModule,
    MatPaginatorModule,
    MatFormFieldModule,
    MatInputModule,
  ...
  providers: [CustomerConfigurationReservationService]
})
export class CustomerConfigurationReservationModule {}
