...
import { ReservationMessagingRoutingModule } from './reservationMessaging-routing.module';
...
@NgModule({
  ...
  imports: [
    ...
    MatTooltipModule,
    ReactiveFormsModule,
    ReservationMessagingRoutingModule,
    MatTableModule,
  ...
  providers: [ReservationMessagingService]
})
export class ReservationMessagingModule {}
