...
import { InventoryPermitRoutingModule } from './inventoryPermit-routing.module';
// import { TwoDigitDecimaNumberDirective } from './twodigitdecimalnumber.directive';


@NgModule({
  declarations: [
    InventoryPermitComponent,
    advanceTableForm,
  ...
  providers: [InventoryPermitService]
})
export class InventoryPermitModule {}
