...
import { DriverInventoryAssociationRoutingModule } from './driverInventoryAssociation-routing.module';
...
@NgModule({
  ...
  imports: [
    ...
    FormsModule,
    ReactiveFormsModule,
    DriverInventoryAssociationRoutingModule,
    MatTableModule,
    MatPaginatorModule,
    MatFormFieldModule,
    MatInputModule,
  ...
  providers: [DriverInventoryAssociationService]
})
export class DriverInventoryAssociationModule {}
