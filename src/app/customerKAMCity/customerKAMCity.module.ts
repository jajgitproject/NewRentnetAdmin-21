...
import { CustomerKAMCityRoutingModule } from './customerKAMCity-routing.module';
import { CustomerKAMCityService } from './customerKAMCity.service';
import { MatAutocompleteModule } from '@angular/material/autocomplete';
@NgModule({
  declarations: [
    CustomerKAMCityComponent,
    advanceTableForm,
  ...
  providers: [CustomerKAMCityService]
})
export class CustomerKAMCityModule {}
