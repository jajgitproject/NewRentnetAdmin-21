...
import { OrganizationalEntityMessageRoutingModule } from './organizationalEntityMessage-routing.module';
...
@NgModule({
  declarations: [
    OrganizationalEntityMessageComponent,
    advanceTableForm,
  ...
  imports: [
    ...
    OrganizationalEntityMessageRoutingModule,
    MatTableModule,
    MatPaginatorModule,
    MatFormFieldModule,
    MatInputModule,
  ...
  providers: [OrganizationalEntityMessageService]
})
export class OrganizationalEntityMessageModule {}
