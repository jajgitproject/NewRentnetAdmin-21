...
export class FormDialogComponent 
{
  ...
  advanceTable: SupplierContractCDCLocalLumpsum;
  fName = '';
  contents: any[];
  mydata = [];
  name = '';
  ...
  public _generalService:GeneralService)
  {
        ...
        {
          this.dialogTitle = 'Chauffeur Driven Car Local Lumpsum Package';
          this.advanceTable = new SupplierContractCDCLocalLumpsum({});
 ...
 InitCityTier(){
  ...
  createContactForm(): FormGroup 
  {
    ...
    {
      supplierContractCDCLocalLumpsumID: [this.advanceTable.supplierContractCDCLocalLumpsumID],
  ...
  public Post(): void
  {
    ...
    response => 
    {
      this.isLoading = false; 
        this.dialogRef.close();
       this._generalService.sendUpdate('SupplierContractCDCLocalLumpsumCreate:SupplierContractCDCLocalLumpsumView:Success');//To Send Updates  
 ...
 this.advanceTableForm.patchValue({packageID:this.packageID || this.advanceTable.packageID});
    ...
    response => 
    {
      this.isLoading = false;
        this.dialogRef.close();
       this._generalService.sendUpdate('SupplierContractCDCLocalLumpsumUpdate:SupplierContractCDCLocalLumpsumView:Success');//To Send Updates  
...
//   if (/[a-zA-Z]/.supplierContractCDCLocalLumpsum(inp)) {
//     return true;
//   } else {
//     event.preventDefault();
//     return false;
