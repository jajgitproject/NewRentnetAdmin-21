...
export class FormDialogComponent 
{
  ...
  advanceTable: CDCOutStationRoundTripRate;
  ...
  public _generalService:GeneralService)
  {
        ...
        {
          this.dialogTitle = 'Chauffeur Driven Car Outstation Round Trip Package';
          this.advanceTable = new CDCOutStationRoundTripRate({});
  ...
  InitPackage(){
    this._generalService.GetPackageForCDC(8).subscribe(
      data=>{
  ...
  createContactForm(): FormGroup 
  {
    ...
    {
      cdcOutStationRoundTripRateID: [this.advanceTable.cdcOutStationRoundTripRateID],
