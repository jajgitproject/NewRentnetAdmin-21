...
import { SupplierContractCDCOutStationLumpsumTripService } from './supplierContractCDCOutStationLumpsumTrip.service';
...
@Component({
  standalone: false,
  selector: 'app-supplierContractCDCOutStationLumpsumTrip',
  templateUrl: './supplierContractCDCOutStationLumpsumTrip.component.html',
  styleUrls: ['./supplierContractCDCOutStationLumpsumTrip.component.sass'],
  providers: [{ provide: MAT_DATE_LOCALE, useValue: 'en-GB' }]
})
export class SupplierContractCDCOutStationLumpsumTripComponent implements OnInit {
  displayedColumns = [
    'vehicleCategory',
    'cityTierName',
    'package',
  ...
  dataSource: SupplierContractCDCOutStationLumpsumTrip[] | null;
  supplierContractCDCOutStationLumpsumTripID: number;
  advanceTable: SupplierContractCDCOutStationLumpsumTrip | null;
  searchSupplierContractCDCOutStationLumpsumTripID: number=0;
  ...
  packageRate : FormControl = new FormControl();
  ...
  constructor(
    ...
    public supplierContractCDCOutStationLumpsumTripService: SupplierContractCDCOutStationLumpsumTripService,
...
@ViewChild(MatMenuTrigger)
  ...
  refresh() {
    ...
    this.searchSupplierContractCDCOutStationLumpsumTripID=0;
    this.vehicleCategory.setValue('');
    this.cityTier.setValue('');
    this.package.setValue('');
    this.SearchPackageRate='';
    this.searchTerm='';
  ...
  editCall(row) {
      //  alert(row.id);
    this.supplierContractCDCOutStationLumpsumTripID = row.supplierContractCDCOutStationLumpsumTripID;
    const dialogRef = this.dialog.open(FormDialogComponent, {
      data: {
        advanceTable: row,
        action: 'edit',
  ...
  deleteItem(row)
  {
    ...
    this.supplierContractCDCOutStationLumpsumTripID = row.id;
   ...
   public loadData() 
   {
    switch (this.selectedFilter)
    {
      ...
      case 'package':
        ...
        break;
      case 'packageRate':
        this.SearchPackageRate = this.searchTerm;
        break;
      default:
        this.searchTerm = '';
        break;
    }
      this.supplierContractCDCOutStationLumpsumTripService.getTableData(
        this.searchSupplierContractCDCOutStationLumpsumTripID,
  ...
  onContextMenu(event: MouseEvent, item: SupplierContractCDCOutStationLumpsumTrip) {
    event.preventDefault();
...
/////////////////for Image Upload ends////////////////////////////
  ...
  SubscribeUpdateService()
  {
    ...
    (
      ...
      { 
        ...
        {
          if(this.MessageArray[0]=="SupplierContractCDCOutStationLumpsumTripCreate")
          {
            if(this.MessageArray[1]=="SupplierContractCDCOutStationLumpsumTripView")
            {
              if(this.MessageArray[2]=="Success")
              {
                ...
                'snackbar-success',
                'Supplier Contract CDC OutStation Lumpsum Trip Created...!!!',
                'bottom',
                'center'
              );
              }
          ...
          else if(this.MessageArray[0]=="SupplierContractCDCOutStationLumpsumTripUpdate")
          {
            if(this.MessageArray[1]=="SupplierContractCDCOutStationLumpsumTripView")
            {
              if(this.MessageArray[2]=="Success")
              {
               ...
               this.showNotification(
                'snackbar-success',
                'Supplier Contract CDC OutStation Lumpsum Trip Updated...!!!',
                'bottom',
                'center'
              );
              }
          ...
          else if(this.MessageArray[0]=="SupplierContractCDCOutStationLumpsumTripDelete")
          {
            if(this.MessageArray[1]=="SupplierContractCDCOutStationLumpsumTripView")
            {
              if(this.MessageArray[2]=="Success")
              {
               ...
               this.showNotification(
                'snackbar-success',
                'Supplier Contract CDC OutStation Lumpsum Trip Deleted...!!!',
                'bottom',
                'center'
              );
              }
          ...
          else if(this.MessageArray[0]=="SupplierContractCDCOutStationLumpsumTripAll")
          {
            if(this.MessageArray[1]=="SupplierContractCDCOutStationLumpsumTripView")
            {
  ...
  SortingData(coloumName:any) {
    ...
    this.supplierContractCDCOutStationLumpsumTripService.getTableDataSort(
      this.searchSupplierContractCDCOutStationLumpsumTripID,
      this.supplierContract_ID,
