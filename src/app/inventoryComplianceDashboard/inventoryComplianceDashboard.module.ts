...
import { InventoryComplianceDashboardRoutingModule } from './inventoryComplianceDashboard-routing.module';
import { MatExpansionModule } from '@angular/material/expansion';

@NgModule({
  declarations: [
    InventoryComplianceDashboardComponent,
  ...
  imports: [
    ...
    MatTooltipModule,
    ReactiveFormsModule,
    InventoryComplianceDashboardRoutingModule,
  ...
  providers: [InventoryComplianceDashboardService],
})
export class InventoryComplianceDashboardModule {}
