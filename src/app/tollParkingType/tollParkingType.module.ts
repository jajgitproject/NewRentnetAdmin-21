...
import { TollParkingTypeRoutingModule } from './tollParkingType-routing.module';
import { TollParkingTypeService } from './tollParkingType.service';
@NgModule({
  declarations: [
    TollParkingTypeComponent,
    advanceTableForm,
  ...
  providers: [TollParkingTypeService]
})
export class TollParkingTypeModule {}
