...
export class DeleteDialogComponent
{
  ...
  confirmDelete()
  {
    this.advanceTableService.delete(this.data.tollParkingTypeID)  
    .subscribe(
    data => 
    {
       this._generalService.sendUpdate('TollParkingTypeDelete:TollParkingTypeView:Success');//To Send Updates   
    },
    error =>
    {
