...
import { CustomerReservationFieldValuesRoutingModule } from './customerReservationFieldValues-routing.module';
...
@NgModule({
  declarations: [
    CustomerReservationFieldValuesComponent,
    advanceTableForm,
  ...
  imports: [
    ...
    FormsModule,
    ReactiveFormsModule,
    CustomerReservationFieldValuesRoutingModule,
    MatTableModule,
    MatPaginatorModule,
    MatFormFieldModule,
    MatInputModule,
  ...
  providers: [CustomerReservationFieldValuesService]
})
export class CustomerReservationFieldValuesModule {}
