...
export class CarAndDriverSearchFormDialogComponent 
{
  ...
  advanceTable: CarAndDriverSearch;
  ...
  constructor(
  public dialogRef: MatDialogRef<CarAndDriverSearchFormDialogComponent>, 
  ...
  public _generalService:GeneralService)
  {
        ...
        if (this.action === 'edit') 
        {
          this.dialogTitle ='Car And Driver Search';       
          this.advanceTable = data.advanceTable;
        } 
        else 
        {
          this.dialogTitle = 'Search Car And Driver';
          this.advanceTable = new CarAndDriverSearch({});
  ...
  createContactForm(): FormGroup 
  {
    ...
    {
      CarAndDriverSearchID: [this.advanceTable.CarAndDriverSearchID],
      CarAndDriverSearch: [this.advanceTable.CarAndDriverSearch,[this.noWhitespaceValidator]],
