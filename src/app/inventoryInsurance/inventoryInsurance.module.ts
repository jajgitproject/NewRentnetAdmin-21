...
import { InventoryInsuranceRoutingModule } from './inventoryInsurance-routing.module';
...
@NgModule({
  ...
  imports: [
    ...
    FormsModule,
    ReactiveFormsModule,
    InventoryInsuranceRoutingModule,
    MatTableModule,
    MatPaginatorModule,
    MatFormFieldModule,
    MatInputModule,
  ...
  providers: [InventoryInsuranceService]
})
export class InventoryInsuranceModule {}
