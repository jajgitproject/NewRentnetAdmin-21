...
export class DeleteDialogComponent
{
  ...
  confirmDelete()
  {
    this.advanceTableService.delete(this.data.modeOfPaymentID)  
    .subscribe(
    data => 
    {
       this._generalService.sendUpdate('ModeOfPaymentDelete:ModeOfPaymentView:Success');//To Send Updates   
    },
    error =>
    {
