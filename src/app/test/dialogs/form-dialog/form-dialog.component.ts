...
import { TestDropDown } from '../../testDropDown.model';
...
export class FormDialogComponent 
{
  ...
  public _generalService:GeneralService)
  {
        ...
        {
          //this.dialogTitle = 'Create Test';
          this.dialogTitle = 'Test';
          this.advanceTable = new Test({});
  ...
  createContactForm(): FormGroup 
  {
    ...
    {
      testID: [this.advanceTable.testID],
      name: [this.advanceTable.name, [Validators.required, Validators.pattern(/^[A-Za-z\s]*$/)]],
      gender : [this.advanceTable.gender],
      dob : [this.advanceTable.dob],
      image : [this.advanceTable.image],
      salary:[this.advanceTable.salary,[Validators.required, Validators.pattern(/^[1-9]\d*(\.\d+)?$/)]],
  ...
  public Post(): void
  {
    ...
    response => 
    {
       ...
       {
        this.dialogRef.close();
       this._generalService.sendUpdate('TestCreate:TestView:Success');//To Send Updates  
    }
  },
    error =>
    {
  ...
  public Put(): void
  {
    ...
    response => 
    {
       ...
       {
        this.dialogRef.close();
       this._generalService.sendUpdate('TestUpdate:TestView:Success');//To Send Updates  
       } 
    },
    error =>
    {
