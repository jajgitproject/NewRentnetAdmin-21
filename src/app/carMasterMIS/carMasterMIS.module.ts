...
import { CarMasterMISRoutingModule } from './carMasterMIS-routing.module';
...
@NgModule({
  ...
  providers: [CarMasterMISService]
})
export class CarMasterMISModule {}
