...
import { IncidenceEmailToBeSentToRoutingModule } from './incidenceEmailToBeSentTo-routing.module';
import { MyUploadModule } from '../myupload/myupload.module';

@NgModule({
  declarations: [
    IncidenceEmailToBeSentToComponent,
    advanceTableForm,
  ...
  imports: [
    ...
    FormsModule,
    ReactiveFormsModule,
    IncidenceEmailToBeSentToRoutingModule,
    MatTableModule,
    MatPaginatorModule,
    MatFormFieldModule,
    MatInputModule,
  ...
  providers: [IncidenceEmailToBeSentToService]
})
export class IncidenceEmailToBeSentToModule {}
