...
import { FormDialogCityComponent } from './dialogscity/form-dialog-city/form-dialog-city.component';

@Component({
  standalone: false,
  selector: 'app-city-master',
  templateUrl: './city-master.component.html',
  styleUrls: ['./city-master.component.sass']
})
export class CityMasterComponent implements OnInit {
  ...
  exampleDatabase: CityMasterTestService | null;
  dataSource: ExampleDataSource | null;
  selection = new SelectionModel<CityMaster>(true, []);
  id: number;
  advanceTable: CityMaster | null;
  ...
  addNew() {
     const dialogRef = this.dialog.open(FormDialogCityComponent, {
      data: {
  ...
  removeSelectedRows() {
    ...
    this.selection.selected.forEach((item) => {
      ...
      this.refreshTable();
      this.selection = new SelectionModel<CityMaster>(true, []);
    });
    this.showNotification(
      'snackbar-danger',
  ...
  public loadData() {
    this.exampleDatabase = new CityMasterTestService(this.httpClient);
...
export class ExampleDataSource extends DataSource<CityMaster> {
  ...
  constructor(
    public exampleDatabase: CityMasterTestService,
    ...
    return merge(...displayDataChanges).pipe(
      map(() => {
        ...
        this.filteredData = this.exampleDatabase.data
          .slice()
          .filter((advanceTable: CityMaster) => {
            const searchStr = (
              advanceTable.fName +
              advanceTable.lName +
              advanceTable.email +
