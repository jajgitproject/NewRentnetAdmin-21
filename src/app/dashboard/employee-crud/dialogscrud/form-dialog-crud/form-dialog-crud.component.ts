...
@Component({
  ...
  templateUrl: './form-dialog-crud.component.html',
  styleUrls: ['./form-dialog-crud.component.sass'],
  providers: [{ provide: MAT_DATE_LOCALE, useValue: 'en-GB' }]
})
export class FormDialogCrudComponent {
  action: string;
  dialogTitle: string;
  advanceTableForm: FormGroup;
  advanceTable: EmployeeCrud;
  constructor(
    public dialogRef: MatDialogRef<FormDialogCrudComponent>,
    ...
    if (this.action === 'edit') {
      ...
      this.advanceTable = new EmployeeCrud({});
    }
