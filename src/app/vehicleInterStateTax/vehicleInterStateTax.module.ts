...
import { VehicleInterStateTaxRoutingModule } from './vehicleInterStateTax-routing.module';
// import { TwoDigitDecimaNumberDirective } from './twodigitdecimalnumber.directive';

@NgModule({
  declarations: [
    VehicleInterStateTaxComponent,
    advanceTableForm,
  ...
  imports: [
    ...
    FormsModule,
    ReactiveFormsModule,
    VehicleInterStateTaxRoutingModule,
  ...
  providers: [VehicleInterStateTaxService]
})
export class VehicleInterStateTaxModule {}
