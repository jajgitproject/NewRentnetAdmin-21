...
export class FormDialogComponent 
{
  ...
  advanceTable: CDCLocalOnDemandRate;
  ...
  public _generalService:GeneralService)
  {
        ...
        {
          this.dialogTitle = 'Chauffeur Driven Car Local On Demand Package';
          this.advanceTable = new CDCLocalOnDemandRate({});
  ...
  InitPackage(){
    this._generalService.GetPackageForCDC(3).subscribe(
      data=>{
  ...
  createContactForm(): FormGroup 
  {
    ...
    {
      cdcLocalOnDemandRateID: [this.advanceTable?.cdcLocalOnDemandRateID],
      ...
      gpsPerKMRateForSupplier: [this.advanceTable?.gpsPerKMRateForSupplier],
      perMinuteRate: [this.advanceTable?.perMinuteRate],
      perMinuteRateForSupplier: [this.advanceTable?.perMinuteRateForSupplier],
      freeMinutes:[this.advanceTable?.freeMinutes],
      baseRate: [this.advanceTable?.baseRate],
      baseRateForSupplier: [this.advanceTable?.baseRateForSupplier],
