...
@Component({
  standalone: false,
  selector: 'app-cdcLocalOnDemandRate',
  templateUrl: './cdcLocalOnDemandRate.component.html',
  styleUrls: ['./cdcLocalOnDemandRate.component.sass'],
  providers: [{ provide: MAT_DATE_LOCALE, useValue: 'en-GB' }]
})
export class CDCLocalOnDemandRateComponent implements OnInit {
  displayedColumns = [
  ...
  dataSource: CDCLocalOnDemandRate[] | null;
  cdcLocalOnDemandRateID: number;
  CDCLocalOnDemandRateID: number=0;
  advanceTable: CDCLocalOnDemandRate | null;
  ...
  constructor(
    ...
    public cdcLocalOnDemandRateService: CDCLocalOnDemandRateService,
...
InitVehicleCategory(){
  ...
  editCall(row) {
      //  alert(row.id);
    this.cdcLocalOnDemandRateID = row.cdcLocalRateID;
    const dialogRef = this.dialog.open(FormDialogComponent, {
      data: {
        advanceTable: row,
        action: 'edit',
  ...
  deleteItem(row)
  {
    ...
    this.cdcLocalOnDemandRateID = row.id;
  ...
  onBackPress(event) 
  {
   ...
   public loadData() 
   {
    switch (this.selectedFilter)
    {
      ...
      this.cdcLocalOnDemandRateService.getTableData(
        this.CDCLocalOnDemandRateID,
  ...
  onContextMenu(event: MouseEvent, item: CDCLocalOnDemandRate) {
    event.preventDefault();
...
/////////////////for Image Upload ends////////////////////////////
  ...
  SubscribeUpdateService()
  {
    ...
    (
      ...
      { 
        ...
        {
          if(this.MessageArray[0]=="CDCLocalOnDemandRateCreate")
          {
            if(this.MessageArray[1]=="CDCLocalOnDemandRateView")
            {
              if(this.MessageArray[2]=="Success")
              {
                ...
                'snackbar-success',
                'CDC Local On Demand Rate Created ...!!!',
                'bottom',
                'center'
              );
              }
          ...
          else if(this.MessageArray[0]=="CDCLocalOnDemandRateUpdate")
          {
            if(this.MessageArray[1]=="CDCLocalOnDemandRateView")
            {
              if(this.MessageArray[2]=="Success")
              {
               ...
               this.showNotification(
                'snackbar-success',
                'CDC Local On Demand Rate Updated ...!!!',
                'bottom',
                'center'
              );
              }
          ...
          else if(this.MessageArray[0]=="CDCLocalOnDemandRateDelete")
          {
            if(this.MessageArray[1]=="CDCLocalOnDemandRateView")
            {
              if(this.MessageArray[2]=="Success")
              {
               ...
               this.showNotification(
                'snackbar-success',
                'CDC Local On Demand Rate Deleted ...!!!',
                'bottom',
                'center'
              );
              }
          ...
          else if(this.MessageArray[0]=="CDCLocalOnDemandRateAll")
          {
            if(this.MessageArray[1]=="CDCLocalOnDemandRateView")
            {
  ...
  SortingData(coloumName:any) {
    ...
    this.cdcLocalOnDemandRateService.getTableDataSort(
      this.CDCLocalOnDemandRateID,
      this.customerContract_ID,
