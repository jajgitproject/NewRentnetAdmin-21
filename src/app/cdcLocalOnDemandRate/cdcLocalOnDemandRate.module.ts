...
import { CDCLocalOnDemandRateRoutingModule } from './cdcLocalOnDemandRate-routing.module';
...
@NgModule({
  ...
  imports: [
    ...
    FormsModule,
    ReactiveFormsModule,
    CDCLocalOnDemandRateRoutingModule,
    MatTableModule,
    MatPaginatorModule,
    MatFormFieldModule,
    MatInputModule,
  ...
  providers: [CDCLocalOnDemandRateService]
})
export class CDCLocalOnDemandRateModule {}
