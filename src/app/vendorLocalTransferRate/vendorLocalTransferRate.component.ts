...
@Component({
  standalone: false,
  selector: 'app-vendorLocalTransferRate',
  templateUrl: './vendorLocalTransferRate.component.html',
  styleUrls: ['./vendorLocalTransferRate.component.sass'],
  providers: [{ provide: MAT_DATE_LOCALE, useValue: 'en-GB' }]
})
export class VendorLocalTransferRateComponent implements OnInit {
  displayedColumns = [
  ...
  dataSource:  VendorLocalTransferRate[] | null;
   vendorLocalTransferRateID: number;
  advanceTable:  VendorLocalTransferRate | null;
  searchVendorLocalTransferRateID: number=0;
  ...
  constructor(
    ...
    public  vendorLocalTransferRateService:  VendorLocalTransferRateService,
...
InitVehicleCategory(){
  ...
  refresh() {
    ...
    this.searchVendorLocalTransferRateID=0;
  ...
  editCall(row) {
    ...
    this. vendorLocalTransferRateID = row. vendorLocalTransferRateID;
    const dialogRef = this.dialog.open(FormDialogComponent, {
      data: {
        advanceTable: row,
        action: 'edit',
  ...
  deleteItem(row)
{
  ...
  duplicateCall(row) 
  {
    ...
    const dialogRef = this.dialog.open(FormDialogComponent, {
      data: {
        ...
        action: 'duplicate',
        vendorContractID:this.vendorContract_ID,
        vendorLocalTransferRateID:this.vendorLocalTransferRateID,
        applicableFrom:this.Applicable_From,
        applicableTo:this.Applicable_To,
        vendorContract_Name:this.vendorContract_Name
      }
  ...
  onBackPress(event) 
  {
   ...
   public loadData() 
   {
    switch (this.selectedFilter)
    {
      ...
      this. vendorLocalTransferRateService.getTableData(
        this.searchVendorLocalTransferRateID,
  ...
  onContextMenu(event: MouseEvent, item:  VendorLocalTransferRate) {
    event.preventDefault();
  ...
  SubscribeUpdateService()
  {
    ...
    (
      ...
      { 
        ...
        {
          if(this.MessageArray[0]=="VendorLocalTransferRateCreate")
          {
            if(this.MessageArray[1]=="VendorLocalTransferRateView")
            {
              if(this.MessageArray[2]=="Success")
              {
                ...
                'snackbar-success',
                'Vendor Contract Local Transfer Rate Created...!!!',
                'bottom',
                'center'
              );
              }
          ...
          else if(this.MessageArray[0]=="VendorLocalTransferRateUpdate")
          {
            if(this.MessageArray[1]=="VendorLocalTransferRateView")
            {
              if(this.MessageArray[2]=="Success")
              {
               ...
               this.showNotification(
                'snackbar-success',
                'Vendor Contract Local Transfer Rate Updated ...!!!',
                'bottom',
                'center'
              );
              }
         ...
         else if(this.MessageArray[0]=="VendorLocalTransferRateDelete")
{
  if(this.MessageArray[1]=="VendorLocalTransferRateView")
  {
    if(this.MessageArray[2]=="Success")
    {
      ...
      this.showNotification(
        'snackbar-success',
        'Vendor Contract Local Transfer Rate Deleted ...!!!',
        'bottom',
        'center'
      );
    }
          ...
          else if(this.MessageArray[0]=="VendorLocalTransferRateAll")
          {
            if(this.MessageArray[1]=="VendorLocalTransferRateView")
            {
  ...
  SortingData(coloumName:any) {
    ...
    this.vendorLocalTransferRateService.getTableDataSort(
      this.searchVendorLocalTransferRateID,
   ...
   RateView()
  {
    ...
    const url = this.router.serializeUrl(this.router.createUrlTree(
      ['/rateViewForVendorLocalTransferRate'],
      {
        queryParams: {
