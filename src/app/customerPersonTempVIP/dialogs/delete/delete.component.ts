...
export class DeleteDialogComponent
{
  ...
  confirmDelete()
  {
    this.advanceTableService.delete(this.data.customerPersonTempVIPID)  
    .subscribe(
    data => 
    {
       this._generalService.sendUpdate('CustomerPersonTempVIPDelete:CustomerPersonTempVIPView:Success');//To Send Updates   
    },
    error =>
    {
