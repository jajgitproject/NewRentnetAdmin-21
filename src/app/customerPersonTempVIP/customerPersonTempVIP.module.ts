...
import { CustomerPersonTempVIPComponent } from './customerPersonTempVIP.component';
...
import { CustomerPersonTempVIPRoutingModule } from './customerPersonTempVIP-routing.module';
...
@NgModule({
  declarations: [
    CustomerPersonTempVIPComponent,
    advanceTableForm,
  ...
  imports: [
    ...
    FormsModule,
    ReactiveFormsModule,
    CustomerPersonTempVIPRoutingModule,
    MatTableModule,
    MatPaginatorModule,
    MatFormFieldModule,
    MatInputModule,
  ...
  providers: [CustomerPersonTempVIPService]
})
export class CustomerPersonTempVIPModule {}
