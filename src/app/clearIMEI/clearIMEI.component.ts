...
import { ClearIMEI } from './clearIMEI.model';
...
export class ClearIMEIComponent implements OnInit {
  displayedColumns = [
    'driverName',
    'supplierName',
    'driverEmail',
  ...
  dataSource: ClearIMEI[] | null;
  driverID: number;
  advanceTable: ClearIMEI | null;
  ...
  constructor(
    ...
    public driverService: ClearIMEIService,
  ...
  onContextMenu(event: MouseEvent, item: ClearIMEI) {
      ...
      (
        message => {
          ...
          if (this.MessageArray.length == 3) {
            if (this.MessageArray[0] == "ClearIMEICreate") {
              if (this.MessageArray[1] == "ClearIMEIView") {
            ...
            else if (this.MessageArray[0] == "ClearIMEIUpdate") {
              if (this.MessageArray[1] == "ClearIMEIView") {
                if (this.MessageArray[2] == "Success") {
                  this.refresh();
                  this.showNotification(
            ...
            else if (this.MessageArray[0] == "ClearIMEIDelete") {
              if (this.MessageArray[1] == "ClearIMEIView") {
                if (this.MessageArray[2] == "Success") {
                  this.refresh();
                  this.showNotification(
            ...
            else if(this.MessageArray[0]=="ClearIMEIClearIMEI")
          {
            if(this.MessageArray[1]=="ClearIMEIView")
            {
              if(this.MessageArray[2]=="Success")
            ...
            else if (this.MessageArray[0] == "ClearIMEIAll") {
              if (this.MessageArray[1] == "ClearIMEIView") {
