...
import { SupplierCustomerFixedForAllPercentageRoutingModule } from './supplierCustomerFixedForAllPercentage-routing.module';
...
@NgModule({
  declarations: [
    SupplierCustomerFixedForAllPercentageComponent,
    advanceTableForm,
  ...
  imports: [
    ...
    SupplierCustomerFixedForAllPercentageRoutingModule,
    MatTableModule,
    MatPaginatorModule,
    MatFormFieldModule,
    MatInputModule,
  ...
  providers: [SupplierCustomerFixedForAllPercentageService]
})
export class SupplierCustomerFixedForAllPercentageModule {}
