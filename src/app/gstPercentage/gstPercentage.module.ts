...
import { GSTPercentageRoutingModule } from './gstPercentage-routing.module';
...
@NgModule({
  ...
  providers: [GSTPercentageService]
})
export class GSTPercentageModule {}
