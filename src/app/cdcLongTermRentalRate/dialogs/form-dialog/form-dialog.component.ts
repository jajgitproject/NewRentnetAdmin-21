...
export class FormDialogComponent {
  ...
  advanceTable: CDCLongTermRentalRate;
  ...
  constructor(
    ...
    if (this.action === 'duplicate') {
      ...
      this.dialogTitle = 'Chauffeur Driven Car Long  Term Rental Package';
      this.advanceTable = new CDCLongTermRentalRate({});
  ...
  InitPackage(){
    this._generalService.GetPackageForCDC(5).subscribe(
      data=>{
  ...
  createContactForm(): FormGroup {
    return this.fb.group(
      {
        cdcLongTermRentalRateID: [this.advanceTable.cdcLongTermRentalRateID],
  ...
  nightChargesBasedOn: [this.advanceTable.nightChargesBasedOn || 'Garage'],
        ...
        totalDaysBaseRateForSupplier: [this.advanceTable.totalDaysBaseRateForSupplier || 0],
        dailyBaseRate: [this.advanceTable.dailyBaseRate],
        dailyBaseRateForSupplier: [this.advanceTable.dailyBaseRateForSupplier || 0],
