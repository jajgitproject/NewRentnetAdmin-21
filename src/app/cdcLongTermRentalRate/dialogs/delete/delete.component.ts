...
export class DeleteDialogComponent
{
  ...
  confirmDelete()
  {
    this.advanceTableService.delete(this.data.cdcLongTermRentalRateID)  
    .subscribe(
    data => 
    {
       this._generalService.sendUpdate('CDCLongTermRentalRateDelete:CDCLongTermRentalRateView:Success');//To Send Updates   
    },
    error =>
    {
