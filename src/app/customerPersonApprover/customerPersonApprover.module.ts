...
import { CustomerPersonApproverRoutingModule } from './customerPersonApprover-routing.module';
...
@NgModule({
  declarations: [
    CustomerPersonApproverComponent,
    advanceTableForm,
  ...
  imports: [
    ...
    FormsModule,
    ReactiveFormsModule,
    CustomerPersonApproverRoutingModule,
    MatTableModule,
    MatPaginatorModule,
    MatFormFieldModule,
    MatInputModule,
  ...
  providers: [CustomerPersonApproverService]
})
export class CustomerPersonApproverModule {}
