...
@Component({
  ...
  styleUrls: ['./pickupDetails.component.sass'],
...
export class PickupDetailsComponent implements OnInit {
  ...
  advanceTable: PickupDetails | null;
  PickupDetailsID: number = 0;
  ...
  constructor(
    ...
    public pickupDetailsService: PickupDetailsService,
...
deleteItem(row)
{
  ...
  public Filter()
  {
   ...
   public loadData() 
   {
      this.pickupDetailsService.getTableData( this.reservationID,this.pickupDetailsID,this.stopType,this.SearchActivationStatus, this.PageNumber).subscribe
    (
      data =>   
      {
  ...
  onContextMenu(event: MouseEvent, item: PickupDetails) {
