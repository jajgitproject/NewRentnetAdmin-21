...
export class DeleteDialogComponent
{
  ...
  confirmDelete()
  {
    this.advanceTableService.delete(this.data.customerDesignationID)  
    .subscribe(
    data => 
    {
       this._generalService.sendUpdate('CustomerDesignationDelete:CustomerDesignationView:Success');//To Send Updates   
    },
    error =>
    {
