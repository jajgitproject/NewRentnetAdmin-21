...
import { CarAndDriverAllotmentTempRoutingModule } from './CarAndDriverAllotmentTemp-routing.module';
...
@NgModule({
  declarations: [
    CarAndDriverAllotmentTempComponent
  ],
  imports: [
    CommonModule,
    FormsModule,
    ...
    CarAndDriverAllotmentTempRoutingModule,
    MatTableModule,
    MatPaginatorModule,
    MatFormFieldModule,
    MatInputModule,
  ...
  providers: [CarAndDriverAllotmentTempService,OtherFilterService,TripFilterService]
})
export class CarAndDriverAllotmentTempModule { }
