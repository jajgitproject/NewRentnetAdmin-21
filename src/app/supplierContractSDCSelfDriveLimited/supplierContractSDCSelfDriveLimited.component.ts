...
@Component({
  standalone: false,
  selector: 'app-supplierContractSDCSelfDriveLimited',
  templateUrl: './supplierContractSDCSelfDriveLimited.component.html',
  styleUrls: ['./supplierContractSDCSelfDriveLimited.component.sass'],
  providers: [{ provide: MAT_DATE_LOCALE, useValue: 'en-GB' }]
})
export class SupplierContractSDCSelfDriveLimitedComponent implements OnInit {
  displayedColumns = [
    'vehicleCategory',
    'cityTierName',
    'package',
  ...
  dataSource: SupplierContractSDCSelfDriveLimited[] | null;
  supplierContractSDCSelfDriveLimitedID: number;
  advanceTable: SupplierContractSDCSelfDriveLimited | null;
  ...
  constructor(
    ...
    public supplierContractSDCSelfDriveLimitedService: SupplierContractSDCSelfDriveLimitedService,
...
initVehicle(){
  this._generalService.GetVehicleCategories().subscribe(
    ...
    {
      this.VehicleList=data;
      this.filteredVehicleCategoryOptions =this.vehicle.valueChanges.pipe(
        startWith(""),
...
private _filter(value: string): any {
 ...
 initPackage(){
  ...
  deleteItem(row)
  {
    ...
    this.supplierContractSDCSelfDriveLimitedID = row.id;
  ...
  public Filter()
  {
   ...
   public loadData() 
   {
    switch (this.selectedFilter)
    {
      ...
      this.supplierContractSDCSelfDriveLimitedService.getTableData(
  ...
  onContextMenu(event: MouseEvent, item: SupplierContractSDCSelfDriveLimited) {
    event.preventDefault();
...
/////////////////for Image Upload ends////////////////////////////
  ...
  SubscribeUpdateService()
  {
    ...
    (
      ...
      { 
        ...
        {
          if(this.MessageArray[0]=="SupplierContractSDCSelfDriveLimitedCreate")
          {
            if(this.MessageArray[1]=="SupplierContractSDCSelfDriveLimitedView")
            {
              if(this.MessageArray[2]=="Success")
              {
                ...
                'snackbar-success',
                'Supplier Contract SDC Self Drive Limited Created ...!!!',
                'bottom',
                'center'
              );
              }
          ...
          else if(this.MessageArray[0]=="SupplierContractSDCSelfDriveLimitedUpdate")
          {
            if(this.MessageArray[1]=="SupplierContractSDCSelfDriveLimitedView")
            {
              if(this.MessageArray[2]=="Success")
              {
               ...
               this.showNotification(
                'snackbar-success',
                'Supplier Contract SDC Self Drive Limited ...!!!',
                'bottom',
                'center'
              );
              }
          ...
          else if(this.MessageArray[0]=="SupplierContractSDCSelfDriveLimitedDelete")
          {
            if(this.MessageArray[1]=="SupplierContractSDCSelfDriveLimitedView")
            {
              if(this.MessageArray[2]=="Success")
          ...
          else if(this.MessageArray[0]=="SupplierContractSDCSelfDriveLimitedAll")
          {
            if(this.MessageArray[1]=="SupplierContractSDCSelfDriveLimitedView")
            {
  ...
  SortingData(coloumName:any) {
    ...
    this.supplierContractSDCSelfDriveLimitedService.getTableDataSort(
      this.supplierContract_ID ,
