...
import { SupplierContractSDCSelfDriveLimitedRoutingModule } from './supplierContractSDCSelfDriveLimited-routing.module';
...
@NgModule({
  declarations: [
    SupplierContractSDCSelfDriveLimitedComponent,
    advanceTableForm,
  ...
  imports: [
    ...
    ReactiveFormsModule,
    SupplierContractSDCSelfDriveLimitedRoutingModule,
    MatTableModule,
    MatPaginatorModule,
    MatFormFieldModule,
    MatInputModule,
  ...
  providers: [SupplierContractSDCSelfDriveLimitedService]
})
export class SupplierContractSDCSelfDriveLimitedModule {}
