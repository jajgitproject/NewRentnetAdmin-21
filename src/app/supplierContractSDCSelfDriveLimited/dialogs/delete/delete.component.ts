...
export class DeleteDialogComponent
{
  ...
  confirmDelete()
  {
    this.advanceTableService.delete(this.data.supplierContractSDCSelfDriveLimitedID)  
    .subscribe(
    data => 
    {
       this._generalService.sendUpdate('SupplierContractSDCSelfDriveLimitedDelete:SupplierContractSDCSelfDriveLimitedView:Success');//To Send Updates   
    },
    error =>
    {
